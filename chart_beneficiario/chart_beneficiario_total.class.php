...
class chart_beneficiario_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['chart_beneficiario']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['chart_beneficiario']['campos_busca']))
      { 
