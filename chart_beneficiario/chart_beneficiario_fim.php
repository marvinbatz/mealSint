...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["MealSint2_____chart_beneficiario"]))
   {
      unset($_SESSION['session_sec_aplicacao']["MealSint2_____chart_beneficiario"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_beneficiario']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['chart_beneficiario']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_beneficiario']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['chart_beneficiario']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['chart_beneficiario']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>chart_beneficiario</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['chart_beneficiario']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['chart_beneficiario']['embutida_filho'] as $ind => $sc_init)
          {
