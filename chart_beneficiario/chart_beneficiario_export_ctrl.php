<?php
@session_start() ;
$_SESSION['scriptcase']['chart_beneficiario']['sc_process_barr'] = true;
require_once('../chart_beneficiario/index.php');
unset($_SESSION['scriptcase']['chart_beneficiario']['sc_process_barr']);
$ExportCtrl = new chart_beneficiario_export_control;
$ExportCtrl->Export_barr();

class chart_beneficiario_export_control
{
