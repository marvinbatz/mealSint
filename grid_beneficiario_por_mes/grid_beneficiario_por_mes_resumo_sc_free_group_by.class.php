...
class grid_beneficiario_por_mes_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $array_total_beneficiario_idplanificacion;
   var $array_total_beneficiario_fechadeingreso;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_beneficiario_idplanificacion = array();
      $this->array_total_beneficiario_fechadeingreso  = array();
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['dashboard_info']['under_dashboard'] ? "off" : "on";
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_beneficiario_por_mes']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_beneficiario_por_mes']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              ...
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['tot_geral'][1];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['arr_total']['beneficiario_idplanificacion'] = $this->array_total_beneficiario_idplanificacion;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['arr_total']['beneficiario_fechadeingreso'] = $this->array_total_beneficiario_fechadeingreso;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['json_use_label'])
       {
          $Lab_beneficiario_idplanificacion = "beneficiario.idPlanificacion";
          $Lab_beneficiario_fechadeingreso = "beneficiario.fechaDeIngreso";
       }
       else
       {
       $Lab_beneficiario_idplanificacion = "Id Planificacion";
       $Lab_beneficiario_fechadeingreso = "Fecha De Ingreso";
       $Lab_beneficiario_fechadeingreso =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMM'] . "", $Lab_beneficiario_fechadeingreso);
       }
       $prep_field = array();
       $prep_field['beneficiario_idplanificacion'] = $Lab_beneficiario_idplanificacion;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['labels']['beneficiario_idplanificacion'] = $Lab_beneficiario_idplanificacion; 
       $prep_field['beneficiario_fechadeingreso'] = $Lab_beneficiario_fechadeingreso;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['labels']['beneficiario_fechadeingreso'] = $Lab_beneficiario_fechadeingreso; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['labels']['persona_noidentificacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['labels']['persona_noidentificacion'] = "No Identificacion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['labels']['beneficiario_quienrecibe']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['labels']['beneficiario_quienrecibe'] = "Quien Recibe"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['labels']['beneficiario_idbeneficiario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['labels']['beneficiario_idbeneficiario'] = "Id Beneficiario"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['labels']['beneficiario_idplanificacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['labels']['beneficiario_idplanificacion'] = "Id Planificacion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['labels']['beneficiario_fechadeingreso']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['labels']['beneficiario_fechadeingreso'] = "Fecha De Ingreso"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['labels']['beneficiario_login']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['labels']['beneficiario_login'] = "Login"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['labels']['persona_idpersona']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['labels']['persona_idpersona'] = "Id Persona"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['labels']['planificacion_meta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['labels']['planificacion_meta'] = "Meta"; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['beneficiario_idplanificacion']['alin'] = "''";
       $Arr_parms['beneficiario_idplanificacion']['link'] = "S";
       $Arr_parms['beneficiario_fechadeingreso']['alin'] = "''";
       $Arr_parms['beneficiario_fechadeingreso']['link'] = "S";
       $Arr_parms['beneficiario_idplanificacion']['fill'] = "true";
       $Arr_parms['beneficiario_idplanificacion']['order'] = "label";
       $Arr_parms['beneficiario_idplanificacion']['order_start'] = 'asc';
       $Arr_parms['beneficiario_idplanificacion']['order_invert'] = 'false';
       $Arr_parms['beneficiario_idplanificacion']['order_enabled'] = 'true';
       $Arr_parms['beneficiario_idplanificacion']['order_datatype'] = 'int';
       $Arr_parms['beneficiario_fechadeingreso']['fill'] = "true";
       $Arr_parms['beneficiario_fechadeingreso']['order'] = "value";
       $Arr_parms['beneficiario_fechadeingreso']['order_start'] = 'asc';
       $Arr_parms['beneficiario_fechadeingreso']['order_invert'] = 'false';
       $Arr_parms['beneficiario_fechadeingreso']['order_enabled'] = 'true';
       $Arr_parms['beneficiario_fechadeingreso']['order_datatype'] = 'date';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['beneficiario_idplanificacion'] = array(0 => 'beneficiario_idplanificacion', 1 => '');
       $prep_links_fl['beneficiario_fechadeingreso'] = array(0 => 'beneficiario_fechadeingreso', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_beneficiario_por_mes@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $prep_chart_config = array(
           'beneficiario_idplanificacion' => array(
           '1' => array(
               'title'    => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'beneficiario_idplanificacion',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_beneficiario_idplanificacion)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           ),
           'beneficiario_fechadeingreso' => array(
           '1' => array(
               'title'    => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'beneficiario_fechadeingreso',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_beneficiario_fechadeingreso)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           ),
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_charts'];
	}
	...
	function filterChartsBySummarization() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao)) {
			...
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['summarizing_fields_display']['sc_free_group_by'] as $fieldIndex => $fieldData) {
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_beneficiario_por_mes_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_beneficiario_por_mes_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['embutida'])
                   {
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function resumo_final()
   {
      ...
      if (!$this->NM_res_sem_reg && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['opcao'] != "pdf")
      {
          $this->grafico_bot();
      }
      if ("out" == $this->NM_tipo)
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_beneficiario_por_mes_total.class.php"); 
      }
      ...
      $this->Total   = new grid_beneficiario_por_mes_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['dashboard_refresh_after_chart'] = 'resumo';
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>" . $this->Ini->Nm_lang['lang_othr_smry_title'] . " </TITLE>\r\n");
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_beneficiario_por_mes/grid_beneficiario_por_mes_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_beneficiario_por_mes_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_beneficiario_por_mes_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_beneficiario_por_mes_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['num_css'] . '.css');
     ...
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['embutida'])
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_beneficiario_por_mes/grid_beneficiario_por_mes_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_beneficiario_por_mes&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&origem=res&language=&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_beneficiario_por_mes/grid_beneficiario_por_mes_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['json'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bjson", "", "", "Rjson_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_beneficiario_por_mes/grid_beneficiario_por_mes_config_json.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_json_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_json_format=N&nm_json_label=S&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_beneficiario_por_mes/grid_beneficiario_por_mes_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_beneficiario_por_mes/grid_beneficiario_por_mes_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_beneficiario_por_mes_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      global $nm_saida;
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['ajax_nav'])
       { 
           $this->Ini->Arr_result['exec_script'][] = "nm_gp_move('resumo')";
           $_SESSION['scriptcase']['saida_html'] = "";
           return;
       } 
      $str_pbfile = $this->Ini->root . $this->Ini->path_imag_temp . '/sc_pb_' . session_id() . '.tmp';
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_beneficiario_por_mes']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_beneficiario_por_mes']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_beneficiario_por_mes_config_pivot.php?nome_apl=grid_beneficiario_por_mes&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_beneficiario_por_mes/grid_beneficiario_por_mes_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=pdf_res&sAdd=__E__nmgp_tipo_pdf=\" + z + \"__E__sc_parms_pdf=\" + p + \"__E__sc_create_charts=\" + crt + \"__E__sc_graf_pdf=\" + g + \"__E__chart_level=\" + chart_level + \"__E__SC_module_export=\" + SC_module_export + \"__E__use_pass_pdf=\" + use_pass_pdf + \"__E__pdf_all_cab=\" + pdf_all_cab + \"__E__pdf_all_label=\" +  pdf_all_label + \"__E__pdf_label_group=\" +  pdf_label_group + \"__E__pdf_zip=\" +  pdf_zip + \"&nm_opc=pdf&KeepThis=true&TB_iframe=true&modal=true\", '');\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['SC_Gb_Free_cmp']))
      {
      ...
      $nm_saida->saida("         var output =  $('#').click();\r\n");
      $nm_saida->saida("         return (0 < output.length);\r\n");
      $nm_saida->saida("      }\r\n");
      $nm_saida->saida("   return false;\r\n");
      $nm_saida->saida("   }\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_beneficiario_por_mes_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_beneficiario_por_mes/grid_beneficiario_por_mes_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
 function grafico_bot()
 {
   ...
   $bPDF = false;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new grid_beneficiario_por_mes_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
      ...
      if ($bPDF && (!isset($this->progress_fp) || !$this->progress_fp))
      {
           ...
           grid_beneficiario_por_mes_pdf_progress_call("\n", $this->Ini->Nm_lang);
           grid_beneficiario_por_mes_pdf_progress_call("\n", $this->Ini->Nm_lang);
           grid_beneficiario_por_mes_pdf_progress_call("100\n", $this->Ini->Nm_lang);
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['pivot_charts'] as $chart_index => $chart_data)
       {
           ...
           if ($bPDF)
           {
               ...
               if ($this->progress_fp)
               {
                   grid_beneficiario_por_mes_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "/" . $iChartTotal . "...\n", $this->Ini->Nm_lang, true);
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['ajax_nav'])
      {
         $this->Ini->Arr_result['setValue'][] = array('field' => 'res_chart_table', 'value' => NM_charset_to_utf8($_SESSION['scriptcase']['saida_html']));
         $_SESSION['scriptcase']['saida_html'] = "";
      }
       $nm_saida->saida("</TABLE>\r\n");
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $beneficiario_idbeneficiario = $Busca_temp['beneficiario_idbeneficiario']; 
          $tmp_pos = strpos($beneficiario_idbeneficiario, "##@@");
          if ($tmp_pos !== false && !is_array($beneficiario_idbeneficiario))
          {
              $beneficiario_idbeneficiario = substr($beneficiario_idbeneficiario, 0, $tmp_pos);
          }
          $persona_noidentificacion = $Busca_temp['persona_noidentificacion']; 
          $tmp_pos = strpos($persona_noidentificacion, "##@@");
          if ($tmp_pos !== false && !is_array($persona_noidentificacion))
          {
              $persona_noidentificacion = substr($persona_noidentificacion, 0, $tmp_pos);
          }
          $beneficiario_idplanificacion = $Busca_temp['beneficiario_idplanificacion']; 
          $tmp_pos = strpos($beneficiario_idplanificacion, "##@@");
          if ($tmp_pos !== false && !is_array($beneficiario_idplanificacion))
          {
              $beneficiario_idplanificacion = substr($beneficiario_idplanificacion, 0, $tmp_pos);
          }
          $beneficiario_quienrecibe = $Busca_temp['beneficiario_quienrecibe']; 
          $tmp_pos = strpos($beneficiario_quienrecibe, "##@@");
          if ($tmp_pos !== false && !is_array($beneficiario_quienrecibe))
          {
              $beneficiario_quienrecibe = substr($beneficiario_quienrecibe, 0, $tmp_pos);
          }
      } 
     ...
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['proc_pdf_vert']) {
      ...
      $nm_saida->saida("    <div class=\"" . $this->css_scGridHeaderFont . "\" style=\"float: left; text-transform: uppercase;\">" . $this->Ini->Nm_lang['lang_othr_smry_title'] . " </div>\r\n");
   ...
   //---- 
   function adiciona_registro($quebra_beneficiario_idplanificacion, $quebra_beneficiario_fechadeingreso, $quebra_beneficiario_idplanificacion_orig, $quebra_beneficiario_fechadeingreso_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_por_mes']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->persona_noidentificacion = $rs_res->fields[0] ;  
            $this->beneficiario_quienrecibe = $rs_res->fields[1] ;  
            $this->beneficiario_idbeneficiario = $rs_res->fields[2] ;  
            $this->beneficiario_idplanificacion = $rs_res->fields[3] ;  
            $this->beneficiario_fechadeingreso = $rs_res->fields[4] ;  
            $this->beneficiario_login = $rs_res->fields[5] ;  
            $this->persona_idpersona = $rs_res->fields[6] ;  
            $this->beneficiario_idplanificacion_orig = $this->beneficiario_idplanificacion;
            $this->beneficiario_fechadeingreso_orig = $this->beneficiario_fechadeingreso;
            nmgp_Form_Num_Val($this->beneficiario_idplanificacion, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->beneficiario_idplanificacion, $this->beneficiario_fechadeingreso, $this->beneficiario_idplanificacion_orig,  $this->beneficiario_fechadeingreso_orig);
            }
   }
//
