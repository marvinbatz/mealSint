 ...
 */
   ...
   // scriptcase
   include_once('form_mediosdeverificacion_session.php');
   @session_start();
   // ----------
...
if (!isset($_SESSION['sc_session'][ $_POST['param_seq'] ]['form_mediosdeverificacion']['upload_field_info']) || !isset($_SESSION['sc_session'][ $_POST['param_seq'] ]['form_mediosdeverificacion']['upload_field_info'][ $_POST['param_field'] ]))
{
    exit;
}

$aUploadInfo = $_SESSION['sc_session'][ $_POST['param_seq'] ]['form_mediosdeverificacion']['upload_field_info'][ $_POST['param_field'] ];
