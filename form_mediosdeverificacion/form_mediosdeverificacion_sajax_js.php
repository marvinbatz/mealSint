  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_mediosdeverificacion" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_mediosdeverificacion_form();
	}
...
?>
  ...
  // ---------- Validate medio
  function do_ajax_form_mediosdeverificacion_validate_medio()
  {
    var nomeCampo_medio = "medio";
    var var_medio = scAjaxGetFieldText(nomeCampo_medio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mediosdeverificacion_validate_medio(var_medio, var_script_case_init, do_ajax_form_mediosdeverificacion_validate_medio_cb);
  } // do_ajax_form_mediosdeverificacion_validate_medio

  function do_ajax_form_mediosdeverificacion_validate_medio_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mediosdeverificacion_validate_medio_cb

  // ---------- Validate descripcion
  function do_ajax_form_mediosdeverificacion_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mediosdeverificacion_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_mediosdeverificacion_validate_descripcion_cb);
  } // do_ajax_form_mediosdeverificacion_validate_descripcion

  function do_ajax_form_mediosdeverificacion_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mediosdeverificacion_validate_descripcion_cb

  // ---------- Validate nombre
  function do_ajax_form_mediosdeverificacion_validate_nombre()
  {
  } // do_ajax_form_mediosdeverificacion_validate_nombre

  function do_ajax_form_mediosdeverificacion_validate_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mediosdeverificacion_validate_nombre_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_mediosdeverificacion_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_mediosdeverificacion_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_medio = scAjaxGetFieldText("medio");
    var var_descripcion = scAjaxGetFieldText("descripcion");
    var var_nombre = scAjaxGetFieldHidden("nombre");
    var var_medio_ul_name = scAjaxSpecCharProtect(document.F1.medio_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_medio_ul_type = document.F1.medio_ul_type.value;
    var var_medio_salva = scAjaxSpecCharProtect(document.F1.medio_salva.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_medio_limpa = document.F1.medio_limpa.checked ? "S" : "N";
    ...
    scAjaxProcOn();
    x_ajax_form_mediosdeverificacion_submit_form(var_medio, var_descripcion, var_nombre, var_medio_ul_name, var_medio_ul_type, var_medio_salva, var_medio_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_mediosdeverificacion_submit_form_cb);
  } // do_ajax_form_mediosdeverificacion_submit_form

  function do_ajax_form_mediosdeverificacion_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    if (!scAjaxHasError())
    {
      ...
      if (document.F1.medio_limpa && document.F1.medio_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldDocument("medio", oImgTemp, "", "");
      }
      else if (document.getElementById("id_ajax_doc_medio") && "" != document.getElementById("id_ajax_doc_medio").innerHTML)
      {
        document.getElementById("id_ajax_doc_medio").style.display = "";
      }
    }
    scAjaxShowDebug();
    scAjaxSetDisplay();
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_mediosdeverificacion_submit_form_cb_after_alert);
  } // do_ajax_form_mediosdeverificacion_submit_form_cb
  function do_ajax_form_mediosdeverificacion_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_mediosdeverificacion_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_mediosdeverificacion_navigate_form()
  {
    perform_ajax_form_mediosdeverificacion_navigate_form();
  }

  function perform_ajax_form_mediosdeverificacion_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("descripcion");
    scAjaxHideErrorDisplay("nombre");
    var var_idmediosdeverificacion = document.F2.idmediosdeverificacion.value;
    ...
    scAjaxProcOn();
    x_ajax_form_mediosdeverificacion_navigate_form(var_idmediosdeverificacion, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_mediosdeverificacion_navigate_form_cb);
  } // do_ajax_form_mediosdeverificacion_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_mediosdeverificacion']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_mediosdeverificacion_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idmediosdeverificacion.value = scAjaxGetKeyValue("idmediosdeverificacion");
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_mediosdeverificacion_navigate_form_cb_after_alert);
  } // do_ajax_form_mediosdeverificacion_navigate_form_cb
  function do_ajax_form_mediosdeverificacion_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_mediosdeverificacion_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_mediosdeverificacion_navigate_form_cb_after_alert
  function sc_hide_form_mediosdeverificacion_form()
  {
  ...
  ajax_field_list[0] = "medio";
  ajax_field_list[1] = "descripcion";
  ajax_field_list[2] = "nombre";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "medio": {"label": "Medio", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["medio"][1] = "medio";
  ajax_field_mult["descripcion"][1] = "descripcion";
  ajax_field_mult["nombre"][1] = "nombre";

  var ajax_field_id = {
    "medio": new Array("hidden_field_label_medio", "hidden_field_data_medio"),
