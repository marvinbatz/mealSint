<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_persona']['sc_process_barr'] = true;
require_once('../pdfreport_persona/index.php');
unset($_SESSION['scriptcase']['pdfreport_persona']['sc_process_barr']);
$ExportCtrl = new pdfreport_persona_export_control;
$ExportCtrl->Export_barr();

class pdfreport_persona_export_control
{
