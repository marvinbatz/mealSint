  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_pais_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate idpais
  function do_ajax_form_pais_mob_validate_idpais()
  {
    var nomeCampo_idpais = "idpais";
    var var_idpais = scAjaxGetFieldHidden(nomeCampo_idpais);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pais_mob_validate_idpais(var_idpais, var_script_case_init, do_ajax_form_pais_mob_validate_idpais_cb);
  } // do_ajax_form_pais_mob_validate_idpais

  function do_ajax_form_pais_mob_validate_idpais_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pais_mob_validate_idpais_cb

  // ---------- Validate nombre
  function do_ajax_form_pais_mob_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pais_mob_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_pais_mob_validate_nombre_cb);
  } // do_ajax_form_pais_mob_validate_nombre

  function do_ajax_form_pais_mob_validate_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pais_mob_validate_nombre_cb

  // ---------- Validate abr
  function do_ajax_form_pais_mob_validate_abr()
  {
    var nomeCampo_abr = "abr";
    var var_abr = scAjaxGetFieldText(nomeCampo_abr);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pais_mob_validate_abr(var_abr, var_script_case_init, do_ajax_form_pais_mob_validate_abr_cb);
  } // do_ajax_form_pais_mob_validate_abr

  function do_ajax_form_pais_mob_validate_abr_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "abr";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pais_mob_validate_abr_cb

  // ---------- Validate departamento
  function do_ajax_form_pais_mob_validate_departamento()
  {
    var nomeCampo_departamento = "departamento";
    var var_departamento = scAjaxGetFieldText(nomeCampo_departamento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pais_mob_validate_departamento(var_departamento, var_script_case_init, do_ajax_form_pais_mob_validate_departamento_cb);
  } // do_ajax_form_pais_mob_validate_departamento

  function do_ajax_form_pais_mob_validate_departamento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pais_mob_validate_departamento_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_pais_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_pais_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idpais = scAjaxGetFieldHidden("idpais");
    var var_nombre = scAjaxGetFieldText("nombre");
    var var_abr = scAjaxGetFieldText("abr");
    ...
    scAjaxProcOn();
    x_ajax_form_pais_mob_submit_form(var_idpais, var_nombre, var_abr, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_pais_mob_submit_form_cb);
  } // do_ajax_form_pais_mob_submit_form

  function do_ajax_form_pais_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idpais");
      scAjaxHideErrorDisplay("nombre");
      scAjaxHideErrorDisplay("abr");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_pais_mob_submit_form_cb_after_alert);
  } // do_ajax_form_pais_mob_submit_form_cb
  function do_ajax_form_pais_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_pais_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_departamento_mob"] = "off";

  function do_ajax_form_pais_mob_navigate_form()
  {
    perform_ajax_form_pais_mob_navigate_form();
  }

  function perform_ajax_form_pais_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("abr");
    scAjaxHideErrorDisplay("departamento");
    var var_idpais = document.F2.idpais.value;
    ...
    scAjaxProcOn();
    scStatusDetail["form_departamento_mob"] = "on";
    x_ajax_form_pais_mob_navigate_form(var_idpais, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_pais_mob_navigate_form_cb);
  } // do_ajax_form_pais_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_pais_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_pais_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idpais.value = scAjaxGetKeyValue("idpais");
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_departamento_mob"] && "nmsc_iframe_liga_form_departamento_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_departamento_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_departamento_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_departamento_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_departamento_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_departamento_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_pais_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_pais_mob_navigate_form_cb
  function do_ajax_form_pais_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_pais_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_pais_mob_navigate_form_cb_after_alert
  function sc_hide_form_pais_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_departamento_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "idpais";
  ajax_field_list[1] = "nombre";
  ajax_field_list[2] = "abr";
  ajax_field_list[3] = "departamento";
  ...
  var ajax_error_list = {
    "idpais": {"label": "Id Pais", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nombre": {"label": "Nombre", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "abr": {"label": "Codigo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "departamento": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
