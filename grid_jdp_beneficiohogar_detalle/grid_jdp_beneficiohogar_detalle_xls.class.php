...
class grid_jdp_beneficiohogar_detalle_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_xls()
   {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['embutida']) {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['opcao'] = "";
      }
   }
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['SC_Gb_Free_cmp']))
          {
              $this->Tem_xls_res  = false;
          }
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_jdp_beneficiohogar_detalle/grid_jdp_beneficiohogar_detalle_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              ...
              $this->Res_xls = new grid_jdp_beneficiohogar_detalle_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_jdp_beneficiohogar_detalle.zip";
          $this->Arquivo   .= "_grid_jdp_beneficiohogar_detalle" . $this->Xls_tp;
          $this->Tit_doc    = "grid_jdp_beneficiohogar_detalle" . $this->Xls_tp;
          $this->Tit_zip    = "grid_jdp_beneficiohogar_detalle.zip";
      ...
      require_once($this->Ini->path_aplicacao . "grid_jdp_beneficiohogar_detalle_total.class.php"); 
      $this->Tot = new grid_jdp_beneficiohogar_detalle_total($this->Ini->sc_page);
      $this->prep_modulos("Tot");
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['SC_Ind_Groupby'];
      $this->Tot->$Gb_geral();
      $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['tot_geral'][1];
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      $pos      = strrpos($this->Ini->link_grid_beneficiohogar_avance_cons_emb, '/');
      $link_xls = substr($this->Ini->link_grid_beneficiohogar_avance_cons_emb, 0, $pos) . "/grid_beneficiohogar_avance_xls.class.php";
      if (!is_file($this->Ini->link_grid_beneficiohogar_avance_cons_emb) || !is_file($link_xls))
      {
      ...
      $nm_raiz_img  = ""; 
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['field_order'] as $Cada_cmp)
      {
      ...
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['campos_busca']))
      { 
          $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['campos_busca'];
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['where_pesq'];
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['where_pesq'];
      $nmgp_select .= " group by pl.idPlanificacion"; 
      $nmgp_select_count .= " group by pl.idPlanificacion"; 
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['order_grid'];
     ...
     $nm_houve_quebra = "N";
         ...
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['field_order'] as $Cada_col)
         { 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   { 
      ...
      { 
          ...
          if ($Cada_col == "avance" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiohogar_avance']['embutida'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiohogar_avance']['embutida_label'] = true;
              $GLOBALS["script_case_init"] = $this->Ini->sc_page;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiohogar_avance']['embutida'] = false;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiohogar_avance']['embutida_label'] = false;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['embutida'])
              { 
   ...
   function NM_export_avance()
   {
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiohogar_avance']['embutida'] = true;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiohogar_avance']['nolabel'] = true;
         if (method_exists($this->grid_beneficiohogar_avance, "controle"))
         {
             $this->grid_beneficiohogar_avance->controle();
             if (isset($_SESSION['scriptcase']['export_return']))
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['nolabel'])
       {
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle'][$path_doc_md5][1] = $this->Tit_doc;
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiohogar_detalle']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
