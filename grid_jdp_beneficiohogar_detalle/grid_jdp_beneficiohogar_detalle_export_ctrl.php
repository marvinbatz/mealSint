<?php
@session_start() ;
$_SESSION['scriptcase']['grid_jdp_beneficiohogar_detalle']['sc_process_barr'] = true;
require_once('../grid_jdp_beneficiohogar_detalle/index.php');
unset($_SESSION['scriptcase']['grid_jdp_beneficiohogar_detalle']['sc_process_barr']);
$ExportCtrl = new grid_jdp_beneficiohogar_detalle_export_control;
$ExportCtrl->Export_barr();

class grid_jdp_beneficiohogar_detalle_export_control
{
