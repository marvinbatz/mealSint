<?php
@session_start() ;
$_SESSION['scriptcase']['grid_asignaciontipodeverificacion']['sc_process_barr'] = true;
require_once('../grid_asignaciontipodeverificacion/index.php');
unset($_SESSION['scriptcase']['grid_asignaciontipodeverificacion']['sc_process_barr']);
$ExportCtrl = new grid_asignaciontipodeverificacion_export_control;
$ExportCtrl->Export_barr();

class grid_asignaciontipodeverificacion_export_control
{
