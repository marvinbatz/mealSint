<?php
@session_start() ;
$_SESSION['scriptcase']['grid_jdp_planificacion_institucion_act']['sc_process_barr'] = true;
require_once('../grid_jdp_planificacion_institucion_act/index.php');
unset($_SESSION['scriptcase']['grid_jdp_planificacion_institucion_act']['sc_process_barr']);
$ExportCtrl = new grid_jdp_planificacion_institucion_act_export_control;
$ExportCtrl->Export_barr();

class grid_jdp_planificacion_institucion_act_export_control
{
