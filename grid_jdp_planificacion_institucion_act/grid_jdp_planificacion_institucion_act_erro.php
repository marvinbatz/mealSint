...
function scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['grid_jdp_planificacion_institucion_act']['contr_erro']) && $_SESSION['scriptcase']['grid_jdp_planificacion_institucion_act']['contr_erro'] == 'on')
    {
