...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "idplanmeal";$Nm_numeric[] = "";$Nm_numeric[] = "idplanmeal";$Nm_numeric[] = "";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_idplanmeal_cond" name="idplanmeal_cond" onChange="nm_campos_between(document.getElementById('id_vis_idplanmeal'), this, 'idplanmeal')">
      ...
      <br><span id="id_hide_idplanmeal"  <?php echo $str_hide_idplanmeal?>><INPUT  type="text" id="SC_idplanmeal" name="idplanmeal" value="<?php echo NM_encode_input($idplanmeal) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
