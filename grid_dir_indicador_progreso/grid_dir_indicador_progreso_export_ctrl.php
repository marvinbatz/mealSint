<?php
@session_start() ;
$_SESSION['scriptcase']['grid_dir_indicador_progreso']['sc_process_barr'] = true;
require_once('../grid_dir_indicador_progreso/index.php');
unset($_SESSION['scriptcase']['grid_dir_indicador_progreso']['sc_process_barr']);
$ExportCtrl = new grid_dir_indicador_progreso_export_control;
$ExportCtrl->Export_barr();

class grid_dir_indicador_progreso_export_control
{
