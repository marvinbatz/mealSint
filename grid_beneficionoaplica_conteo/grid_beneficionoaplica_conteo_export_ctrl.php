<?php
@session_start() ;
$_SESSION['scriptcase']['grid_beneficionoaplica_conteo']['sc_process_barr'] = true;
require_once('../grid_beneficionoaplica_conteo/index.php');
unset($_SESSION['scriptcase']['grid_beneficionoaplica_conteo']['sc_process_barr']);
$ExportCtrl = new grid_beneficionoaplica_conteo_export_control;
$ExportCtrl->Export_barr();

class grid_beneficionoaplica_conteo_export_control
{
