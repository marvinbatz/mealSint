...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "pl_meta";$Nm_numeric[] = "sum(be_valor)";$Nm_numeric[] = "round(sum(be_valor)*100/pl_meta)";$Nm_numeric[] = "pl_meta";$Nm_numeric[] = "sum(be_valor)";$Nm_numeric[] = "round(sum(be_valor)*100/pl_meta)";
