  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tecnico_objetivo_resultado" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tecnico_objetivo_resultado_form();
	}
...
?>
  ...
  // ---------- Validate nombre
  function do_ajax_form_tecnico_objetivo_resultado_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tecnico_objetivo_resultado_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_tecnico_objetivo_resultado_validate_nombre_cb);
  } // do_ajax_form_tecnico_objetivo_resultado_validate_nombre

  function do_ajax_form_tecnico_objetivo_resultado_validate_nombre_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tecnico_objetivo_resultado_validate_nombre_cb

  // ---------- Validate planificacion
  function do_ajax_form_tecnico_objetivo_resultado_validate_planificacion()
  {
    var nomeCampo_planificacion = "planificacion";
    var var_planificacion = scAjaxGetFieldText(nomeCampo_planificacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tecnico_objetivo_resultado_validate_planificacion(var_planificacion, var_script_case_init, do_ajax_form_tecnico_objetivo_resultado_validate_planificacion_cb);
  } // do_ajax_form_tecnico_objetivo_resultado_validate_planificacion

  function do_ajax_form_tecnico_objetivo_resultado_validate_planificacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "planificacion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tecnico_objetivo_resultado_validate_planificacion_cb

  // ---------- Validate planmeal
  function do_ajax_form_tecnico_objetivo_resultado_validate_planmeal()
  {
    var nomeCampo_planmeal = "planmeal";
    var var_planmeal = scAjaxGetFieldText(nomeCampo_planmeal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tecnico_objetivo_resultado_validate_planmeal(var_planmeal, var_script_case_init, do_ajax_form_tecnico_objetivo_resultado_validate_planmeal_cb);
  } // do_ajax_form_tecnico_objetivo_resultado_validate_planmeal

  function do_ajax_form_tecnico_objetivo_resultado_validate_planmeal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "planmeal";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tecnico_objetivo_resultado_validate_planmeal_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tecnico_objetivo_resultado_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tecnico_objetivo_resultado_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tecnico_objetivo_resultado_submit_form(var_nombre, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tecnico_objetivo_resultado_submit_form_cb);
  } // do_ajax_form_tecnico_objetivo_resultado_submit_form

  function do_ajax_form_tecnico_objetivo_resultado_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("planificacion");
      scAjaxHideErrorDisplay("planmeal");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tecnico_objetivo_resultado_submit_form_cb_after_alert);
  } // do_ajax_form_tecnico_objetivo_resultado_submit_form_cb
  function do_ajax_form_tecnico_objetivo_resultado_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tecnico_objetivo_resultado_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_planificacion"] = "off";
  scStatusDetail["grid_planmeal"] = "off";

  function do_ajax_form_tecnico_objetivo_resultado_navigate_form()
  {
    perform_ajax_form_tecnico_objetivo_resultado_navigate_form();
  }

  function perform_ajax_form_tecnico_objetivo_resultado_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("planificacion");
    scAjaxHideErrorDisplay("planmeal");
    var var_idobjetivo_resultado = document.F2.idobjetivo_resultado.value;
    ...
    scAjaxProcOn();
    scStatusDetail["form_planificacion"] = "on";
    scStatusDetail["grid_planmeal"] = "on";
    x_ajax_form_tecnico_objetivo_resultado_navigate_form(var_idobjetivo_resultado, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tecnico_objetivo_resultado_navigate_form_cb);
  } // do_ajax_form_tecnico_objetivo_resultado_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tecnico_objetivo_resultado']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tecnico_objetivo_resultado_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idobjetivo_resultado.value = scAjaxGetKeyValue("idobjetivo_resultado");
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_planificacion"] && "nmsc_iframe_liga_form_planificacion" != scMasterDetailIframe["nmsc_iframe_liga_form_planificacion"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_planificacion"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_planificacion').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_planificacion').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_planificacion').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_grid_planmeal"] && "nmsc_iframe_liga_grid_planmeal" != scMasterDetailIframe["nmsc_iframe_liga_grid_planmeal"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_grid_planmeal"]);
    }
    else {
        if (oResp["navSummary"].reg_tot != 0) {
            document.getElementById('nmsc_iframe_liga_grid_planmeal').contentWindow.nm_move('apl_detalhe', true, '1005');
        }
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tecnico_objetivo_resultado_navigate_form_cb_after_alert);
  } // do_ajax_form_tecnico_objetivo_resultado_navigate_form_cb
  function do_ajax_form_tecnico_objetivo_resultado_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_tecnico_objetivo_resultado_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_tecnico_objetivo_resultado_navigate_form_cb_after_alert
  function sc_hide_form_tecnico_objetivo_resultado_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_planificacion"] && "off" == scStatusDetail["grid_planmeal"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[1] = "planificacion";
  ajax_field_list[2] = "planmeal";
  ...
  var ajax_error_list = {
    ...
    "planificacion": {"label": "Planificación", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "planmeal": {"label": "Plan Meal", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "nombre": new Array(),
    "planificacion": new Array(),
    "planmeal": new Array()
  };
  ajax_field_mult["nombre"][1] = "nombre";
  ajax_field_mult["planificacion"][1] = "planificacion";
  ajax_field_mult["planmeal"][1] = "planmeal";

  var ajax_field_id = {
    "nombre": new Array("hidden_field_label_nombre", "hidden_field_data_nombre"),
    "planificacion": new Array("hidden_field_label_planificacion", "hidden_field_data_planificacion"),
    "planmeal": new Array("hidden_field_label_planmeal", "hidden_field_data_planmeal")
  };
