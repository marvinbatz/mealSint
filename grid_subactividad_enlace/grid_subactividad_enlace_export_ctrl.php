<?php
@session_start() ;
$_SESSION['scriptcase']['grid_subactividad_enlace']['sc_process_barr'] = true;
require_once('../grid_subactividad_enlace/index.php');
unset($_SESSION['scriptcase']['grid_subactividad_enlace']['sc_process_barr']);
$ExportCtrl = new grid_subactividad_enlace_export_control;
$ExportCtrl->Export_barr();

class grid_subactividad_enlace_export_control
{
