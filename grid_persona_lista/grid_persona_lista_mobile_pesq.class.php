...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "p.fechaDeNacimiento";$Nm_datas[] = "p_fechaDeNacimiento";$Nm_numeric[] = "p_idpersona";$Nm_numeric[] = "year( curdate( ) ) - year( fechadenacimiento ) - if( month( curdate( ) ) < month( fechadenacimiento),1,if ( month(curdate( )) = month(fechadenacimiento),if (day( curdate( ) ) < day( fechadenacimiento ),1,0 ),0))";$Nm_numeric[] = "month(curdate()) - month( fechadenacimiento) + 12 * if( month(curdate())<month(fechadenacimiento),1,if(month(curdate())=month(fechadenacimiento),if (day(curdate())<day(fechadenacimiento),1,0),0)
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_p_noidentificacion_cond" name="p_noidentificacion_cond" onChange="nm_campos_between(document.getElementById('id_vis_p_noidentificacion'), this, 'p_noidentificacion')">
