...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["MealSint2_____grid_persona_lista"]))
   {
      unset($_SESSION['session_sec_aplicacao']["MealSint2_____grid_persona_lista"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_persona_lista']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_persona_lista']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_persona_lista']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_persona_lista']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_persona_lista']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_persona_lista</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_persona_lista']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_persona_lista']['embutida_filho'] as $ind => $sc_init)
          {
