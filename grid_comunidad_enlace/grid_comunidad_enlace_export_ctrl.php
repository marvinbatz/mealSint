<?php
@session_start() ;
$_SESSION['scriptcase']['grid_comunidad_enlace']['sc_process_barr'] = true;
require_once('../grid_comunidad_enlace/index.php');
unset($_SESSION['scriptcase']['grid_comunidad_enlace']['sc_process_barr']);
$ExportCtrl = new grid_comunidad_enlace_export_control;
$ExportCtrl->Export_barr();

class grid_comunidad_enlace_export_control
{
