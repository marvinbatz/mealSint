<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tec_planificacion_en_revision']['sc_process_barr'] = true;
require_once('../grid_tec_planificacion_en_revision/index.php');
unset($_SESSION['scriptcase']['grid_tec_planificacion_en_revision']['sc_process_barr']);
$ExportCtrl = new grid_tec_planificacion_en_revision_export_control;
$ExportCtrl->Export_barr();

class grid_tec_planificacion_en_revision_export_control
{
