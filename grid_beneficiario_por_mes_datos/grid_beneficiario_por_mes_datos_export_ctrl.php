<?php
@session_start() ;
$_SESSION['scriptcase']['grid_beneficiario_por_mes_datos']['sc_process_barr'] = true;
require_once('../grid_beneficiario_por_mes_datos/index.php');
unset($_SESSION['scriptcase']['grid_beneficiario_por_mes_datos']['sc_process_barr']);
$ExportCtrl = new grid_beneficiario_por_mes_datos_export_control;
$ExportCtrl->Export_barr();

class grid_beneficiario_por_mes_datos_export_control
{
