<?php
@session_start() ;
$_SESSION['scriptcase']['grid_subactividad']['sc_process_barr'] = true;
require_once('../grid_subactividad/index.php');
unset($_SESSION['scriptcase']['grid_subactividad']['sc_process_barr']);
$ExportCtrl = new grid_subactividad_export_control;
$ExportCtrl->Export_barr();

class grid_subactividad_export_control
{
