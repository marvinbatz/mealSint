<?php
@session_start() ;
$_SESSION['scriptcase']['grid_departamento']['sc_process_barr'] = true;
require_once('../grid_departamento/index.php');
unset($_SESSION['scriptcase']['grid_departamento']['sc_process_barr']);
$ExportCtrl = new grid_departamento_export_control;
$ExportCtrl->Export_barr();

class grid_departamento_export_control
{
