<?php
@session_start() ;
$_SESSION['scriptcase']['grid_donante']['sc_process_barr'] = true;
require_once('../grid_donante/index.php');
unset($_SESSION['scriptcase']['grid_donante']['sc_process_barr']);
$ExportCtrl = new grid_donante_export_control;
$ExportCtrl->Export_barr();

class grid_donante_export_control
{
