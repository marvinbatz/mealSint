...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["MealSint2_____grid_coberturas"]))
   {
      unset($_SESSION['session_sec_aplicacao']["MealSint2_____grid_coberturas"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_coberturas']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_coberturas']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_coberturas']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_coberturas']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_coberturas']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_coberturas']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_coberturas']['embutida_filho'] as $ind => $sc_init)
          {
