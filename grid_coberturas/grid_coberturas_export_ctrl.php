<?php
@session_start() ;
$_SESSION['scriptcase']['grid_coberturas']['sc_process_barr'] = true;
require_once('../grid_coberturas/index.php');
unset($_SESSION['scriptcase']['grid_coberturas']['sc_process_barr']);
$ExportCtrl = new grid_coberturas_export_control;
$ExportCtrl->Export_barr();

class grid_coberturas_export_control
{
