...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["MealSint2_____grid_dir_proyecto_reportes"]))
   {
      unset($_SESSION['session_sec_aplicacao']["MealSint2_____grid_dir_proyecto_reportes"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_dir_proyecto_reportes']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_dir_proyecto_reportes']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_dir_proyecto_reportes']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_dir_proyecto_reportes']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_dir_proyecto_reportes']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_dir_proyecto_reportes</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_dir_proyecto_reportes']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_dir_proyecto_reportes']['embutida_filho'] as $ind => $sc_init)
          {
