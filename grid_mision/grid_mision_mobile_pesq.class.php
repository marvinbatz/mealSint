...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "idmision";$Nm_numeric[] = "idmision";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_idmision_cond" name="idmision_cond" onChange="nm_campos_between(document.getElementById('id_vis_idmision'), this, 'idmision')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_abr_cond" name="abr_cond" onChange="nm_campos_between(document.getElementById('id_vis_abr'), this, 'abr')">
      ...
      <br><span id="id_hide_abr"  <?php echo $str_hide_abr?>><?php
      if ($abr != "")
      {
      $abr_look = substr($this->Db->qstr($abr), 1, -1); 
      $nmgp_def_dados = array(); 
