<?php
@session_start() ;
$_SESSION['scriptcase']['grid_mision']['sc_process_barr'] = true;
require_once('../grid_mision/index.php');
unset($_SESSION['scriptcase']['grid_mision']['sc_process_barr']);
$ExportCtrl = new grid_mision_export_control;
$ExportCtrl->Export_barr();

class grid_mision_export_control
{
