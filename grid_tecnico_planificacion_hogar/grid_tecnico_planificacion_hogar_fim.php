...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["MealSint2_____grid_tecnico_planificacion_hogar"]))
   {
      unset($_SESSION['session_sec_aplicacao']["MealSint2_____grid_tecnico_planificacion_hogar"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tecnico_planificacion_hogar']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tecnico_planificacion_hogar']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tecnico_planificacion_hogar']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tecnico_planificacion_hogar']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tecnico_planificacion_hogar']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tecnico_planificacion_hogar</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tecnico_planificacion_hogar']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tecnico_planificacion_hogar']['embutida_filho'] as $ind => $sc_init)
          {
