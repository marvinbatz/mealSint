  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_unidad" == sTestField)
        {
...
?>
  ...
  // ---------- Validate nombre_
  function do_ajax_form_unidad_validate_nombre_(iNumLinha)
  {
    var nomeCampo_nombre_ = "nombre_" + iNumLinha;
    var var_nombre_ = scAjaxGetFieldText(nomeCampo_nombre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_unidad_validate_nombre_(var_nombre_, iNumLinha, var_script_case_init, do_ajax_form_unidad_validate_nombre__cb);
  } // do_ajax_form_unidad_validate_nombre_

  function do_ajax_form_unidad_validate_nombre__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_unidad_validate_nombre__cb

  // ---------- Validate idunidad_
  function do_ajax_form_unidad_validate_idunidad_(iNumLinha)
  {
    var nomeCampo_idunidad_ = "idunidad_" + iNumLinha;
    var var_idunidad_ = scAjaxGetFieldHidden(nomeCampo_idunidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_unidad_validate_idunidad_(var_idunidad_, iNumLinha, var_script_case_init, do_ajax_form_unidad_validate_idunidad__cb);
  } // do_ajax_form_unidad_validate_idunidad_

  function do_ajax_form_unidad_validate_idunidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idunidad_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idunidad_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idunidad_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idunidad_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_unidad_validate_idunidad__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_unidad_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_unidad_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_unidad_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_unidad_add_new_line_cb);
  } // do_ajax_form_unidad_add_new_line

  function do_ajax_form_unidad_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_unidad_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_unidad_backup_line(iNumLinha)
  {
    var var_idunidad_ = scAjaxGetFieldHidden("idunidad_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_unidad_backup_line(var_idunidad_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_unidad_backup_line_cb);
  } // do_ajax_form_unidad_backup_line

  function do_ajax_form_unidad_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_unidad_backup_line_cb

  function do_ajax_form_unidad_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_unidad_cancel_insert

  function do_ajax_form_unidad_cancel_update(iSeqVert)
  {
    do_ajax_form_unidad_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_unidad_cancel_update

  function do_ajax_form_unidad_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_unidad_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_unidad_table_refresh()
  {
    var var_idunidad_ = document.F2.idunidad_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_unidad_table_refresh(var_idunidad_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_unidad_table_refresh_cb);
  } //  do_ajax_form_unidad_table_refresh

  function do_ajax_form_unidad_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idunidad_.value = scAjaxGetKeyValue("idunidad_");
    ...
    scAjaxAlert(do_ajax_form_unidad_table_refresh_cb_after_alert);
  } // do_ajax_form_unidad_table_refresh_cb
  function do_ajax_form_unidad_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_unidad_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_unidad_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_unidad_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_unidad_submit_form(var_nombre_, var_idunidad_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_unidad_submit_form_cb);
  } // do_ajax_form_unidad_submit_form

  function do_ajax_form_unidad_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("idunidad_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_unidad_submit_form_cb_after_alert);
  } // do_ajax_form_unidad_submit_form_cb
  function do_ajax_form_unidad_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_unidad_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_unidad_navigate_form()
  {
    perform_ajax_form_unidad_navigate_form();
  }

  function perform_ajax_form_unidad_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_unidad_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("idunidad_" + iNavForm);
    }
    var var_idunidad_ = document.F2.idunidad_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_unidad_navigate_form(var_idunidad_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_unidad_navigate_form_cb);
  } // do_ajax_form_unidad_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_unidad']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_unidad_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idunidad_.value = scAjaxGetKeyValue("idunidad_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_unidad_navigate_form_cb_after_alert);
  } // do_ajax_form_unidad_navigate_form_cb
  function do_ajax_form_unidad_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_unidad_navigate_form_cb_after_alert
  function sc_hide_form_unidad_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idunidad_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["idunidad_" + iNumLinha] = {"label": "Id Unidad<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["nombre_"][iNumLinha] = "nombre_" + iNumLinha;
    ajax_field_mult["idunidad_"][iNumLinha] = "idunidad_" + iNumLinha;
    ...
    ajax_error_count["idunidad_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["nombre_" + iNumLinha] = "off";
    ajax_read_only["idunidad_" + iNumLinha] = "on";
<?php
}
else
{
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["idunidad_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["idunidad_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idunidad_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idunidad_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idunidad_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idunidad_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idunidad_'])) ? $this->nmgp_cmp_readonly['idunidad_'] : 'on';
?>
    scAjaxFieldRead("idunidad_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("nombre_" + iSeq, "on");
    scAjaxFieldRead("idunidad_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["nombre_" + iRow] || "on" == ajax_error_count["idunidad_" + iRow]))
    {
      ...
      $("#hidden_field_data_idunidad_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["nombre_" + iRow] && "off" == ajax_error_count["idunidad_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["nombre_" + iRow] = "off";
        ajax_error_count["idunidad_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_idunidad_" + iRow).removeClass("scFormErrorLine");
    }
  }
