...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["MealSint2_____grid_mediosdeverificacion"]))
   {
      unset($_SESSION['session_sec_aplicacao']["MealSint2_____grid_mediosdeverificacion"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_mediosdeverificacion']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_mediosdeverificacion']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_mediosdeverificacion']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_mediosdeverificacion']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_mediosdeverificacion']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_mediosdeverificacion</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_mediosdeverificacion']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_mediosdeverificacion']['embutida_filho'] as $ind => $sc_init)
          {
