<?php
@session_start() ;
$_SESSION['scriptcase']['grid_mediosdeverificacion']['sc_process_barr'] = true;
require_once('../grid_mediosdeverificacion/index.php');
unset($_SESSION['scriptcase']['grid_mediosdeverificacion']['sc_process_barr']);
$ExportCtrl = new grid_mediosdeverificacion_export_control;
$ExportCtrl->Export_barr();

class grid_mediosdeverificacion_export_control
{
