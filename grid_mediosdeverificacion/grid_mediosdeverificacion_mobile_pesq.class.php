...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "mdv_idmediosdeverificacion";$Nm_numeric[] = "mdv_idplanificacion";$Nm_numeric[] = "mdv_idmediosdeverificacion";$Nm_numeric[] = "mdv_idplanificacion";
...
<HTML>
<HEAD>
 <TITLE> mediosdeverificacion</TITLE>
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_mdv_nombre_cond" name="mdv_nombre_cond" onChange="nm_campos_between(document.getElementById('id_vis_mdv_nombre'), this, 'mdv_nombre')">
      ...
      <br><span id="id_hide_mdv_nombre"  <?php echo $str_hide_mdv_nombre?>><INPUT  type="text" id="SC_mdv_nombre" name="mdv_nombre" value="<?php echo NM_encode_input($mdv_nombre) ?>"  size=50 alt="{datatype: 'text', maxLength: 300, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
