<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tipodeactividad']['sc_process_barr'] = true;
require_once('../grid_tipodeactividad/index.php');
unset($_SESSION['scriptcase']['grid_tipodeactividad']['sc_process_barr']);
$ExportCtrl = new grid_tipodeactividad_export_control;
$ExportCtrl->Export_barr();

class grid_tipodeactividad_export_control
{
