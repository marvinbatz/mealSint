...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["MealSint2_____grid_tipodeactividad"]))
   {
      unset($_SESSION['session_sec_aplicacao']["MealSint2_____grid_tipodeactividad"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tipodeactividad']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tipodeactividad']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tipodeactividad']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tipodeactividad']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tipodeactividad']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tipodeactividad</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tipodeactividad']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tipodeactividad']['embutida_filho'] as $ind => $sc_init)
          {
