<?php
@session_start() ;
$_SESSION['scriptcase']['grid_indicador']['sc_process_barr'] = true;
require_once('../grid_indicador/index.php');
unset($_SESSION['scriptcase']['grid_indicador']['sc_process_barr']);
$ExportCtrl = new grid_indicador_export_control;
$ExportCtrl->Export_barr();

class grid_indicador_export_control
{
