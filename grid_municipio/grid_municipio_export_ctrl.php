<?php
@session_start() ;
$_SESSION['scriptcase']['grid_municipio']['sc_process_barr'] = true;
require_once('../grid_municipio/index.php');
unset($_SESSION['scriptcase']['grid_municipio']['sc_process_barr']);
$ExportCtrl = new grid_municipio_export_control;
$ExportCtrl->Export_barr();

class grid_municipio_export_control
{
