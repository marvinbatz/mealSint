<?php
@session_start() ;
$_SESSION['scriptcase']['grid_socioporproyecto_detalle']['sc_process_barr'] = true;
require_once('../grid_socioporproyecto_detalle/index.php');
unset($_SESSION['scriptcase']['grid_socioporproyecto_detalle']['sc_process_barr']);
$ExportCtrl = new grid_socioporproyecto_detalle_export_control;
$ExportCtrl->Export_barr();

class grid_socioporproyecto_detalle_export_control
{
