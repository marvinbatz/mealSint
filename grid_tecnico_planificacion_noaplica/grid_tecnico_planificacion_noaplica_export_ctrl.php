<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tecnico_planificacion_noaplica']['sc_process_barr'] = true;
require_once('../grid_tecnico_planificacion_noaplica/index.php');
unset($_SESSION['scriptcase']['grid_tecnico_planificacion_noaplica']['sc_process_barr']);
$ExportCtrl = new grid_tecnico_planificacion_noaplica_export_control;
$ExportCtrl->Export_barr();

class grid_tecnico_planificacion_noaplica_export_control
{
