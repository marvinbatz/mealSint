...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["MealSint2_____grid_tecnico_planificacion"]))
   {
      unset($_SESSION['session_sec_aplicacao']["MealSint2_____grid_tecnico_planificacion"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tecnico_planificacion']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tecnico_planificacion']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tecnico_planificacion']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tecnico_planificacion']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tecnico_planificacion']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tecnico_planificacion</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tecnico_planificacion']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tecnico_planificacion']['embutida_filho'] as $ind => $sc_init)
          {
