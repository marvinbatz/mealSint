...
class grid_jdp_beneficiario_dash_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_xls()
   {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash']['embutida']) {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash']['opcao'] = "";
      }
   }
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_jdp_beneficiario_dash/grid_jdp_beneficiario_dash_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              ...
              $this->Res_xls = new grid_jdp_beneficiario_dash_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_jdp_beneficiario_dash.zip";
          $this->Arquivo   .= "_grid_jdp_beneficiario_dash" . $this->Xls_tp;
          $this->Tit_doc    = "grid_jdp_beneficiario_dash" . $this->Xls_tp;
          $this->Tit_zip    = "grid_jdp_beneficiario_dash.zip";
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      $pos      = strrpos($this->Ini->link_grid_beneficiario_conteo_dash_cons_emb, '/');
      $link_xls = substr($this->Ini->link_grid_beneficiario_conteo_dash_cons_emb, 0, $pos) . "/grid_beneficiario_conteo_dash_xls.class.php";
      if (!is_file($this->Ini->link_grid_beneficiario_conteo_dash_cons_emb) || !is_file($link_xls))
      {
      ...
      $nm_raiz_img  = ""; 
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash']['field_order'] as $Cada_cmp)
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash']['where_pesq'];
      ...
      { 
          ...
          { 
              ...
              $nmgp_select_count .= " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash']['where_resumo']; 
          } 
          else
          { 
              $nmgp_select .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash']['where_resumo'] . ")"; 
              $nmgp_select_count .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash']['where_resumo'] . ")"; 
          } 
      } 
      $nmgp_select .= " group by pl.idPlanificacion"; 
      $nmgp_select_count .= " group by pl.idPlanificacion"; 
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash']['order_grid'];
      ...
      while (!$rs->EOF)
      {
         ...
         $this->pl_informacioncualitativa = $rs->fields[7] ;  
         $this->pl_observacionesadicionales = $rs->fields[8] ;  
         $this->unidad = $rs->fields[9] ;  
         $this->sc_field_1 = $rs->fields[10] ;  
         $this->sc_field_2 = $rs->fields[11] ;  
         $this->emergencia = $rs->fields[12] ;  
         $this->sc_field_3 = $rs->fields[13] ;  
         $this->indicador = $rs->fields[14] ;  
         $this->departamento = $rs->fields[15] ;  
         $this->municipio = $rs->fields[16] ;  
         $this->comunidad = $rs->fields[17] ;  
         $this->pl_colonia = $rs->fields[18] ;  
         $this->sc_field_4 = $rs->fields[19] ;  
         $this->sc_field_4 = (string)$this->sc_field_4;
         $this->estado = $rs->fields[20] ;  
         $this->p_idproyecto = $rs->fields[21] ;  
         $this->p_idproyecto = (string)$this->p_idproyecto;
         $this->pl_idplanificacion = $rs->fields[22] ;  
     ...
     $nm_houve_quebra = "N";
         ...
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash']['field_order'] as $Cada_col)
         { 
         ...
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash']['field_order'] as $Cada_col)
         { 
            if ($Cada_col == "conteo" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
            { 
                $xls_row_base = $this->Xls_row;
                if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash']['embutida'])
                { 
                    foreach ($this->Rows_sub_conteo as $line => $cols)
                    {
                        $this->Xls_row++;
                        $this->arr_export['lines'][$this->Xls_row] = $cols;
                    }
                    if (!empty($this->Rows_sub_conteo['lines']))
                    {
                ...
                { 
                    foreach ($this->Rows_sub_conteo as $lines)
                    {
                        $this->Xls_col = 0;
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   { 
      ...
      { 
          ...
          if ($Cada_col == "conteo" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->arr_span['conteo'] = $this->count_span;
              $this->Emb_label_cols_conteo = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_conteo_dash']['embutida'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_conteo_dash']['embutida_label'] = true;
              $GLOBALS["script_case_init"] = $this->Ini->sc_page;
                  ...
                  if (isset($_SESSION['scriptcase']['export_return']))
                  {
                     foreach ($_SESSION['scriptcase']['export_return']['label'] as $col => $dados)
                     {
                         if (isset($dados['col_span_i'])) {
                             $this->Emb_label_cols_conteo += $dados['col_span_i'];
                         }
                         elseif (isset($dados['col_span_f'])) {
                             $this->Emb_label_cols_conteo += $dados['col_span_f'];
                         }
                         else {
                             $this->Emb_label_cols_conteo++;
                         }
                     }
                  }
                  $this->count_span += $this->Emb_label_cols_conteo;
              }
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_conteo_dash']['embutida'] = false;
              ...
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash']['embutida'])
              { 
                  $this->arr_export['label'][$this->Xls_col]['col_span_f'] = $this->Emb_label_cols_conteo;
                  $this->Xls_col++;
              }
              else
              { 
                  $this->Xls_col += $this->Emb_label_cols_conteo;
              } 
          }
   ...
   //----- conteo
   function NM_export_conteo()
   {
         $GLOBALS["script_case_init"] = $this->Ini->sc_page;
         $GLOBALS["nmgp_parms"] = "nmgp_opcao?#?xls?@?gloplanificacion?#?" . str_replace("'", "@aspass@", $this->Orig_pl_idplanificacion) . "?@?";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_conteo_dash']['embutida'] = true;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_beneficiario_conteo_dash']['nolabel'] = true;
         if (method_exists($this->grid_beneficiario_conteo_dash, "controle"))
         {
             $this->grid_beneficiario_conteo_dash->controle();
             if (isset($_SESSION['scriptcase']['export_return']))
             {
                 $this->Rows_sub_conteo = array();
                 if (isset($_SESSION['scriptcase']['export_return']['label']))
                 {
                     $_SESSION['scriptcase']['export_return']['label'][0]['col_span_i'] = $this->arr_span['conteo'];
                     $this->Xls_col += $this->Emb_label_cols_conteo;
                 }
                 if (isset($_SESSION['scriptcase']['export_return']['lines']))
                 {
                     foreach ($_SESSION['scriptcase']['export_return']['lines'] as $line => $cols)
                     {
                         ...
                         {
                             $this->Rows_sub_conteo[$line][$icol] = $dados;
                             if ($prim_col)
                             {
                                 if (isset($this->Rows_sub_conteo[$line][$icol]['col_span_i']))
                                 {
                                    $this->Rows_sub_conteo[$line][$icol]['col_span_i'] += $this->arr_span['conteo'];
                                 }
                                 else
                                 {
                                    $this->Rows_sub_conteo[$line][$icol]['col_span_i'] = $this->arr_span['conteo'];
             ...
             if (isset($_SESSION['scriptcase']['export_return']))
             {
                 ...
                 if (isset($_SESSION['scriptcase']['export_return']['lines']))
                 {
                     ...
                     foreach ($_SESSION['scriptcase']['export_return']['lines'] as $line => $cols)
                     {
                         ...
                         foreach ($cols as $icol => $dados)
                         {
                             $this->Rows_sub_conteo[$this->row_sub][$icol] = $dados;
                             if ($prim_col && $this->row_sub > 1)
                             {
                                 if (isset($this->Rows_sub_conteo[$this->row_sub][$icol]['col_span_i']))
                                 {
                                    $this->Rows_sub_conteo[$this->row_sub][$icol]['col_span_i'] += $this->arr_span['conteo'];
                                 }
                                 else
                                 {
                                    $this->Rows_sub_conteo[$this->row_sub][$icol]['col_span_i'] = $this->arr_span['conteo'];
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash']['nolabel'])
       {
 ...
 function quebra_p_idproyecto_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   function quebra_p_idproyecto_sc_free_group_by_top()
   {
       if ($this->groupby_show != "S") {
           return;
       }
       ...
       $temp_cmp = "";
       $cont_col = 0;
       foreach ($this->campos_quebra_p_idproyecto as $cada_campo) {
           if ($cont_col == $lim_col) {
   ...
   function quebra_p_idproyecto_sc_free_group_by_bot()
   {
       if ($this->groupby_show != "S") {
           return;
       }
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash']['field_order'] as $Cada_cmp)
       {
           if (!isset($this->NM_cmp_hidden[$Cada_cmp]) || $this->NM_cmp_hidden[$Cada_cmp] != "off")
           {
               ...
               elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash']['embutida']) {
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash'][$path_doc_md5][1] = $this->Tit_doc;
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jdp_beneficiario_dash']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
