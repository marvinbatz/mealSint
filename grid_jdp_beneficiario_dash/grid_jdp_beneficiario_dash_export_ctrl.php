<?php
@session_start() ;
$_SESSION['scriptcase']['grid_jdp_beneficiario_dash']['sc_process_barr'] = true;
require_once('../grid_jdp_beneficiario_dash/index.php');
unset($_SESSION['scriptcase']['grid_jdp_beneficiario_dash']['sc_process_barr']);
$ExportCtrl = new grid_jdp_beneficiario_dash_export_control;
$ExportCtrl->Export_barr();

class grid_jdp_beneficiario_dash_export_control
{
