  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_departamento" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_departamento_form();
	}
...
?>
  ...
  // ---------- Validate nombre
  function do_ajax_form_departamento_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_departamento_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_departamento_validate_nombre_cb);
  } // do_ajax_form_departamento_validate_nombre

  function do_ajax_form_departamento_validate_nombre_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_departamento_validate_nombre_cb

  // ---------- Validate coddepartamento
  function do_ajax_form_departamento_validate_coddepartamento()
  {
    var nomeCampo_coddepartamento = "coddepartamento";
    var var_coddepartamento = scAjaxGetFieldText(nomeCampo_coddepartamento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_departamento_validate_coddepartamento(var_coddepartamento, var_script_case_init, do_ajax_form_departamento_validate_coddepartamento_cb);
  } // do_ajax_form_departamento_validate_coddepartamento

  function do_ajax_form_departamento_validate_coddepartamento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "coddepartamento";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_departamento_validate_coddepartamento_cb

  // ---------- Validate lat
  function do_ajax_form_departamento_validate_lat()
  {
    var nomeCampo_lat = "lat";
    var var_lat = scAjaxGetFieldText(nomeCampo_lat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_departamento_validate_lat(var_lat, var_script_case_init, do_ajax_form_departamento_validate_lat_cb);
  } // do_ajax_form_departamento_validate_lat

  function do_ajax_form_departamento_validate_lat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "lat";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_departamento_validate_lat_cb

  // ---------- Validate lon
  function do_ajax_form_departamento_validate_lon()
  {
    var nomeCampo_lon = "lon";
    var var_lon = scAjaxGetFieldText(nomeCampo_lon);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_departamento_validate_lon(var_lon, var_script_case_init, do_ajax_form_departamento_validate_lon_cb);
  } // do_ajax_form_departamento_validate_lon

  function do_ajax_form_departamento_validate_lon_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "lon";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_departamento_validate_lon_cb

  // ---------- Validate municipio
  function do_ajax_form_departamento_validate_municipio()
  {
    var nomeCampo_municipio = "municipio";
    var var_municipio = scAjaxGetFieldText(nomeCampo_municipio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_departamento_validate_municipio(var_municipio, var_script_case_init, do_ajax_form_departamento_validate_municipio_cb);
  } // do_ajax_form_departamento_validate_municipio

  function do_ajax_form_departamento_validate_municipio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "municipio";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_departamento_validate_municipio_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_departamento_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_departamento_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_nombre = scAjaxGetFieldText("nombre");
    var var_coddepartamento = scAjaxGetFieldText("coddepartamento");
    var var_lat = scAjaxGetFieldText("lat");
    var var_lon = scAjaxGetFieldText("lon");
    ...
    scAjaxProcOn();
    x_ajax_form_departamento_submit_form(var_nombre, var_coddepartamento, var_lat, var_lon, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_departamento_submit_form_cb);
  } // do_ajax_form_departamento_submit_form

  function do_ajax_form_departamento_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("nombre");
      scAjaxHideErrorDisplay("coddepartamento");
      scAjaxHideErrorDisplay("lat");
      scAjaxHideErrorDisplay("lon");
      scAjaxHideErrorDisplay("municipio");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_departamento_submit_form_cb_after_alert);
  } // do_ajax_form_departamento_submit_form_cb
  function do_ajax_form_departamento_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_departamento_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_municipio"] = "off";

  function do_ajax_form_departamento_navigate_form()
  {
    perform_ajax_form_departamento_navigate_form();
  }

  function perform_ajax_form_departamento_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("lon");
    scAjaxHideErrorDisplay("municipio");
    var var_iddepartamento = document.F2.iddepartamento.value;
    ...
    scAjaxProcOn();
    scStatusDetail["form_municipio"] = "on";
    x_ajax_form_departamento_navigate_form(var_iddepartamento, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_departamento_navigate_form_cb);
  } // do_ajax_form_departamento_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_departamento']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_departamento_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.iddepartamento.value = scAjaxGetKeyValue("iddepartamento");
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_municipio"] && "nmsc_iframe_liga_form_municipio" != scMasterDetailIframe["nmsc_iframe_liga_form_municipio"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_municipio"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_municipio').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_municipio').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_municipio').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_departamento_navigate_form_cb_after_alert);
  } // do_ajax_form_departamento_navigate_form_cb
  function do_ajax_form_departamento_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_departamento_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_departamento_navigate_form_cb_after_alert
  function sc_hide_form_departamento_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_municipio"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "nombre";
  ajax_field_list[1] = "coddepartamento";
  ajax_field_list[2] = "lat";
  ajax_field_list[3] = "lon";
  ajax_field_list[4] = "municipio";
  ...
  var ajax_error_list = {
    "nombre": {"label": "Nombre", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "coddepartamento": {"label": "Cod Departamento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "lat": {"label": "Latitud", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "lon": {"label": "Longitud", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "municipio": {"label": "Municipios", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "nombre": new Array(),
    "coddepartamento": new Array(),
    "lat": new Array(),
    "lon": new Array(),
    "municipio": new Array()
  };
  ajax_field_mult["nombre"][1] = "nombre";
  ajax_field_mult["coddepartamento"][1] = "coddepartamento";
  ajax_field_mult["lat"][1] = "lat";
  ajax_field_mult["lon"][1] = "lon";
  ajax_field_mult["municipio"][1] = "municipio";

  var ajax_field_id = {
    "nombre": new Array("hidden_field_label_nombre", "hidden_field_data_nombre"),
    "coddepartamento": new Array("hidden_field_label_coddepartamento", "hidden_field_data_coddepartamento"),
    "lat": new Array("hidden_field_label_lat", "hidden_field_data_lat"),
    "lon": new Array("hidden_field_label_lon", "hidden_field_data_lon"),
    "municipio": new Array("hidden_field_label_municipio", "hidden_field_data_municipio")
  };
