<?php
@session_start() ;
$_SESSION['scriptcase']['grid_personasporhogar']['sc_process_barr'] = true;
require_once('../grid_personasporhogar/index.php');
unset($_SESSION['scriptcase']['grid_personasporhogar']['sc_process_barr']);
$ExportCtrl = new grid_personasporhogar_export_control;
$ExportCtrl->Export_barr();

class grid_personasporhogar_export_control
{
