...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["MealSint2_____grid_dir_indicadores_avance"]))
   {
      unset($_SESSION['session_sec_aplicacao']["MealSint2_____grid_dir_indicadores_avance"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_dir_indicadores_avance']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_dir_indicadores_avance']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_dir_indicadores_avance']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_dir_indicadores_avance']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_dir_indicadores_avance']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_dir_indicadores_avance</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_dir_indicadores_avance']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_dir_indicadores_avance']['embutida_filho'] as $ind => $sc_init)
          {
