...
class grid_dir_indicadores_avance_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_dir_indicadores_avance/grid_dir_indicadores_avance_res_xml.class.php"))
      {
          $this->Tem_xml_res  = false;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_indicadores_avance']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_indicadores_avance']['xml_label']))
      {
          $this->Xml_tag_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_indicadores_avance']['xml_label'];
          $this->New_Format    = true;
      }
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_indicadores_avance']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_indicadores_avance']['xml_return']);
          if ($this->Tem_xml_res) {
      ...
      $this->Arquivo     .= "_grid_dir_indicadores_avance";
      $this->Arquivo_view = $this->Arquivo . "_view.xml";
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "grid_dir_indicadores_avance.xml";
   ...
   function grava_arquivo()
   {
      ...
      $link_xml = substr($this->Ini->link_grid_dir_indicador_progreso_cons_emb, 0, $pos) . "/grid_dir_indicador_progreso_xml.class.php";
      if (!is_file($this->Ini->link_grid_dir_indicador_progreso_cons_emb) || !is_file($link_xml))
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_indicadores_avance']['xml_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_indicadores_avance']['xml_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_indicadores_avance']['xml_name'] .= ".xml";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_indicadores_avance']['xml_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_indicadores_avance']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_indicadores_avance']['xml_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_indicadores_avance']['xml_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_indicadores_avance']['xml_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_indicadores_avance']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_indicadores_avance']['embutida'])
         { 
             $this->xml_registro .= "<" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_indicadores_avance']['embutida_tit'] . ">\r\n";
         }
         elseif ($this->New_Format)
         {
             $this->xml_registro = "<grid_dir_indicadores_avance>\r\n";
         }
         else
         {
             $this->xml_registro = "<grid_dir_indicadores_avance";
      ...
      { 
          ...
          { 
              ...
              $this->Res = new grid_dir_indicadores_avance_res_xml();
              $this->prep_modulos("Res");
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_indicadores_avance']['xml_res_grid'] = true;
              $this->Res->monta_xml();
          } 
          if (!$this->Ini->sc_export_ajax) {
          ...
          { 
              ...
              { 
                  $str_zip   = "";
                  $Arq_res   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_indicadores_avance']['xml_res_file']['xml'];
                  ...
                  unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_indicadores_avance']['xml_res_file']['xml']);
              }
              if ($this->Grava_view)
              {
                  $str_zip    = "";
                  ...
                  { 
                      $str_zip   = "";
                      $Arq_res   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_indicadores_avance']['xml_res_file']['view'];
                      $Arq_input = (FALSE !== strpos($Arq_res, ' ')) ? " \"" . $Arq_res . "\"" :  $Arq_res;
                      if (FALSE !== strpos(strtolower(php_uname()), 'windows')) 
                      {
                          $str_zip = "zip.exe " . strtoupper($Parm_pass) . " -j -u " . $this->Xml_password . " " . $Zip_f . " " . $Arq_input;
                      ...
                      unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_indicadores_avance']['xml_res_file']['view']);
                  }
              } 
              else 
              {
              ...
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_indicadores_avance']['xml_res_grid']);
          } 
      }
   ...
   {
         nmgp_Form_Num_Val($this->look_planmeal_idobjetivo_resultado, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->look_planmeal_idobjetivo_resultado))
         {
             $this->look_planmeal_idobjetivo_resultado = sc_convert_encoding($this->look_planmeal_idobjetivo_resultado, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         ...
         {
             $SC_Label = "planmeal_idobjetivo_resultado"; 
         }
         $this->clear_tag($SC_Label); 
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->look_planmeal_idobjetivo_resultado) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->look_planmeal_idobjetivo_resultado) . "\"";
         }
   }
   //----- planmeal_codigo
   function NM_export_planmeal_codigo()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->planmeal_codigo))
         {
             $this->planmeal_codigo = sc_convert_encoding($this->planmeal_codigo, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         if ($this->Xml_tag_label)
         {
         ...
         {
             $SC_Label = "planmeal_codigo"; 
         }
         $this->clear_tag($SC_Label); 
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->planmeal_codigo) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->planmeal_codigo) . "\"";
         }
   }
   //----- planmeal_indicador
   function NM_export_planmeal_indicador()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->planmeal_indicador))
         {
             $this->planmeal_indicador = sc_convert_encoding($this->planmeal_indicador, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         if ($this->Xml_tag_label)
         {
         ...
         {
             $SC_Label = "planmeal_indicador"; 
         }
         $this->clear_tag($SC_Label); 
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->planmeal_indicador) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->planmeal_indicador) . "\"";
         }
   }
   //----- planmeal_definicion_metodologia
   function NM_export_planmeal_definicion_metodologia()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->planmeal_definicion_metodologia))
         {
             $this->planmeal_definicion_metodologia = sc_convert_encoding($this->planmeal_definicion_metodologia, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         if ($this->Xml_tag_label)
         {
         ...
         {
             $SC_Label = "planmeal_definicion_metodologia"; 
         }
         $this->clear_tag($SC_Label); 
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->planmeal_definicion_metodologia) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->planmeal_definicion_metodologia) . "\"";
         }
   }
   //----- planmeal_idunidaddemedida
   function NM_export_planmeal_idunidaddemedida()
   {
         nmgp_Form_Num_Val($this->look_planmeal_idunidaddemedida, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->look_planmeal_idunidaddemedida))
         {
             $this->look_planmeal_idunidaddemedida = sc_convert_encoding($this->look_planmeal_idunidaddemedida, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         if ($this->Xml_tag_label)
         {
         ...
         {
             $SC_Label = "planmeal_idunidaddemedida"; 
         }
         $this->clear_tag($SC_Label); 
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->look_planmeal_idunidaddemedida) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->look_planmeal_idunidaddemedida) . "\"";
         }
   }
   //----- planmeal_descripcionalcance
   function NM_export_planmeal_descripcionalcance()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->planmeal_descripcionalcance))
         {
             $this->planmeal_descripcionalcance = sc_convert_encoding($this->planmeal_descripcionalcance, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         if ($this->Xml_tag_label)
         {
         ...
         {
             $SC_Label = "planmeal_descripcionalcance"; 
         }
         $this->clear_tag($SC_Label); 
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->planmeal_descripcionalcance) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->planmeal_descripcionalcance) . "\"";
         }
   }
   //----- avance
   function NM_export_avance()
   {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_indicador_progreso']['embutida']  = true;
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_indicador_progreso']['xml_label'] = $this->Xml_tag_label;
                  $GLOBALS["script_case_init"] = $this->Ini->sc_page;
                  $GLOBALS["nmgp_parms"] = "nmgp_opcao?#?xml?@?";
                  $detailParameters = array();
                  $detailParameters[] = "gloplanmeal?#?" . str_replace("'", "@aspass@", $this->Orig_planmeal_idplanmeal);
                  ...
                  $this->clear_tag($SC_Label); 
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_indicador_progreso']['embutida_tit'] = "avance";
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_indicador_progreso']['embutida_xml_format'] = $this->New_Format;
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_indicadores_avance']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_indicadores_avance']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> planmeal :: XML</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_indicadores_avance']['xml_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
