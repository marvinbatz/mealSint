...
Id_Btn_selected[1] = "sel_groupby_top";
Id_Btn_selected[2] = "dynamic_search_top";
function ajax_navigate(opc, parm)
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_grid_dir_indicadores_avance').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_grid_dir_indicadores_avance').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_grid_dir_indicadores_avance').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_grid_dir_indicadores_avance').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_grid_dir_indicadores_avance').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_grid_dir_indicadores_avance').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_grid_dir_indicadores_avance').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_grid_dir_indicadores_avance').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_grid_dir_indicadores_avance').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_grid_dir_indicadores_avance').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_grid_dir_indicadores_avance').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_grid_dir_indicadores_avance').style.width  = '0px';
        if (oResp["setValue"]) {
...
function ajax_add_dyn_search(str_field, str_origem)
{
    ...
    $.ajax({
      type: "POST",
      url: "index.php",
      data: "nmgp_opcao=ajax_add_dyn_search&script_case_init=" + document.Fdyn_search.script_case_init.value + "&parm=" + parm + "&seq=" + Tot_obj_dyn_search + "&origem=" + str_origem
     })
     .done(function(jsonDyn_add) {
        var i, oResp;
        ...
        scLoadScInput('#dyn_search_' + parm + '_' + Tot_obj_dyn_search + ' input:text.sc-js-input');
