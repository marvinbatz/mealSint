  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tipodonacion_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tipodonacion_mob_form();
	}
...
?>
  ...
  // ---------- Validate idtipodonacion
  function do_ajax_form_tipodonacion_mob_validate_idtipodonacion()
  {
    var nomeCampo_idtipodonacion = "idtipodonacion";
    var var_idtipodonacion = scAjaxGetFieldHidden(nomeCampo_idtipodonacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipodonacion_mob_validate_idtipodonacion(var_idtipodonacion, var_script_case_init, do_ajax_form_tipodonacion_mob_validate_idtipodonacion_cb);
  } // do_ajax_form_tipodonacion_mob_validate_idtipodonacion

  function do_ajax_form_tipodonacion_mob_validate_idtipodonacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idtipodonacion";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipodonacion_mob_validate_idtipodonacion_cb

  // ---------- Validate nombre
  function do_ajax_form_tipodonacion_mob_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipodonacion_mob_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_tipodonacion_mob_validate_nombre_cb);
  } // do_ajax_form_tipodonacion_mob_validate_nombre

  function do_ajax_form_tipodonacion_mob_validate_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipodonacion_mob_validate_nombre_cb

  // ---------- Validate descripcion
  function do_ajax_form_tipodonacion_mob_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipodonacion_mob_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_tipodonacion_mob_validate_descripcion_cb);
  } // do_ajax_form_tipodonacion_mob_validate_descripcion

  function do_ajax_form_tipodonacion_mob_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipodonacion_mob_validate_descripcion_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tipodonacion_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tipodonacion_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idtipodonacion = scAjaxGetFieldHidden("idtipodonacion");
    ...
    scAjaxProcOn();
    x_ajax_form_tipodonacion_mob_submit_form(var_idtipodonacion, var_nombre, var_descripcion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tipodonacion_mob_submit_form_cb);
  } // do_ajax_form_tipodonacion_mob_submit_form

  function do_ajax_form_tipodonacion_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idtipodonacion");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tipodonacion_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tipodonacion_mob_submit_form_cb
  function do_ajax_form_tipodonacion_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tipodonacion_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tipodonacion_mob_navigate_form()
  {
    perform_ajax_form_tipodonacion_mob_navigate_form();
  }

  function perform_ajax_form_tipodonacion_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("nombre");
    scAjaxHideErrorDisplay("descripcion");
    var var_idtipodonacion = document.F2.idtipodonacion.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tipodonacion_mob_navigate_form(var_idtipodonacion, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tipodonacion_mob_navigate_form_cb);
  } // do_ajax_form_tipodonacion_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tipodonacion_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tipodonacion_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idtipodonacion.value = scAjaxGetKeyValue("idtipodonacion");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tipodonacion_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tipodonacion_mob_navigate_form_cb
  function do_ajax_form_tipodonacion_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_tipodonacion_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tipodonacion_mob_navigate_form_cb_after_alert
  function sc_hide_form_tipodonacion_mob_form()
  {
  ...
  ajax_field_list[0] = "idtipodonacion";
  ajax_field_list[1] = "nombre";
  ajax_field_list[2] = "descripcion";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "idtipodonacion": {"label": "Id Tipo Donacion", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "idtipodonacion": new Array(),
    "nombre": new Array(),
    "descripcion": new Array()
  };
  ajax_field_mult["idtipodonacion"][1] = "idtipodonacion";
