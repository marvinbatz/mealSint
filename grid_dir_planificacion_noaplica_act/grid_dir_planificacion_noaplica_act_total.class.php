...
class grid_dir_planificacion_noaplica_act_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_dir_planificacion_noaplica_act']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_dir_planificacion_noaplica_act']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang , $pl_idplanificacion, $conteobeneficiario, $sumaindicador;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_planificacion_noaplica_act']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_planificacion_noaplica_act']['tot_geral'] = array() ;  
      $nm_comando = "select count(*) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_planificacion_noaplica_act']['where_pesq']; 
      $nm_comando .= " group by pl.idPlanificacion"; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_planificacion_noaplica_act']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      while (!$rt->EOF) 
      {
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_planificacion_noaplica_act']['tot_geral'][1])) 
         {
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_planificacion_noaplica_act']['tot_geral'][1] = 1 ; 
         } 
         else
         {
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_planificacion_noaplica_act']['tot_geral'][1] += 1 ; 
      ...
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_planificacion_noaplica_act']['contr_total_geral'] = "OK";
   } 

   //-----  pl_idproyecto
   function quebra_pl_idproyecto_sc_free_group_by($pl_idproyecto, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb, $pl_idplanificacion, $conteobeneficiario, $sumaindicador;
      $tot_pl_idproyecto = array() ;  
      $tot_pl_idproyecto[0] = $pl_idproyecto ; 
   }
   //-----  pl_codsocio
   function quebra_pl_codsocio_sc_free_group_by($pl_codsocio, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb, $pl_idplanificacion, $conteobeneficiario, $sumaindicador;
      $tot_pl_codsocio = array() ;  
      $tot_pl_codsocio[0] = $pl_codsocio ; 
   }

   //----- 
   function Calc_resumo_sc_free_group_by($destino_resumo)
   {
      global $nm_lang, $sumaindicador, $conteobeneficiario, $avance, $reporte, $pl_idplanificacion, $conteobeneficiario, $sumaindicador;
      $this->nm_data = new nm_data("es");
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_planificacion_noaplica_act']['sql_tot_res']);
      ...
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_planificacion_noaplica_act']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('pl_idproyecto' => "pl.idProyecto",'pl_codsocio' => "pl.codSocio");
      $cmps_quebra_atual = array();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_planificacion_noaplica_act']['SC_Gb_Free_cmp'] as $cmp => $resto)
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_planificacion_noaplica_act']['arr_total'] = array();
      foreach ($cmps_quebra_atual as $cmp_gb)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_planificacion_noaplica_act']['arr_total'][$cmp_gb] = $this->$Arr_tot_name;
      }
   }
   ...
   function Res_Totaliza_sc_free_group_by($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def)
   {
      ...
      $cmp_sql_tp_num = array('pl_idplanificacion' => 'N','pl_idproyecto' => 'N','avance' => 'N','conteobeneficiario' => 'N','sumaindicador' => 'N');
     ...
     $comando .= " ON " . $join;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_planificacion_noaplica_act']['sql_tot_res']))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_planificacion_noaplica_act']['sql_tot_res'] = str_replace("#@#cmps_quebras#@#", "", $comando);
      }
      $comando  = str_replace("#@#cmps_quebras#@#", "," . $cmps_quebras, $comando);
      $comando .= " group by " . $cmps_quebras . " order by " .  $cmps_quebras;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_planificacion_noaplica_act']['Res_search_metric_use']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dir_planificacion_noaplica_act']['Res_search_metric_use']))
      {
          $comando = $cmd_simp;
          $cmps_S  = "";
      ...
      $format_dimensions['pl_idproyecto']['reg'] = "S";
      $format_dimensions['pl_idproyecto']['msk'] = "";
      $format_dimensions['pl_codsocio']['reg'] = "S";
      $format_dimensions['pl_codsocio']['msk'] = "";
      while (!$rt->EOF)
      {
          $sql_where = "";
          foreach ($Cmp_dim as $Cada_dim => $Ind_sql)
          {
              ...
              if ($Cada_dim == "pl_idproyecto") {
                  $this->Lookup->lookup_sc_free_group_by_pl_idproyecto($$Cada_dim,  $pl_idproyecto);
              }
              if ($Cada_dim == "pl_codsocio") {
              }
              if (null === $$Cada_dim)
              {
                  $$Cada_dim = '';
