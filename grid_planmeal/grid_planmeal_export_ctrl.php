<?php
@session_start() ;
$_SESSION['scriptcase']['grid_planmeal']['sc_process_barr'] = true;
require_once('../grid_planmeal/index.php');
unset($_SESSION['scriptcase']['grid_planmeal']['sc_process_barr']);
$ExportCtrl = new grid_planmeal_export_control;
$ExportCtrl->Export_barr();

class grid_planmeal_export_control
{
