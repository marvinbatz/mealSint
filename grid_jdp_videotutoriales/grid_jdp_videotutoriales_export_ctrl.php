<?php
@session_start() ;
$_SESSION['scriptcase']['grid_jdp_videotutoriales']['sc_process_barr'] = true;
require_once('../grid_jdp_videotutoriales/index.php');
unset($_SESSION['scriptcase']['grid_jdp_videotutoriales']['sc_process_barr']);
$ExportCtrl = new grid_jdp_videotutoriales_export_control;
$ExportCtrl->Export_barr();

class grid_jdp_videotutoriales_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> actividad</TITLE>
