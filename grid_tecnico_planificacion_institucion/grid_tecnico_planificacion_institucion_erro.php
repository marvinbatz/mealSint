...
function scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['grid_tecnico_planificacion_institucion']['contr_erro']) && $_SESSION['scriptcase']['grid_tecnico_planificacion_institucion']['contr_erro'] == 'on')
    {
