...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_p_foto_cond" name="p_foto_cond" onChange="nm_campos_between(document.getElementById('id_vis_p_foto'), this, 'p_foto')">
      ...
      <br><span id="id_hide_p_foto"  <?php echo $str_hide_p_foto?>><INPUT  type="text" id="SC_p_foto" name="p_foto" value="<?php echo NM_encode_input($p_foto) ?>" size="50" maxlength="32767" class="scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_p_nombre_cond" name="p_nombre_cond" onChange="nm_campos_between(document.getElementById('id_vis_p_nombre'), this, 'p_nombre')">
