<?php
@session_start() ;
$_SESSION['scriptcase']['grid_unidad']['sc_process_barr'] = true;
require_once('../grid_unidad/index.php');
unset($_SESSION['scriptcase']['grid_unidad']['sc_process_barr']);
$ExportCtrl = new grid_unidad_export_control;
$ExportCtrl->Export_barr();

class grid_unidad_export_control
{
