...
include_once('dashboard_indicadores_session.php');
@ini_set('session.cookie_httponly', 1);
@ini_set('session.use_only_cookies', 1);
@ini_set('session.cookie_secure', 0);
@session_start();

$_SESSION['scriptcase']['dashboard_indicadores']['glo_nm_perfil']          = "";
$_SESSION['scriptcase']['dashboard_indicadores']['glo_nm_path_prod']       = "";
$_SESSION['scriptcase']['dashboard_indicadores']['glo_nm_path_imagens']    = "";
$_SESSION['scriptcase']['dashboard_indicadores']['glo_nm_path_imag_temp']  = "";
$_SESSION['scriptcase']['dashboard_indicadores']['glo_nm_path_doc']        = "";
...
//check prod
if(empty($_SESSION['scriptcase']['dashboard_indicadores']['glo_nm_path_prod']))
{
    /*check prod*/$_SESSION['scriptcase']['dashboard_indicadores']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
}
//check img
if(empty($_SESSION['scriptcase']['dashboard_indicadores']['glo_nm_path_imagens']))
{
    /*check img*/$_SESSION['scriptcase']['dashboard_indicadores']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
}
//check tmp
if(empty($_SESSION['scriptcase']['dashboard_indicadores']['glo_nm_path_imag_temp']))
{
    /*check tmp*/$_SESSION['scriptcase']['dashboard_indicadores']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
}
//check doc
if(empty($_SESSION['scriptcase']['dashboard_indicadores']['glo_nm_path_doc']))
{
    /*check doc*/$_SESSION['scriptcase']['dashboard_indicadores']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
}
...
if (!empty($_POST))
{
    foreach ($_POST as $nmgp_var => $nmgp_val)
    {
        ...
        nm_limpa_str_dashboard_indicadores($nmgp_val);
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['dashboard_indicadores']['glo_nm_path_imag_temp'] . "/sc_apl_default_MealSint2.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['dashboard_indicadores']['glo_nm_path_imag_temp'] . "/sc_apl_default_MealSint2.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "dashboard_indicadores") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['dashboard_indicadores']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['dashboard_indicadores']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['dashboard_indicadores']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_MealSint2'])) {
            $_SESSION['scriptcase']['dashboard_indicadores']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_MealSint2'];
        }
    }
}
if (isset($nmgp_parms) && !empty($nmgp_parms) && !is_array($nmgp_parms))
{
    ...
    while (!empty($todo[$ix]))
    {
       ...
       if (1 < sizeof($cadapar))
       {
           ...
           nm_limpa_str_dashboard_indicadores($cadapar[1]);
...
elseif (isset($script_case_init) && !empty($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['dashboard_indicadores']['parms']))
{
    if (!isset($nmgp_opcao) || ($nmgp_opcao != "incluir" && $nmgp_opcao != "novo" && $nmgp_opcao != "recarga" && $nmgp_opcao != "muda_form"))
    {
        $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['dashboard_indicadores']['parms']);
        $todo  = explode("?@?", $todox);
        $ix = 0;
        while (!empty($todo[$ix]))
        {
...
$dashboard_indicadores_control = new dashboard_indicadores_control();
$dashboard_indicadores_control->control();

class dashboard_indicadores_ini {
    ...
    function init()
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->sc_page]['dashboard_indicadores'])) {
            $_SESSION['sc_session'][$this->sc_page]['dashboard_indicadores'] = array();
        }
        if (!isset($_SESSION['sc_session'][$this->sc_page]['dashboard_indicadores']['embutida_form'])) {
            $_SESSION['sc_session'][$this->sc_page]['dashboard_indicadores']['embutida_form'] = false;
        }
        if (!isset($_SESSION['sc_session'][$this->sc_page]['dashboard_indicadores']['embutida_proc'])) {
            $_SESSION['sc_session'][$this->sc_page]['dashboard_indicadores']['embutida_proc'] = false;
        }
        if (!isset($_SESSION['sc_session'][$this->sc_page]['dashboard_indicadores']['iframe_menu'])) {
            $_SESSION['sc_session'][$this->sc_page]['dashboard_indicadores']['iframe_menu'] = false;
        }

        $this->nm_cod_apl      = "dashboard_indicadores";
        $this->nm_nome_apl     = "";
        $this->nm_seguranca    = "";
        ...
        $this->sc_protocolo   = "";
        $this->path_prod      = $_SESSION['scriptcase']['dashboard_indicadores']['glo_nm_path_prod'];
        $this->path_imagens   = $_SESSION['scriptcase']['dashboard_indicadores']['glo_nm_path_imagens'];
        $this->path_imag_temp = $_SESSION['scriptcase']['dashboard_indicadores']['glo_nm_path_imag_temp'];
        $this->path_doc       = $_SESSION['scriptcase']['dashboard_indicadores']['glo_nm_path_doc'];
        ...
        $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/dashboard_indicadores';
        ...
        if (isset($_SESSION['scriptcase']['dashboard_indicadores']['session_timeout']['lang'])) {
            $this->str_lang = $_SESSION['scriptcase']['dashboard_indicadores']['session_timeout']['lang'];
        }
        elseif (!isset($_SESSION['scriptcase']['dashboard_indicadores']['actual_lang']) || $_SESSION['scriptcase']['dashboard_indicadores']['actual_lang'] != $this->str_lang) {
            $_SESSION['scriptcase']['dashboard_indicadores']['actual_lang'] = $this->str_lang;
        ...
        if (isset($_SESSION['scriptcase']['dashboard_indicadores']['session_timeout']['redir'])) {
            ...
            if ($_SESSION['scriptcase']['dashboard_indicadores']['session_timeout']['redir_tp'] == "R") {
                $SS_cod_html .= "  </HEAD>\r\n";
                $SS_cod_html .= "   <body>\r\n";
            }
            else {
                ...
                $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['dashboard_indicadores']['session_timeout']['redir'] . "');\">\r\n";
                $SS_cod_html .= "     </form>\r\n";
            ...
            if ($_SESSION['scriptcase']['dashboard_indicadores']['session_timeout']['redir_tp'] == "R") {
                $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['dashboard_indicadores']['session_timeout']['redir'] . "');\r\n";
            }
            ...
            $SS_cod_html .= " </body>\r\n";
            $SS_cod_html .= "</HTML>\r\n";
            unset($_SESSION['scriptcase']['dashboard_indicadores']['session_timeout']);
   ...
   {
      $con_devel             =  (isset($_SESSION['scriptcase']['dashboard_indicadores']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['dashboard_indicadores']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      ...
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['dashboard_indicadores']['glo_nm_conexao']) && $_SESSION['scriptcase']['dashboard_indicadores']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['dashboard_indicadores']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['dashboard_indicadores']['glo_nm_perfil']) && $_SESSION['scriptcase']['dashboard_indicadores']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['dashboard_indicadores']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['dashboard_indicadores']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['dashboard_indicadores']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      if (isset($_SESSION['scriptcase']['dashboard_indicadores']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['dashboard_indicadores']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['dashboard_indicadores']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['dashboard_indicadores']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['dashboard_indicadores']['glo_nm_perfil'];
      }
...
// 
      ...
      {
         $_SESSION['sc_session'][$this->sc_page]['dashboard_indicadores']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['dashboard_indicadores']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['dashboard_indicadores']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
          {
              $_SESSION['sc_session'][$this->sc_page]['dashboard_indicadores']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['dashboard_indicadores']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['dashboard_indicadores']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['dashboard_indicadores']['SC_sep_date1'];
      }
// 
      if (!empty($this->nm_falta_var) || !empty($this->nm_falta_var_db) || $nm_crit_perfil)
      {
          ...
          echo "</table>";
          if (!$_SESSION['sc_session'][$this->sc_page]['dashboard_indicadores']['iframe_menu'] && (!isset($_SESSION['sc_session'][$this->sc_page]['dashboard_indicadores']['sc_outra_jan']) || $_SESSION['sc_session'][$this->sc_page]['dashboard_indicadores']['sc_outra_jan'] != 'dashboard_indicadores')) 
          { 
...
// 
  function conectDB()
  {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['dashboard_indicadores']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['dashboard_indicadores']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['dashboard_indicadores']['glo_nm_conexao'], $this->root . $this->path_prod, 'MealSint2', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['dashboard_indicadores']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['dashboard_indicadores']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['dashboard_indicadores']['glo_nm_conexao'], $this->root . $this->path_prod, 'MealSint2', 1, $this->force_db_utf8);
    }
    else {
...
} // dashboard_indicadores_ini

class dashboard_indicadores_control {
    ...
    function init()
    {
        if (!$this->Ini)
        {
            $this->Ini = new dashboard_indicadores_ini();
            $this->Ini->init();
        }
        ...
        $_SESSION['scriptcase']['sc_aba_iframe']['dashboard_indicadores'] = array(
        );

        $_SESSION['scriptcase']['dashboard_targets']['dashboard_indicadores'] = array();


        $_SESSION['scriptcase']['dashboard_scinit']['dashboard_indicadores'] = array();

        $_SESSION['scriptcase']['dashboard_scinit']['dashboard_indicadores']['dbifrm_widget1'] = rand(2, 10000);
        $_SESSION['scriptcase']['dashboard_scinit']['dashboard_indicadores']['dbifrm_widget2'] = rand(2, 10000);

        $_SESSION['scriptcase']['dashboard_toolbar']['dashboard_indicadores'] = array();

        $_SESSION['scriptcase']['dashboard_toolbar']['dashboard_indicadores']['chart_avance_indicadores'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
        ...
        $_SESSION['scriptcase']['dashboard_toolbar']['dashboard_indicadores']['grid_dir_indicadores_avance'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
    ...
    function checkSecurity()
    {
        ...
        if (!isset($_SESSION['scriptcase']['dashboard_indicadores']['session_timeout']['redir']) && (!isset($_SESSION['scriptcase']['sc_apl_seg']['dashboard_indicadores']) || $_SESSION['scriptcase']['sc_apl_seg']['dashboard_indicadores'] != "on"))
        {
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="dashboard_indicadores_container_index.css" />
<?php
...
var scIframeSCInit = {};
<?php
        foreach ($_SESSION['scriptcase']['dashboard_scinit']['dashboard_indicadores'] as $sIframe => $iSCInit) {
?>
                ...
                <div  class="grid-stack-item" data-gs-x="0" data-gs-y="0" data-gs-width="12" data-gs-height="8"  data-gs-no-resize="1" data-gs-no-move="0" id="id-father-0">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-0">
                        <div class="widget-head widget-is-moveable" style="display:">
                            ...
                            <a href="#" class="maximize" onclick="maximizeWidget('0');"><img src="<?php echo $this->Ini->path_icones . '/' . $this->Widget_max; ?>" style="border: 0; float: left; margin-top: 3px" class="sc-widget-maximize" alt="Avance de Indicadores" /></a>
                            <h3 class="scContainerTitle">Avance de Indicadores</h3>
                            <a href="#" class="remove">CLOSE</a>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-' id="id-div-iframe-0"><iframe id="id-iframe-0" name="dbifrm_widget1" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('chart_avance_indicadores'); ?>/?script_case_init=<?php echo $_SESSION["scriptcase"]["dashboard_scinit"]["dashboard_indicadores"]["dbifrm_widget1"] ?>&under_dashboard=1&dashboard_app=dashboard_indicadores&own_widget=dbifrm_widget1&compact_mode=1&remove_margin=0&remove_border=0"></iframe></div>
                    </div>
                </div>
                <div  class="grid-stack-item" data-gs-x="0" data-gs-y="8" data-gs-width="12" data-gs-height="7"  data-gs-no-resize="1" data-gs-no-move="0" id="id-father-1">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-1">
                        <div class="widget-head widget-is-moveable" style="display:">
                            <a href="#" class="collapse">COLLAPSE</a>
                            <a href="#" class="maximize" onclick="maximizeWidget('1');"><img src="<?php echo $this->Ini->path_icones . '/' . $this->Widget_max; ?>" style="border: 0; float: left; margin-top: 3px" class="sc-widget-maximize" alt="Detalles Indicadores" /></a>
                            <h3 class="scContainerTitle">Detalles Indicadores</h3>
                            <a href="#" class="remove">CLOSE</a>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-' id="id-div-iframe-1"><iframe id="id-iframe-1" name="dbifrm_widget2" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('grid_dir_indicadores_avance'); ?>/?script_case_init=<?php echo $_SESSION["scriptcase"]["dashboard_scinit"]["dashboard_indicadores"]["dbifrm_widget2"] ?>&under_dashboard=1&dashboard_app=dashboard_indicadores&own_widget=dbifrm_widget2&compact_mode=1&remove_margin=1&remove_border=0"></iframe></div>
                    </div>
                </div></div>
...
} // dashboard_indicadores_control

function nm_limpa_str_dashboard_indicadores(&$str)
{
