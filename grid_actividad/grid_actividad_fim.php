...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["MealSint2_____grid_actividad"]))
   {
      unset($_SESSION['session_sec_aplicacao']["MealSint2_____grid_actividad"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_actividad']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_actividad']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_actividad']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_actividad']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_actividad']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_actividad']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_actividad']['embutida_filho'] as $ind => $sc_init)
          {
