...
function scEventControl_init(iSeqRow) {
  ...
  scEventControl_data["idtipodeverificacion_" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
}
...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["idtipodeverificacion_" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["idtipodeverificacion_" + iSeqRow]["change"]) {
    return true;
  }
  return false;
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_idtipodeverificacion_' + iSeqRow).bind('blur', function() { sc_form_tipodeverificacion_idtipodeverificacion__onblur(this, iSeqRow) })
                                                   .bind('change', function() { sc_form_tipodeverificacion_idtipodeverificacion__onchange(this, iSeqRow) })
                                                   .bind('focus', function() { sc_form_tipodeverificacion_idtipodeverificacion__onfocus(this, iSeqRow) });
  $('#id_sc_field_nombre_' + iSeqRow).bind('blur', function() { sc_form_tipodeverificacion_nombre__onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_tipodeverificacion_nombre__onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_tipodeverificacion_nombre__onfocus(this, iSeqRow) });
  $('#id_sc_field_descripcion_' + iSeqRow).bind('blur', function() { sc_form_tipodeverificacion_descripcion__onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_tipodeverificacion_descripcion__onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_tipodeverificacion_descripcion__onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_tipodeverificacion_idtipodeverificacion__onblur(oThis, iSeqRow) {
  do_ajax_form_tipodeverificacion_validate_idtipodeverificacion_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tipodeverificacion_idtipodeverificacion__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_tipodeverificacion_idtipodeverificacion__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_tipodeverificacion_nombre__onblur(oThis, iSeqRow) {
  do_ajax_form_tipodeverificacion_validate_nombre_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tipodeverificacion_nombre__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_tipodeverificacion_nombre__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_tipodeverificacion_descripcion__onblur(oThis, iSeqRow) {
  do_ajax_form_tipodeverificacion_validate_descripcion_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tipodeverificacion_descripcion__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_tipodeverificacion_descripcion__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}
...
function displayChange_row(row, status) {
	...
	displayChange_field_idtipodeverificacion_(row, status);
}
...
function displayChange_field(field, row, status) {
	...
	if ("idtipodeverificacion_" == field) {
		displayChange_field_idtipodeverificacion_(row, status);
	}
}
...
function displayChange_field_idtipodeverificacion_(row, status) {
}
...
function scHidePage(pageNo) {
	$("#id_form_tipodeverificacion_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_tipodeverificacion')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
