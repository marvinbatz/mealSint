  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_jdp_proyecto" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_jdp_proyecto_form();
	}
...
?>
  ...
  // ---------- Validate objetivosresultados
  function do_ajax_form_jdp_proyecto_validate_objetivosresultados()
  {
    var nomeCampo_objetivosresultados = "objetivosresultados";
    var var_objetivosresultados = scAjaxGetFieldText(nomeCampo_objetivosresultados);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jdp_proyecto_validate_objetivosresultados(var_objetivosresultados, var_script_case_init, do_ajax_form_jdp_proyecto_validate_objetivosresultados_cb);
  } // do_ajax_form_jdp_proyecto_validate_objetivosresultados

  function do_ajax_form_jdp_proyecto_validate_objetivosresultados_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "objetivosresultados";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jdp_proyecto_validate_objetivosresultados_cb

  // ---------- Validate nombrep
  function do_ajax_form_jdp_proyecto_validate_nombrep()
  {
    var nomeCampo_nombrep = "nombrep";
    var var_nombrep = scAjaxGetFieldText(nomeCampo_nombrep);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jdp_proyecto_validate_nombrep(var_nombrep, var_script_case_init, do_ajax_form_jdp_proyecto_validate_nombrep_cb);
  } // do_ajax_form_jdp_proyecto_validate_nombrep

  function do_ajax_form_jdp_proyecto_validate_nombrep_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombrep";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jdp_proyecto_validate_nombrep_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_jdp_proyecto_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_jdp_proyecto_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_nombrep = scAjaxGetFieldText("nombrep");
    ...
    scAjaxProcOn();
    x_ajax_form_jdp_proyecto_submit_form(var_nombrep, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_jdp_proyecto_submit_form_cb);
  } // do_ajax_form_jdp_proyecto_submit_form

  function do_ajax_form_jdp_proyecto_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("objetivosresultados");
      scAjaxHideErrorDisplay("nombrep");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_jdp_proyecto_submit_form_cb_after_alert);
  } // do_ajax_form_jdp_proyecto_submit_form_cb
  function do_ajax_form_jdp_proyecto_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_jdp_proyecto_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_jdp_objetivo_resultado"] = "off";

  function do_ajax_form_jdp_proyecto_navigate_form()
  {
    perform_ajax_form_jdp_proyecto_navigate_form();
  }

  function perform_ajax_form_jdp_proyecto_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("objetivosresultados");
    scAjaxHideErrorDisplay("nombrep");
    var var_idproyecto = document.F2.idproyecto.value;
    ...
    scAjaxProcOn();
    scStatusDetail["form_jdp_objetivo_resultado"] = "on";
    x_ajax_form_jdp_proyecto_navigate_form(var_idproyecto, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jdp_proyecto_navigate_form_cb);
  } // do_ajax_form_jdp_proyecto_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_jdp_proyecto']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_jdp_proyecto_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idproyecto.value = scAjaxGetKeyValue("idproyecto");
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_jdp_objetivo_resultado"] && "nmsc_iframe_liga_form_jdp_objetivo_resultado" != scMasterDetailIframe["nmsc_iframe_liga_form_jdp_objetivo_resultado"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_jdp_objetivo_resultado"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_jdp_objetivo_resultado').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_jdp_objetivo_resultado').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_jdp_objetivo_resultado').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_jdp_proyecto_navigate_form_cb_after_alert);
  } // do_ajax_form_jdp_proyecto_navigate_form_cb
  function do_ajax_form_jdp_proyecto_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_jdp_proyecto_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_jdp_proyecto_navigate_form_cb_after_alert
  function sc_hide_form_jdp_proyecto_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_jdp_objetivo_resultado"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "objetivosresultados";
  ajax_field_list[1] = "nombrep";
  ...
  var ajax_error_list = {
    "objetivosresultados": {"label": "Objetivos/Resultados", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nombrep": {"label": "Proyecto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "objetivosresultados": new Array(),
    "nombrep": new Array()
  };
  ajax_field_mult["objetivosresultados"][1] = "objetivosresultados";
  ajax_field_mult["nombrep"][1] = "nombrep";

  var ajax_field_id = {
    "objetivosresultados": new Array("hidden_field_label_objetivosresultados", "hidden_field_data_objetivosresultados"),
    "nombrep": new Array("hidden_field_label_nombrep", "hidden_field_data_nombrep")
  };

  var ajax_read_only = {
    "objetivosresultados": "off",
    "nombrep": "on"
  };
