  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_municipio" == sTestField)
        {
...
?>
  ...
  // ---------- Validate nombre
  function do_ajax_form_municipio_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_municipio_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_municipio_validate_nombre_cb);
  } // do_ajax_form_municipio_validate_nombre

  function do_ajax_form_municipio_validate_nombre_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_municipio_validate_nombre_cb

  // ---------- Validate codmunicipio
  function do_ajax_form_municipio_validate_codmunicipio()
  {
    var nomeCampo_codmunicipio = "codmunicipio";
    var var_codmunicipio = scAjaxGetFieldText(nomeCampo_codmunicipio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_municipio_validate_codmunicipio(var_codmunicipio, var_script_case_init, do_ajax_form_municipio_validate_codmunicipio_cb);
  } // do_ajax_form_municipio_validate_codmunicipio

  function do_ajax_form_municipio_validate_codmunicipio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "codmunicipio";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_municipio_validate_codmunicipio_cb

  // ---------- Validate lat
  function do_ajax_form_municipio_validate_lat()
  {
    var nomeCampo_lat = "lat";
    var var_lat = scAjaxGetFieldText(nomeCampo_lat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_municipio_validate_lat(var_lat, var_script_case_init, do_ajax_form_municipio_validate_lat_cb);
  } // do_ajax_form_municipio_validate_lat

  function do_ajax_form_municipio_validate_lat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "lat";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_municipio_validate_lat_cb

  // ---------- Validate lon
  function do_ajax_form_municipio_validate_lon()
  {
    var nomeCampo_lon = "lon";
    var var_lon = scAjaxGetFieldText(nomeCampo_lon);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_municipio_validate_lon(var_lon, var_script_case_init, do_ajax_form_municipio_validate_lon_cb);
  } // do_ajax_form_municipio_validate_lon

  function do_ajax_form_municipio_validate_lon_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "lon";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_municipio_validate_lon_cb

  // ---------- Validate comunidad
  function do_ajax_form_municipio_validate_comunidad()
  {
    var nomeCampo_comunidad = "comunidad";
    var var_comunidad = scAjaxGetFieldText(nomeCampo_comunidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_municipio_validate_comunidad(var_comunidad, var_script_case_init, do_ajax_form_municipio_validate_comunidad_cb);
  } // do_ajax_form_municipio_validate_comunidad

  function do_ajax_form_municipio_validate_comunidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "comunidad";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_municipio_validate_comunidad_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_municipio_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_municipio_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_nombre = scAjaxGetFieldText("nombre");
    var var_codmunicipio = scAjaxGetFieldText("codmunicipio");
    ...
    scAjaxProcOn();
    x_ajax_form_municipio_submit_form(var_nombre, var_codmunicipio, var_lat, var_lon, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_municipio_submit_form_cb);
  } // do_ajax_form_municipio_submit_form

  function do_ajax_form_municipio_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("codmunicipio");
      scAjaxHideErrorDisplay("lat");
      scAjaxHideErrorDisplay("lon");
      scAjaxHideErrorDisplay("comunidad");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_municipio_submit_form_cb_after_alert);
  } // do_ajax_form_municipio_submit_form_cb
  function do_ajax_form_municipio_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_municipio_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_comunidad"] = "off";

  function do_ajax_form_municipio_navigate_form()
  {
    perform_ajax_form_municipio_navigate_form();
  }

  function perform_ajax_form_municipio_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("lon");
    scAjaxHideErrorDisplay("comunidad");
    var var_idmunicipio = document.F2.idmunicipio.value;
    ...
    scAjaxProcOn();
    scStatusDetail["form_comunidad"] = "on";
    x_ajax_form_municipio_navigate_form(var_idmunicipio, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_municipio_navigate_form_cb);
  } // do_ajax_form_municipio_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_municipio']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_municipio_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idmunicipio.value = scAjaxGetKeyValue("idmunicipio");
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_comunidad"] && "nmsc_iframe_liga_form_comunidad" != scMasterDetailIframe["nmsc_iframe_liga_form_comunidad"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_comunidad"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_comunidad').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_comunidad').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_comunidad').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_municipio_navigate_form_cb_after_alert);
  } // do_ajax_form_municipio_navigate_form_cb
  function do_ajax_form_municipio_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_municipio_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_municipio_navigate_form_cb_after_alert
  function sc_hide_form_municipio_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_comunidad"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[1] = "codmunicipio";
  ajax_field_list[2] = "lat";
  ajax_field_list[3] = "lon";
  ajax_field_list[4] = "comunidad";
  ...
  var ajax_error_list = {
    ...
    "codmunicipio": {"label": "Cod Municipio", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "comunidad": {"label": "Comunidades", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
