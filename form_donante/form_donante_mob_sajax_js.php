  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_donante_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate coddonante
  function do_ajax_form_donante_mob_validate_coddonante()
  {
    var nomeCampo_coddonante = "coddonante";
    var var_coddonante = scAjaxGetFieldText(nomeCampo_coddonante);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_donante_mob_validate_coddonante(var_coddonante, var_script_case_init, do_ajax_form_donante_mob_validate_coddonante_cb);
  } // do_ajax_form_donante_mob_validate_coddonante

  function do_ajax_form_donante_mob_validate_coddonante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "coddonante";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_donante_mob_validate_coddonante_cb

  // ---------- Validate nombre
  function do_ajax_form_donante_mob_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_donante_mob_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_donante_mob_validate_nombre_cb);
  } // do_ajax_form_donante_mob_validate_nombre

  function do_ajax_form_donante_mob_validate_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_donante_mob_validate_nombre_cb

  // ---------- Validate comentario
  function do_ajax_form_donante_mob_validate_comentario()
  {
    var nomeCampo_comentario = "comentario";
    var var_comentario = scAjaxGetFieldText(nomeCampo_comentario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_donante_mob_validate_comentario(var_comentario, var_script_case_init, do_ajax_form_donante_mob_validate_comentario_cb);
  } // do_ajax_form_donante_mob_validate_comentario

  function do_ajax_form_donante_mob_validate_comentario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_donante_mob_validate_comentario_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_donante_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_donante_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_coddonante = scAjaxGetFieldText("coddonante");
    ...
    scAjaxProcOn();
    x_ajax_form_donante_mob_submit_form(var_coddonante, var_nombre, var_comentario, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_donante_mob_submit_form_cb);
  } // do_ajax_form_donante_mob_submit_form

  function do_ajax_form_donante_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("coddonante");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_donante_mob_submit_form_cb_after_alert);
  } // do_ajax_form_donante_mob_submit_form_cb
  function do_ajax_form_donante_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_donante_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_donante_mob_navigate_form()
  {
    perform_ajax_form_donante_mob_navigate_form();
  }

  function perform_ajax_form_donante_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("nombre");
    scAjaxHideErrorDisplay("comentario");
    var var_coddonante = document.F2.coddonante.value;
    ...
    scAjaxProcOn();
    x_ajax_form_donante_mob_navigate_form(var_coddonante, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_donante_mob_navigate_form_cb);
  } // do_ajax_form_donante_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_donante_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_donante_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.coddonante.value = scAjaxGetKeyValue("coddonante");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_donante_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_donante_mob_navigate_form_cb
  function do_ajax_form_donante_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_donante_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_donante_mob_navigate_form_cb_after_alert
  function sc_hide_form_donante_mob_form()
  {
  ...
  ajax_field_list[0] = "coddonante";
  ajax_field_list[1] = "nombre";
  ajax_field_list[2] = "comentario";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "coddonante": {"label": "Cod Donante", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "coddonante": new Array(),
    "nombre": new Array(),
    "comentario": new Array()
  };
  ajax_field_mult["coddonante"][1] = "coddonante";
  ajax_field_mult["nombre"][1] = "nombre";
  ajax_field_mult["comentario"][1] = "comentario";

  var ajax_field_id = {
    "coddonante": new Array("hidden_field_label_coddonante", "hidden_field_data_coddonante"),
