<?php
@session_start() ;
$_SESSION['scriptcase']['seg_grid_sec_users']['sc_process_barr'] = true;
require_once('../seg_grid_sec_users/index.php');
unset($_SESSION['scriptcase']['seg_grid_sec_users']['sc_process_barr']);
$ExportCtrl = new seg_grid_sec_users_export_control;
$ExportCtrl->Export_barr();

class seg_grid_sec_users_export_control
{
