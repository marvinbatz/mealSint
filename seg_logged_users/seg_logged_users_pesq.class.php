...
class seg_logged_users_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . seg_logged_users_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . seg_logged_users_pack_protect_string($Tipo_filter[0]) . "\">.." . seg_logged_users_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_login')
      {
          $login = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_login($login);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_date_login')
      {
          $date_login = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_date_login($date_login);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_sc_session')
      {
          $sc_session = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_sc_session($sc_session);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_ip')
      {
          $ip = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_ip($ip);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_login($login)
   {
      $login = substr($this->Db->qstr($login), 1, -1);
            $login_look = substr($this->Db->qstr($login), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct login from " . $this->Ini->nm_tabela . " where sc_session <> '_SC_FAIL_SC_' AND sc_session <> '_SC_BLOCKED_SC_' and  login like '%" . $login . "%' order by login"; 
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_date_login($date_login)
   {
      $date_login = substr($this->Db->qstr($date_login), 1, -1);
            $date_login_look = substr($this->Db->qstr($date_login), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct date_login from " . $this->Ini->nm_tabela . " where sc_session <> '_SC_FAIL_SC_' AND sc_session <> '_SC_BLOCKED_SC_' and  date_login like '%" . $date_login . "%' order by date_login"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_sc_session($sc_session)
   {
      $sc_session = substr($this->Db->qstr($sc_session), 1, -1);
            $sc_session_look = substr($this->Db->qstr($sc_session), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct sc_session from " . $this->Ini->nm_tabela . " where sc_session <> '_SC_FAIL_SC_' AND sc_session <> '_SC_BLOCKED_SC_' and  sc_session like '%" . $sc_session . "%' order by sc_session"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_ip($ip)
   {
      $ip = substr($this->Db->qstr($ip), 1, -1);
            $ip_look = substr($this->Db->qstr($ip), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct ip from " . $this->Ini->nm_tabela . " where sc_session <> '_SC_FAIL_SC_' AND sc_session <> '_SC_BLOCKED_SC_' and  ip like '%" . $ip . "%' order by ip"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_sec_logged_app_title'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>seg_logged_users/seg_logged_users_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="seg_logged_users_ajax_search.js"></script>
 <script type="text/javascript" src="seg_logged_users_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="seg_logged_users_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['seg_logged_users']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['seg_logged_users']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_login_cond#NMF#' + search_get_sel_txt('SC_login_cond') + '@NMF@';
  str_out += 'SC_login#NMF#' + search_get_text('SC_login') + '@NMF@';
  str_out += 'id_ac_login#NMF#' + search_get_text('id_ac_login') + '@NMF@';
  str_out += 'SC_date_login_cond#NMF#' + search_get_sel_txt('SC_date_login_cond') + '@NMF@';
  str_out += 'SC_date_login#NMF#' + search_get_text('SC_date_login') + '@NMF@';
  str_out += 'id_ac_date_login#NMF#' + search_get_text('id_ac_date_login') + '@NMF@';
  str_out += 'SC_sc_session_cond#NMF#' + search_get_sel_txt('SC_sc_session_cond') + '@NMF@';
  str_out += 'SC_sc_session#NMF#' + search_get_text('SC_sc_session') + '@NMF@';
  str_out += 'id_ac_sc_session#NMF#' + search_get_text('id_ac_sc_session') + '@NMF@';
  str_out += 'SC_ip_cond#NMF#' + search_get_sel_txt('SC_ip_cond') + '@NMF@';
  str_out += 'SC_ip#NMF#' + search_get_text('SC_ip') + '@NMF@';
  str_out += 'id_ac_ip#NMF#' + search_get_text('id_ac_ip') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_login").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_login").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_login",
          max_itens: "10",
          cod_desc: "N",
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_login").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_date_login").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_date_login").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_date_login",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_date_login").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_date_login").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_ip").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_ip").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_ip",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
   ...
   scClass = $("#id_ac_sc_session").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_sc_session").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_sc_session",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_sc_session").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; background-color:#FFFFFF; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_sec_logged_app_title'] ?></span></td>
...
<?php
   ...
   {
      global 
             $login_cond, $login, $login_autocomp,
             $date_login_cond, $date_login, $date_login_autocomp,
             $sc_session_cond, $sc_session, $sc_session_autocomp,
             $ip_cond, $ip, $ip_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $login = $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['campos_busca']['login']; 
          $login_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['campos_busca']['login_cond']; 
          $date_login = $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['campos_busca']['date_login']; 
          $date_login_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['campos_busca']['date_login_cond']; 
          $sc_session = $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['campos_busca']['sc_session']; 
          $sc_session_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['campos_busca']['sc_session_cond']; 
          $ip = $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['campos_busca']['ip']; 
          $ip_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['campos_busca']['ip_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['campos_busca']['NM_operador']; 
      } 
      if (!isset($login_cond) || empty($login_cond))
      {
         $login_cond = "qp";
      }
      if (!isset($date_login_cond) || empty($date_login_cond))
      {
         $date_login_cond = "qp";
      }
      if (!isset($sc_session_cond) || empty($sc_session_cond))
      {
         $sc_session_cond = "qp";
      }
      if (!isset($ip_cond) || empty($ip_cond))
      {
         $ip_cond = "qp";
      }
      ...
      $str_hide_login = (in_array($login_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_date_login = (in_array($date_login_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_sc_session = (in_array($sc_session_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_ip = (in_array($ip_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      {
         $tmp_pos = strpos($login, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $login = substr($login, 0, $tmp_pos);
         }
      }
      if (!isset($date_login) || $date_login == "")
      {
          $date_login = "";
      }
      if (isset($date_login) && !empty($date_login))
      {
         $tmp_pos = strpos($date_login, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $date_login = substr($date_login, 0, $tmp_pos);
         }
      }
      if (!isset($sc_session) || $sc_session == "")
      {
          $sc_session = "";
      }
      if (isset($sc_session) && !empty($sc_session))
      {
         $tmp_pos = strpos($sc_session, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $sc_session = substr($sc_session, 0, $tmp_pos);
         }
      }
      if (!isset($ip) || $ip == "")
      {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_login_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['login'])) ? $this->New_label['login'] : "" . $this->Ini->Nm_lang['lang_sec_logged_fild_login'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_login_cond" name="login_cond" onChange="nm_campos_between(document.getElementById('id_vis_login'), this, 'login')">
       <OPTION value="qp" <?php if ("qp" == $login_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $login_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $login_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $login_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_login" <?php echo $str_hide_login?> valign="top">
...
<?php
      ...
      $login_look = substr($this->Db->qstr($login), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct login from " . $this->Ini->nm_tabela . " where sc_session <> '_SC_FAIL_SC_' AND sc_session <> '_SC_BLOCKED_SC_' and login = '$login_look' order by login"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$login]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$login];
      }
      else
      {
          $sAutocompValue = $login;
      }
?>
<INPUT  type="text" id="SC_login" name="login" value="<?php echo NM_encode_input($login) ?>"  size=32 alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_login" name="login_autocomp" size="32"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_date_login_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['date_login'])) ? $this->New_label['date_login'] : "" . $this->Ini->Nm_lang['lang_sec_logged_fild_date_login'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_date_login_cond" name="date_login_cond" onChange="nm_campos_between(document.getElementById('id_vis_date_login'), this, 'date_login')">
       <OPTION value="qp" <?php if ("qp" == $date_login_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $date_login_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $date_login_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $date_login_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_date_login" <?php echo $str_hide_date_login?> valign="top">
 ...
 $nmgp_tab_label .= "date_login?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $date_login_look = substr($this->Db->qstr($date_login), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct date_login from " . $this->Ini->nm_tabela . " where sc_session <> '_SC_FAIL_SC_' AND sc_session <> '_SC_BLOCKED_SC_' and date_login = '$date_login_look' order by date_login"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$date_login]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$date_login];
      }
      else
      {
          $sAutocompValue = $date_login;
      }
?>
<INPUT  type="text" id="SC_date_login" name="date_login" value="<?php echo NM_encode_input($date_login) ?>"  size=50 alt="{datatype: 'text', maxLength: 128, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_date_login" name="date_login_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 128, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_sc_session_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['sc_session'])) ? $this->New_label['sc_session'] : "" . $this->Ini->Nm_lang['lang_sec_logged_fild_sc_session'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_sc_session_cond" name="sc_session_cond" onChange="nm_campos_between(document.getElementById('id_vis_sc_session'), this, 'sc_session')">
       <OPTION value="qp" <?php if ("qp" == $sc_session_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $sc_session_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $sc_session_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $sc_session_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_sc_session" <?php echo $str_hide_sc_session?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['sc_session'])) ? $this->New_label['sc_session'] : "" . $this->Ini->Nm_lang['lang_sec_logged_fild_sc_session'] . "";
 $nmgp_tab_label .= "sc_session?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $sc_session_look = substr($this->Db->qstr($sc_session), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct sc_session from " . $this->Ini->nm_tabela . " where sc_session <> '_SC_FAIL_SC_' AND sc_session <> '_SC_BLOCKED_SC_' and sc_session = '$sc_session_look' order by sc_session"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$sc_session]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$sc_session];
      }
      else
      {
          $sAutocompValue = $sc_session;
      }
?>
<INPUT  type="text" id="SC_sc_session" name="sc_session" value="<?php echo NM_encode_input($sc_session) ?>"  size=32 alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_sc_session" name="sc_session_autocomp" size="32"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_ip_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['ip'])) ? $this->New_label['ip'] : "" . $this->Ini->Nm_lang['lang_sec_logged_fild_ip'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_ip_cond" name="ip_cond" onChange="nm_campos_between(document.getElementById('id_vis_ip'), this, 'ip')">
       <OPTION value="qp" <?php if ("qp" == $ip_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $ip_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $ip_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $ip_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_ip" <?php echo $str_hide_ip?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['ip'])) ? $this->New_label['ip'] : "" . $this->Ini->Nm_lang['lang_sec_logged_fild_ip'] . "";
 $nmgp_tab_label .= "ip?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $ip_look = substr($this->Db->qstr($ip), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct ip from " . $this->Ini->nm_tabela . " where sc_session <> '_SC_FAIL_SC_' AND sc_session <> '_SC_BLOCKED_SC_' and ip = '$ip_look' order by ip"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$ip]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$ip];
      }
      else
      {
          $sAutocompValue = $ip;
...
?>
<INPUT  type="text" id="SC_ip" name="ip" value="<?php echo NM_encode_input($ip) ?>"  size=32 alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_ip" name="ip_autocomp" size="32"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (is_file("seg_logged_users_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['seg_logged_users']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['seg_logged_users']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.date_login_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_date_login'), document.F1.date_login_cond, 'date_login');
   document.F1.date_login.value = "";
   document.F1.date_login_autocomp.value = "";
   document.F1.sc_session_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_sc_session'), document.F1.sc_session_cond, 'sc_session');
   document.F1.sc_session.value = "";
   document.F1.sc_session_autocomp.value = "";
   document.F1.ip_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_ip'), document.F1.ip_cond, 'ip');
   document.F1.ip.value = "";
   document.F1.ip_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "MealSint2/seg_logged_users";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_login_cond'] = 'cond';
      $tp_fields['SC_login'] = 'text_aut';
      $tp_fields['id_ac_login'] = 'text_aut';
      $tp_fields['SC_date_login_cond'] = 'cond';
      $tp_fields['SC_date_login'] = 'text_aut';
      $tp_fields['id_ac_date_login'] = 'text_aut';
      $tp_fields['SC_sc_session_cond'] = 'cond';
      $tp_fields['SC_sc_session'] = 'text_aut';
      $tp_fields['id_ac_sc_session'] = 'text_aut';
      $tp_fields['SC_ip_cond'] = 'cond';
      $tp_fields['SC_ip'] = 'text_aut';
      $tp_fields['id_ac_ip'] = 'text_aut';
   ...
   {
      global $login_cond, $login, $login_autocomp,
             $date_login_cond, $date_login, $date_login_autocomp,
             $sc_session_cond, $sc_session, $sc_session_autocomp,
             $ip_cond, $ip, $ip_autocomp, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($login_autocomp) && empty($login))
      {
          $login = $login_autocomp;
      }
      if (!empty($date_login_autocomp) && empty($date_login))
      {
          $date_login = $date_login_autocomp;
      }
      if (!empty($sc_session_autocomp) && empty($sc_session))
      {
          $sc_session = $sc_session_autocomp;
      }
      if (!empty($ip_autocomp) && empty($ip))
      {
          $ip = $ip_autocomp;
      }
      $login_cond_salva = $login_cond; 
      if (!isset($login_input_2) || $login_input_2 == "")
      {
          $login_input_2 = $login;
      }
      $date_login_cond_salva = $date_login_cond; 
      if (!isset($date_login_input_2) || $date_login_input_2 == "")
      {
          $date_login_input_2 = $date_login;
      }
      $sc_session_cond_salva = $sc_session_cond; 
      if (!isset($sc_session_input_2) || $sc_session_input_2 == "")
      {
          $sc_session_input_2 = $sc_session;
      }
      $ip_cond_salva = $ip_cond; 
      if (!isset($ip_input_2) || $ip_input_2 == "")
      {
          $ip_input_2 = $ip;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['campos_busca']['login'] = $login; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['campos_busca']['login_cond'] = $login_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['campos_busca']['date_login'] = $date_login; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['campos_busca']['date_login_cond'] = $date_login_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['campos_busca']['sc_session'] = $sc_session; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['campos_busca']['sc_session_cond'] = $sc_session_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['campos_busca']['ip'] = $ip; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['campos_busca']['ip_cond'] = $ip_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($login != '') {
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['login'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['login'] = $login;
      }
      $nmgp_def_dados = array();
    if ($date_login != '') {
      $date_login_look = substr($this->Db->qstr($date_login), 1, -1); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['date_login'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['date_login'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['date_login'] = $date_login;
      }
      $nmgp_def_dados = array();
    if ($sc_session != '') {
      $sc_session_look = substr($this->Db->qstr($sc_session), 1, -1); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['sc_session'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['sc_session'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['sc_session'] = $sc_session;
      }
      $nmgp_def_dados = array();
    if ($ip != '') {
      $ip_look = substr($this->Db->qstr($ip), 1, -1); 
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['ip'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['ip'] = $ip;
      }

      //----- $login
      $this->Date_part = false;
      if (isset($login) || $login_cond == "nu" || $login_cond == "nn" || $login_cond == "ep" || $login_cond == "ne")
      {
         $this->monta_condicao("login", $login_cond, $login, "", "login");
      }

      //----- $date_login
      $this->Date_part = false;
      if (isset($date_login) || $date_login_cond == "nu" || $date_login_cond == "nn" || $date_login_cond == "ep" || $date_login_cond == "ne")
      {
         $this->monta_condicao("date_login", $date_login_cond, $date_login, "", "date_login");
      }

      //----- $sc_session
      $this->Date_part = false;
      if (isset($sc_session) || $sc_session_cond == "nu" || $sc_session_cond == "nn" || $sc_session_cond == "ep" || $sc_session_cond == "ne")
      {
         $this->monta_condicao("sc_session", $sc_session_cond, $sc_session, "", "sc_session");
      }

      //----- $ip
      $this->Date_part = false;
      if (isset($ip) || $ip_cond == "nu" || $ip_cond == "nn" || $ip_cond == "ep" || $ip_cond == "ne")
      {
         $this->monta_condicao("ip", $ip_cond, $ip, "", "ip");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['seg_logged_users']['cond_pesq'] .= $this->NM_operador;
