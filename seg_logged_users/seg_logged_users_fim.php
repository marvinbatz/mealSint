...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["MealSint2_____seg_logged_users"]))
   {
      unset($_SESSION['session_sec_aplicacao']["MealSint2_____seg_logged_users"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['seg_logged_users']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['seg_logged_users']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['seg_logged_users']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['seg_logged_users']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['seg_logged_users']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['seg_logged_users']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['seg_logged_users']['embutida_filho'] as $ind => $sc_init)
          {
