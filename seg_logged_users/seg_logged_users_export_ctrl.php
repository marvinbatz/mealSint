<?php
@session_start() ;
$_SESSION['scriptcase']['seg_logged_users']['sc_process_barr'] = true;
require_once('../seg_logged_users/index.php');
unset($_SESSION['scriptcase']['seg_logged_users']['sc_process_barr']);
$ExportCtrl = new seg_logged_users_export_control;
$ExportCtrl->Export_barr();

class seg_logged_users_export_control
{
