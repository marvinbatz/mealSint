...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_login_cond" name="login_cond" onChange="nm_campos_between(document.getElementById('id_vis_login'), this, 'login')">
      ...
      <br><span id="id_hide_login"  <?php echo $str_hide_login?>><?php
      if ($login != "")
      {
      $login_look = substr($this->Db->qstr($login), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_date_login_cond" name="date_login_cond" onChange="nm_campos_between(document.getElementById('id_vis_date_login'), this, 'date_login')">
      ...
      <br><span id="id_hide_date_login"  <?php echo $str_hide_date_login?>><?php
      if ($date_login != "")
      {
      $date_login_look = substr($this->Db->qstr($date_login), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_sc_session_cond" name="sc_session_cond" onChange="nm_campos_between(document.getElementById('id_vis_sc_session'), this, 'sc_session')">
      ...
      <br><span id="id_hide_sc_session"  <?php echo $str_hide_sc_session?>><?php
      if ($sc_session != "")
      {
      $sc_session_look = substr($this->Db->qstr($sc_session), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_ip_cond" name="ip_cond" onChange="nm_campos_between(document.getElementById('id_vis_ip'), this, 'ip')">
      ...
      <br><span id="id_hide_ip"  <?php echo $str_hide_ip?>><?php
      if ($ip != "")
      {
      $ip_look = substr($this->Db->qstr($ip), 1, -1); 
      $nmgp_def_dados = array(); 
