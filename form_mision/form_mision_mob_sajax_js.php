  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_mision_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate nombre
  function do_ajax_form_mision_mob_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mision_mob_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_mision_mob_validate_nombre_cb);
  } // do_ajax_form_mision_mob_validate_nombre

  function do_ajax_form_mision_mob_validate_nombre_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mision_mob_validate_nombre_cb

  // ---------- Validate abr
  function do_ajax_form_mision_mob_validate_abr()
  {
    var nomeCampo_abr = "abr";
    var var_abr = scAjaxGetFieldText(nomeCampo_abr);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mision_mob_validate_abr(var_abr, var_script_case_init, do_ajax_form_mision_mob_validate_abr_cb);
  } // do_ajax_form_mision_mob_validate_abr

  function do_ajax_form_mision_mob_validate_abr_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "abr";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mision_mob_validate_abr_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_mision_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_mision_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_nombre = scAjaxGetFieldText("nombre");
    var var_abr = scAjaxGetFieldText("abr");
    var var_idmision = scAjaxGetFieldText("idmision");
    ...
    scAjaxProcOn();
    x_ajax_form_mision_mob_submit_form(var_nombre, var_abr, var_idmision, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_mision_mob_submit_form_cb);
  } // do_ajax_form_mision_mob_submit_form

  function do_ajax_form_mision_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_mision_mob_submit_form_cb_after_alert);
  } // do_ajax_form_mision_mob_submit_form_cb
  function do_ajax_form_mision_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_mision_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_mision_mob_navigate_form()
  {
    perform_ajax_form_mision_mob_navigate_form();
  }

  function perform_ajax_form_mision_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("nombre");
    scAjaxHideErrorDisplay("abr");
    var var_idmision = document.F2.idmision.value;
    ...
    scAjaxProcOn();
    x_ajax_form_mision_mob_navigate_form(var_idmision, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_mision_mob_navigate_form_cb);
  } // do_ajax_form_mision_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_mision_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_mision_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idmision.value = scAjaxGetKeyValue("idmision");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_mision_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_mision_mob_navigate_form_cb
  function do_ajax_form_mision_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_mision_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_mision_mob_navigate_form_cb_after_alert
  function sc_hide_form_mision_mob_form()
  {
  ...
  var ajax_error_list = {
    ...
    "abr": {"label": "Abr", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
