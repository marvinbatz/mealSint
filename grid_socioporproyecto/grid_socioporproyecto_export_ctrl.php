<?php
@session_start() ;
$_SESSION['scriptcase']['grid_socioporproyecto']['sc_process_barr'] = true;
require_once('../grid_socioporproyecto/index.php');
unset($_SESSION['scriptcase']['grid_socioporproyecto']['sc_process_barr']);
$ExportCtrl = new grid_socioporproyecto_export_control;
$ExportCtrl->Export_barr();

class grid_socioporproyecto_export_control
{
