<?php
@session_start() ;
$_SESSION['scriptcase']['grid_jdp_planificacion_rechazado']['sc_process_barr'] = true;
require_once('../grid_jdp_planificacion_rechazado/index.php');
unset($_SESSION['scriptcase']['grid_jdp_planificacion_rechazado']['sc_process_barr']);
$ExportCtrl = new grid_jdp_planificacion_rechazado_export_control;
$ExportCtrl->Export_barr();

class grid_jdp_planificacion_rechazado_export_control
{
