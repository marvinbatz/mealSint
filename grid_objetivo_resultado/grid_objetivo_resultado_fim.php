...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["MealSint2_____grid_objetivo_resultado"]))
   {
      unset($_SESSION['session_sec_aplicacao']["MealSint2_____grid_objetivo_resultado"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_objetivo_resultado']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_objetivo_resultado']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_objetivo_resultado']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_objetivo_resultado']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_objetivo_resultado']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_objetivo_resultado</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_objetivo_resultado']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_objetivo_resultado']['embutida_filho'] as $ind => $sc_init)
          {
