<?php
@session_start() ;
$_SESSION['scriptcase']['grid_objetivo_resultado']['sc_process_barr'] = true;
require_once('../grid_objetivo_resultado/index.php');
unset($_SESSION['scriptcase']['grid_objetivo_resultado']['sc_process_barr']);
$ExportCtrl = new grid_objetivo_resultado_export_control;
$ExportCtrl->Export_barr();

class grid_objetivo_resultado_export_control
{
