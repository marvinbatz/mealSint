<?php
@session_start() ;
$_SESSION['scriptcase']['grid_dir_planificacionhogar_act']['sc_process_barr'] = true;
require_once('../grid_dir_planificacionhogar_act/index.php');
unset($_SESSION['scriptcase']['grid_dir_planificacionhogar_act']['sc_process_barr']);
$ExportCtrl = new grid_dir_planificacionhogar_act_export_control;
$ExportCtrl->Export_barr();

class grid_dir_planificacionhogar_act_export_control
{
