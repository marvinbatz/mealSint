...
$old_error_handler = set_error_handler("form_tipodebeneficiario_scriptcase_error_handler");

function form_tipodebeneficiario_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_tipodebeneficiario']['contr_erro']) && $_SESSION['scriptcase']['form_tipodebeneficiario']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_tipodebeneficiario->contr_form_tipodebeneficiario->Apl_com_erro = true;
            if ($inicial_form_tipodebeneficiario->contr_form_tipodebeneficiario->NM_ajax_flag)
            {
                $inicial_form_tipodebeneficiario->contr_form_tipodebeneficiario->NM_ajax_info['errList']['geral_form_tipodebeneficiario'][] = $msg;
                return;
            }
            form_tipodebeneficiario_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_tipodebeneficiario_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_tipodebeneficiario'])  && '' != $_SESSION['scriptcase']['error_icon']['form_tipodebeneficiario'])  ? $_SESSION['scriptcase']['error_icon']['form_tipodebeneficiario']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_tipodebeneficiario']) && '' != $_SESSION['scriptcase']['error_span_title']['form_tipodebeneficiario']) ? $_SESSION['scriptcase']['error_span_title']['form_tipodebeneficiario'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_tipodebeneficiario']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_tipodebeneficiario']) ? $_SESSION['scriptcase']['error_icon_title']['form_tipodebeneficiario'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_tipodebeneficiario']['error_buffer'] .= ob_get_flush();
}
