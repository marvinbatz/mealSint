...
function scEventControl_init(iSeqRow) {
  ...
  scEventControl_data["idtipodebeneficiario_" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
}
...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["idtipodebeneficiario_" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["idtipodebeneficiario_" + iSeqRow]["change"]) {
    return true;
  }
  return false;
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_idtipodebeneficiario_' + iSeqRow).bind('blur', function() { sc_form_tipodebeneficiario_idtipodebeneficiario__onblur(this, iSeqRow) })
                                                   .bind('change', function() { sc_form_tipodebeneficiario_idtipodebeneficiario__onchange(this, iSeqRow) })
                                                   .bind('focus', function() { sc_form_tipodebeneficiario_idtipodebeneficiario__onfocus(this, iSeqRow) });
  $('#id_sc_field_nombre_' + iSeqRow).bind('blur', function() { sc_form_tipodebeneficiario_nombre__onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_tipodebeneficiario_nombre__onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_tipodebeneficiario_nombre__onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_tipodebeneficiario_idtipodebeneficiario__onblur(oThis, iSeqRow) {
  do_ajax_form_tipodebeneficiario_validate_idtipodebeneficiario_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tipodebeneficiario_idtipodebeneficiario__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_tipodebeneficiario_idtipodebeneficiario__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_tipodebeneficiario_nombre__onblur(oThis, iSeqRow) {
  do_ajax_form_tipodebeneficiario_validate_nombre_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_tipodebeneficiario_nombre__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_tipodebeneficiario_nombre__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}
...
function displayChange_row(row, status) {
	...
	displayChange_field_idtipodebeneficiario_(row, status);
}
...
function displayChange_field(field, row, status) {
	...
	if ("idtipodebeneficiario_" == field) {
		displayChange_field_idtipodebeneficiario_(row, status);
	}
}
...
function displayChange_field_idtipodebeneficiario_(row, status) {
}
...
function scHidePage(pageNo) {
	$("#id_form_tipodebeneficiario_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_tipodebeneficiario')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
