...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["MealSint2_____grid_beneficioinstitucion_conteo"]))
   {
      unset($_SESSION['session_sec_aplicacao']["MealSint2_____grid_beneficioinstitucion_conteo"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_beneficioinstitucion_conteo']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_beneficioinstitucion_conteo']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_beneficioinstitucion_conteo']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_beneficioinstitucion_conteo']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_beneficioinstitucion_conteo']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_beneficioinstitucion_conteo</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_beneficioinstitucion_conteo']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_beneficioinstitucion_conteo']['embutida_filho'] as $ind => $sc_init)
          {
