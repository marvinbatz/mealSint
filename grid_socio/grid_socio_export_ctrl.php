<?php
@session_start() ;
$_SESSION['scriptcase']['grid_socio']['sc_process_barr'] = true;
require_once('../grid_socio/index.php');
unset($_SESSION['scriptcase']['grid_socio']['sc_process_barr']);
$ExportCtrl = new grid_socio_export_control;
$ExportCtrl->Export_barr();

class grid_socio_export_control
{
