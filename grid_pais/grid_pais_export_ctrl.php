<?php
@session_start() ;
$_SESSION['scriptcase']['grid_pais']['sc_process_barr'] = true;
require_once('../grid_pais/index.php');
unset($_SESSION['scriptcase']['grid_pais']['sc_process_barr']);
$ExportCtrl = new grid_pais_export_control;
$ExportCtrl->Export_barr();

class grid_pais_export_control
{
