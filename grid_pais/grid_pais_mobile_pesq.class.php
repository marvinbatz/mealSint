...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "idpais";$Nm_numeric[] = "idpais";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_idpais_cond" name="idpais_cond" onChange="nm_campos_between(document.getElementById('id_vis_idpais'), this, 'idpais')">
      ...
      <br><span id="id_hide_idpais"  <?php echo $str_hide_idpais?>><INPUT  type="text" id="SC_idpais" name="idpais" value="<?php echo NM_encode_input($idpais) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
