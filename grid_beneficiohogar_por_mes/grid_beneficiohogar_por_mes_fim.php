...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["MealSint2_____grid_beneficiohogar_por_mes"]))
   {
      unset($_SESSION['session_sec_aplicacao']["MealSint2_____grid_beneficiohogar_por_mes"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_beneficiohogar_por_mes']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_beneficiohogar_por_mes']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_beneficiohogar_por_mes']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_beneficiohogar_por_mes']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_beneficiohogar_por_mes']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_beneficiohogar_por_mes</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_beneficiohogar_por_mes']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_beneficiohogar_por_mes']['embutida_filho'] as $ind => $sc_init)
          {
