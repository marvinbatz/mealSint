<?php
@session_start() ;
$_SESSION['scriptcase']['grid_beneficiario_conteo_dash']['sc_process_barr'] = true;
require_once('../grid_beneficiario_conteo_dash/index.php');
unset($_SESSION['scriptcase']['grid_beneficiario_conteo_dash']['sc_process_barr']);
$ExportCtrl = new grid_beneficiario_conteo_dash_export_control;
$ExportCtrl->Export_barr();

class grid_beneficiario_conteo_dash_export_control
{
