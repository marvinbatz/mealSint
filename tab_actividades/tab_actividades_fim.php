...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["MealSint2_____tab_actividades"]))
   {
      unset($_SESSION['session_sec_aplicacao']["MealSint2_____tab_actividades"]);
   }
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']['tab_actividades']))
   {
       unset($_SESSION['scriptcase']['sc_aba_iframe']['tab_actividades']);
   }
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['tab_actividades']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['tab_actividades']['sc_outra_jan'])
   {
       $fecha_janela = true;
   }
   $fecha_modal = false;
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['tab_actividades']['aba_saida']) && $_SESSION['sc_session'][$script_case_init]['tab_actividades']['aba_saida'] == "modal")
   {
       unset($_SESSION['sc_session'][$script_case_init]['tab_actividades']['aba_saida']);
       $fecha_modal = true;
   }
