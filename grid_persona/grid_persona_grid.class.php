...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['charts_html'] = '';
   ...
   { 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['SC_Ind_Groupby'] != "sc_free_total")
      {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['embutida'])
       { 
           include_once($this->Ini->path_embutida . "grid_persona/" . $this->Ini->Apl_resumo); 
       } 
       else 
       { 
           include_once($this->Ini->path_aplicacao . $this->Ini->Apl_resumo); 
       } 
       $this->Res         = new grid_persona_resumo();
       $this->Res->Db     = $this->Db;
       ...
       {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['proc_pdf_vert'])
            {
            } 
            else
            {
       ...
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_persona'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'];
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_top();
       } 
       if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao_print'] != 'print')
       { 
           if ($this->Ini->grid_search_change_fil)
           { 
               $seq_search = 1;
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['grid_pesq'] as $cmp => $def)
               {
                  $Seq_grid      = $seq_search;
                  $Cmp_grid      = $cmp;
       ...
       if (!$this->Proc_link_res && $nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao_print'] != 'print')
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dyn_refresh'] = array();
           $this->html_dynamic_search();
       } 
       unset ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['save_grid']);
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['pdf_res'] && (!isset($_GET['flash_graf']) || 'chart' != $_GET['flash_graf']))
       {
           $this->grid();
       }
       if ($nmgrp_apl_opcao != "pdf")
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['print_all'] && empty($this->nm_grid_sem_reg) && ($Gera_res || $Gera_graf) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['SC_Ind_Groupby'] != "sc_free_total")
       { 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['SC_Ind_Groupby'] != "sc_free_total")
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] == "pdf")
       { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'];
 }
...
//
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['Ind_lig_mult'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['Ind_lig_mult'] = 0;
   }
   $this->Img_embbed      = false;
   $this->nm_data         = new nm_data("es");
   $this->pdf_label_group = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opc_pdf']['label_group'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opc_pdf']['label_group'] : "N";
   $this->pdf_all_cab     = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opc_pdf']['all_cab']))     ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opc_pdf']['all_cab'] : "S";
   $this->pdf_all_label   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opc_pdf']['all_label']))   ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opc_pdf']['all_label'] : "S";
   ...
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "grid_persona/grid_persona_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dyn_search_add']))
   {
       $NM_func_dyn_add = "dynamic_search_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dyn_search_add']['cmp'];
       $Lin_dyn_add = $this->$NM_func_dyn_add($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dyn_search_add']['seq'], 'S');
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dyn_search_add']);
       exit;
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['pesq_tab_label']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['pesq_tab_label'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['pesq_tab_label'] .= "p_noidentificacion?#?" . "No Identificación" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['pesq_tab_label'] .= "p_nombre?#?" . "Nombre" . "?@?";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['grid_search_add']))
   {
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['pesq_tab_label'];
       ...
       $Seq_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['grid_search_add']['seq'];
       $Cmp_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['grid_search_add']['cmp'];
       ...
       $oJson = new Services_JSON();
       echo $oJson->encode($this->Arr_result);
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['grid_search_add']);
       exit;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dyn_search_aut_comp']))
   {
       $NM_func_aut_comp = "lookup_ajax_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dyn_search_aut_comp']['cmp'];
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dyn_search_aut_comp']);
       exit;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['embutida'])
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['force_toolbar']);
   } 
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_persona']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_persona']['lig_edit'] != '')
   {
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_persona']['lig_edit'] == "on")  {$_SESSION['scriptcase']['sc_apl_conf']['grid_persona']['lig_edit'] = "S";}
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_persona']['lig_edit'] == "off") {$_SESSION['scriptcase']['sc_apl_conf']['grid_persona']['lig_edit'] = "N";}
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_persona']['lig_edit'];
   }
   ...
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['mostra_edit'] = "N";
       }
   }
   if ($this->Ini->SC_Link_View || ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opc_psq'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['psq_edit'] == 'N'))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['mostra_edit'] = "N";
   }
   $nm_tem_quebra = 0;
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ind_tree'] = 0;
   }
   elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['emb_tree_no']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['emb_tree_no'])
   { 
       $this->NM_emb_tree_no = true; 
   }
   $this->aba_iframe = false;
   $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['print_all'];
   if ($this->Print_All)
   {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['where_resumo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['where_resumo'])) 
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['doc_word'] || $this->Ini->sc_export_ajax_img)
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] = "muda_qt_linhas";
   } 

   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dashboard_info']['maximized']) {
       $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dashboard_info']['dashboard_app'];
       if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_persona'])) {
           $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_persona'];
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "grid_persona/grid_persona_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "grid_persona_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   $this->Tot         = new grid_persona_total($this->Ini->sc_page);
   $this->Tot->Db     = $this->Db;
   $this->Tot->Erro   = $this->Erro;
   $this->Tot->Ini    = $this->Ini;
   $this->Tot->Lookup = $this->Lookup;
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['qt_lin_grid'] = 1;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['qt_col_grid'] = 1 ;  
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_persona']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_persona']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_persona']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_persona']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_persona']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_persona']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_persona']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_persona']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
       if (!empty($nmgp_quant_colunas)) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['qt_col_grid'] = $nmgp_quant_colunas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['qt_lin_grid'] * $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['qt_col_grid']; 
   $this->nm_grid_slides_linha = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['qt_col_grid'];
   $this->Ini->nm_limite_lin = $this->Ini->nm_limite_lin * $this->nm_grid_slides_linha; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ordem_select']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ordem_select'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ordem_select_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ordem_select']; 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ordem_quebra']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ordem_quebra'] = array(); 
       } 
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       { 
           ...
           foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ordem_quebra'] as $campo => $resto) 
           {
               foreach($resto as $sqldef => $ordem) 
               {
                   ...
                   { 
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ordem_quebra'][$campo][$nmgp_ordem] = $ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ordem_cmp'] = $nmgp_ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ordem_label'] = trim($ordem);
                   }   
               }   
           }   
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ordem_grid'] = $nmgp_ordem  ; 
           }
       }
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['where_pesq_filtro'];
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao']       = "igual" ; 
...
// 
   $this->count_ger = 0;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['tot_geral'][1] ;  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] == "final" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['qt_reg_grid'] == "all") 
   { 
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['tot_geral'][1] ;  
       $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['tot_geral'][1];
   } 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
       ...
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['contr_array_resumo']))  
       { 
   ...
   { 
       ...
       $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['where_pesq']; 
       if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['where_pesq'])) 
       { 
           $nmgp_select .= " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['where_resumo']; 
       } 
       else
       { 
           $nmgp_select .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['where_resumo'] . ")"; 
       } 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['sc_total'] = $rt_grid->fields[0];  
       
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
...
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ordem_grid']) 
        {
   ...
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ordem_desc']; 
   } 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] == "pdf" || $this->Ini->Apl_paginacao == "FULL")
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       ...
       $this->p_id_ref_externa = $this->rs_grid->fields[20] ;  
       ...
       $this->SC_seq_page = 0;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['final']; 
   ...
   $this->nmgp_reg_inicial = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['final'] + 1;
   $this->nmgp_reg_final   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['qt_reg_grid'];
   $this->nmgp_reg_final   = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['doc_word'] && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['word_return']);
       ...
       if ($this->Ini->Proc_print && $this->Ini->Export_html_zip  && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['print_return']);
           $this->pb->setTotalSteps($this->count_ger);
       }
       if (!$this->Ini->sc_export_ajax && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['pivot_charts']) : 0;
           ...
           if (-1 < $this->progress_grid)
           {
               ...
               grid_persona_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
               grid_persona_pdf_progress_call($this->Ini->path_js   . "\n", $this->Ini->Nm_lang);
               grid_persona_pdf_progress_call($this->Ini->path_prod . "/img/\n", $this->Ini->Nm_lang);
               grid_persona_pdf_progress_call($this->progress_tot   . "\n", $this->Ini->Nm_lang);
               ...
               grid_persona_pdf_progress_call($this->progress_tot . "_#NM#_" . "1_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ajax_nav'] && !$this->Ini->sc_export_ajax)
       { 
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['embutida'] || $this->Ini->Apl_paginacao == "FULL")
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($this->count_ger) . ";\r\n");
           }
           else
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['qt_reg_grid']) . ";\r\n");
           }
           ...
           $nm_saida->saida("    {\r\n");
           $nm_saida->saida("        let cells = $(\".sc-ui-grid-header-row-grid_persona-1\").find(\"td\");\r\n");
           ...
           $nm_saida->saida("        rows = $(\".sc-ui-grid-header-row-grid_persona-1\");\r\n");
           ...
           $nm_saida->saida("   var gridHeaders = $(\".sc-ui-grid-header-row-grid_persona-1\"), headerDisplayed = true;\r\n");
           ...
           $nm_saida->saida("   tableOriginal = document.getElementById(\"sc-ui-grid-body-ffe72a39\");\r\n");
           ...
           if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao_print'] != 'print' && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['grid_pesq']))
           { 
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ancor_save']);
           }
           if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
           {
...
$nm_saida->saida("}\r\n");
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['num_css']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['num_css'] = rand(0, 1000);
       }
       $write_css = true;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['embutida'] && !$this->Print_All && $this->NM_opcao != "print" && $this->NM_opcao != "pdf")
       {
           $write_css = false;
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['embutida_pdf']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['embutida_pdf'])
       {
           $write_css = true;
       }
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_persona_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['embutida'])
       {
 ...
 { 
       ...
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_persona_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_grid_persona_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema_dir'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_persona/grid_persona_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
  ...
  if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['proc_pdf_vert'])
  {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           $cada_css = ".grid_persona_" . substr($cada_css, 1);
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['embutida'])
   { 
       if (!$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['doc_word'] && ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao_print'] == "print")) 
       {
           if ($this->Print_All) 
           {
               $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
       ...
       {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
          $vertical_center = '';
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] != "pdf" && !$this->Print_All)
       { 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['doc_word'])
       { 
   ...
   else
   {
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] != "pdf" && 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao_print'] != "print") 
       { 
           $nm_saida->saida("    <TR>\r\n");
           $nm_saida->saida("    <TD  colspan=3 style=\"padding: 0px; border-width: 0px; vertical-align: top;\">\r\n");
           $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_A_grid_persona\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_A_grid_persona\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    </TR>\r\n");
           $nm_saida->saida("    <TR>\r\n");
           $nm_saida->saida("    <TD style=\"padding: 0px; border-width: 0px; vertical-align: top;\">\r\n");
           $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_E_grid_persona\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_E_grid_persona\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    <td style=\"padding: 0px;  vertical-align: top;\"><table style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\" width=\"100%\"><tr>\r\n");
           $nm_saida->saida("    <TD colspan=3 style=\"padding: 0px; border-width: 0px; vertical-align: top;\" width=1>\r\n");
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_AL_grid_persona\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_AL_grid_persona\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    </TR>\r\n");
        } 
   }  
 ...
 {  
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_persona']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_persona']) . "_";
           } 
       } 
       else 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_persona']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_persona']) . "_";
           } 
       }
   }
   $temp_css  = explode("/", $compl_css);
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['embutida']) ? "grid_persona_" : "";
   $this->css_sep = " ";
   ...
   $this->css_p_id_ref_externa_label = $compl_css_emb . "css_p_id_ref_externa_label";
   $this->css_p_id_ref_externa_grid_line = $compl_css_emb . "css_p_id_ref_externa_grid_line";
   $this->css_codbar_label = $compl_css_emb . "css_codbar_label";
   $this->css_codbar_grid_line = $compl_css_emb . "css_codbar_grid_line";
   $this->css_carnet_label = $compl_css_emb . "css_carnet_label";
   $this->css_carnet_grid_line = $compl_css_emb . "css_carnet_grid_line";
...
//----- 
 function cabecalho_normal()
 {
   global
          $nm_saida;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dashboard_info']['maximized'])
   {
       return; 
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opc_liga']['cab']))
   {
       return; 
   }
   $nm_cab_filtro   = ""; 
   ...
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['where_pesq_filtro'];
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['cond_pesq']))
   {  
       $pos       = 0;
       $trab_pos  = false;
       $pos_tmp   = true; 
       $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['cond_pesq'];
       while ($pos_tmp)
       {
          $pos = strpos($tmp, "##*@@", $pos);
          if ($pos !== false)
       ...
       $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
       $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
       $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['cond_pesq'], 0, $trab_pos);
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['sv_dt_head']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['sv_dt_head'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['sv_dt_head']['fix'] = $nm_data_fixa;
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['sv_dt_head'] as $ind => $val)
   {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['sv_dt_head']['fix'] != $nm_data_fixa)
   {
       $nm_refresch_cab_rod = true;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ajax_nav'] && $nm_refresch_cab_rod)
   { 
   ...
   { 
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['proc_pdf']) 
     { 
         $this->NM_calc_span();
           $nm_saida->saida("   <TD colspan=\"" . $this->NM_colspan . "\" class=\"" . $this->css_scGridTabelaTd . "\" style=\"vertical-align: top\">\r\n");
     } 
     else if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['proc_pdf_vert']) 
     {
   ...
   $nm_saida->saida(" </TR>\r\n");
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ordem_cmp'] == $fieldName) {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ordem_label'] == 'desc') {
                $sortRule = 'desc';
            } else {
                $sortRule = 'asc';
            }
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ini_cor_grid']);
       }
   }
...
// 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['labels']['td_nombre'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['qrcode'])) ? $this->New_label['qrcode'] : "Código QR";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['labels']['qrcode'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['p_foto'])) ? $this->New_label['p_foto'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['labels']['p_foto'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['p_nombre'])) ? $this->New_label['p_nombre'] : "Nombre";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['labels']['p_nombre'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['g_genero'])) ? $this->New_label['g_genero'] : "Género";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['labels']['g_genero'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['e_nombre'])) ? $this->New_label['e_nombre'] : "Étnia";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['labels']['e_nombre'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['p_noidentificacion'])) ? $this->New_label['p_noidentificacion'] : "No Identificación";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['labels']['p_noidentificacion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['p_fechadenacimiento'])) ? $this->New_label['p_fechadenacimiento'] : "Fecha De Nacimiento";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['labels']['p_fechadenacimiento'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['anios'])) ? $this->New_label['anios'] : "Años";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['labels']['anios'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['meses'])) ? $this->New_label['meses'] : "Meses";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['labels']['meses'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['getario'])) ? $this->New_label['getario'] : "Getario";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['labels']['getario'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['ec_nombre'])) ? $this->New_label['ec_nombre'] : "Estado Civil";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['labels']['ec_nombre'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['l_nombre'])) ? $this->New_label['l_nombre'] : "LGBT";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['labels']['l_nombre'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['p_iddepartamento'])) ? $this->New_label['p_iddepartamento'] : "Departamento";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['labels']['p_iddepartamento'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['p_idmunicipio'])) ? $this->New_label['p_idmunicipio'] : "Municipio";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['labels']['p_idmunicipio'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['c_nombre'])) ? $this->New_label['c_nombre'] : "Comunidad";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['labels']['c_nombre'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['p_direccion'])) ? $this->New_label['p_direccion'] : "Direccion";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['labels']['p_direccion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['p_email'])) ? $this->New_label['p_email'] : "Email";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['labels']['p_email'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['p_telefono'])) ? $this->New_label['p_telefono'] : "Teléfono";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['labels']['p_telefono'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['p_cargo'])) ? $this->New_label['p_cargo'] : "Cargo";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['labels']['p_cargo'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['p_institucion'])) ? $this->New_label['p_institucion'] : "Institucion";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['labels']['p_institucion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['p_id_ref_externa'])) ? $this->New_label['p_id_ref_externa'] : "Id Ref Externa";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['labels']['p_id_ref_externa'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['codbar'])) ? $this->New_label['codbar'] : "Código de Barras";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['labels']['codbar'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['carnet'])) ? $this->New_label['carnet'] : "CARNET";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['labels']['carnet'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['p_idpersona'])) ? $this->New_label['p_idpersona'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['labels']['p_idpersona'] = $SC_Label; 
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['grid_persona']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_persona']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_persona']['lig_edit'];
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       {
           $this->Lin_impressas++;
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['embutida_grid'])
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['cols_emb']))
               {
                   $cont_col = 0;
                   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['field_order'] as $cada_field)
                   {
                       $cont_col++;
                   }
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['cols_emb'];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['rows_emb']++;
           ...
           {
               $nm_saida->saida("<table id=\"apl_grid_persona#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               ...
               $nm_id_aplicacao = "";
               $nm_saida->saida("  <tr><td class=\"" . $this->css_scGridFieldOdd . "\"  style=\"padding: 0px; font-family:" . $this->Ini->texto_fonte_tipo_impar . ";font-size:12px;\" colspan = \"26\" align=\"center\">\r\n");
      ...
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_EL_grid_persona\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_EL_grid_persona\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
               $nm_saida->saida("    </TD>\r\n");
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['force_toolbar'] = true;
           } 
           ...
           { 
               ...
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_A_grid_persona', 'value' => 'NM_Blank_Page.htm');
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_D_grid_persona', 'value' => 'NM_Blank_Page.htm');
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_E_grid_persona', 'value' => 'NM_Blank_Page.htm');
               $_SESSION['scriptcase']['saida_html'] = "";
           } 
           $nm_saida->saida("  </td></tr>\r\n");
           if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] != "pdf" &&
      ...
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_DL_grid_persona\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_DL_grid_persona\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
               $nm_saida->saida("</TD>\r\n");
               $nm_saida->saida("    <TD style=\"padding: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_D_grid_persona\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_D_grid_persona\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
               $nm_saida->saida("    </TD>\r\n");
               $nm_saida->saida("    </TR>\r\n");
           } 
       $nm_saida->saida("</TABLE>\r\n");
...
else
{
      ...
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_EL_grid_persona\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_EL_grid_persona\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       ...
       $nm_id_aplicacao = " id=\"apl_grid_persona#?#1\"";
   } 
   $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] == "pdf") ? "padding: 0px !important;" : "";
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['proc_pdf_vert'])
{
}
else
{
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opc_psq'])
   { 
...
{
   $nm_saida->saida("    <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-ffe72a39\" align=\"center\" width=\"100%\">\r\n");
}
if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['proc_pdf_vert']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['embutida'] )
{
...
// 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['Config_Page_break_PDF'] = "S";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['Page_break_PDF']))
   {
       if (isset($this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['SC_Ind_Groupby']]))
       {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['SC_Ind_Groupby'] == "sc_free_group_by")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['SC_Gb_Free_cmp'] as $Cmp_gb => $resto)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['Page_break_PDF'][$Cmp_gb] = $this->Break_pag_pdf['sc_free_group_by'][$Cmp_gb];
               }
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['Page_break_PDF'] = $this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['SC_Ind_Groupby']];
           }
       }
       else
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['Page_break_PDF'] = array();
       }
   }
   ...
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          ...
          //---------- Gauge ----------
          if (!$this->Ini->sc_export_ajax && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
              if (0 == $this->progress_lim_now)
              {
               ...
               if (!NM_is_utf8($lang_protect))
               {
                  ...
                  grid_persona_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $lang_protect . " " . $this->progress_now . "...\n", $this->Ini->Nm_lang);
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['SC_Ind_Groupby'] != "sc_free_total")
         {
          ...
          $GLOBALS["p_idmunicipio"] = (string)$GLOBALS["p_idmunicipio"];
          $this->SC_seq_page++; 
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['final'] + 1; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['rows_emb']++;
...
$_SESSION['scriptcase']['grid_persona']['contr_erro'] = 'off';
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dado_psq_ret'];
...
$nm_saida->saida("    <table width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px;\"><tr valign=\"top\"><td style=\"padding: 0px\" width=\"100%\" height=\"\">\r\n");
 if(!isset($this->Ini->nm_hidden_blocos[0]) || $this->Ini->nm_hidden_blocos[0] != "off")
 {
     ...
     $Img_tit_blk_f = "";
     $Collapse_blk  = "";
     if ('' != $this->Ini->Block_img_exp && '' != $this->Ini->Block_img_col && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] != "pdf")
     {
...
$nm_saida->saida("  <TABLE class=\"" . $this->css_scGridTabela . "\"  style=\"border-collapse:collapse;\" cellspacing=0px cellpadding=0px align=\"center\" id=\"grid_persona_hidden_bloco_0_" . $this->nm_contr_album . "\" width=\"100%\" style=\"height: 100%\">\r\n");
$nm_saida->saida("   <TR>\r\n");
...
$nm_saida->saida("      <TR>\r\n");
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao_print'] != "print") { 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . "\"  NOWRAP align=\"center\" valign=\"\" width=\"25%\" >\r\n");
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['mostra_edit'] != "N"){ 
              $Sc_parent = ($this->grid_emb_form || $this->grid_emb_form_full) ? "S" : "";
              $Parms_Det  = "nmgp_chave_det?#?" . $this->td_nombre . "*PDet*" . $this->p_foto . "*PDet*" . $this->p_nombre . "*PDet*" . $this->g_genero . "*PDet*" . $this->e_nombre . "*PDet*" . $this->p_noidentificacion . "*PDet*" . $this->anios . "*PDet*" . $this->meses . "*PDet*" . $this->getario . "*PDet*" . $this->ec_nombre . "*PDet*" . $this->l_nombre . "*PDet*" . $this->p_iddepartamento . "*PDet*" . $this->p_idmunicipio . "*PDet*" . $this->c_nombre . "*PDet*" . $this->p_direccion . "*PDet*" . $this->p_email . "*PDet*" . $this->p_telefono . "*PDet*" . $this->p_cargo . "*PDet*" . $this->p_institucion . "*PDet*" . $this->p_id_ref_externa . "*PDet*" . $this->p_idpersona . "?@?Sc_seq_det?#?" . $this->SC_seq_register . "?#?";
              $Md5_Det    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_persona@SC_par@" . md5($Parms_Det);
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['Lig_Md5'][md5($Parms_Det)] = $Parms_Det;
     $Link_Det  = nmButtonOutput($this->arr_buttons, "bcons_detalhes", "nm_gp_submit3('" . $Md5_Det . "', '', 'detalhe', '" . $this->SC_ancora . "')", "nm_gp_submit3('" . $Md5_Det . "', '', 'detalhe', '" . $this->SC_ancora . "')", "", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              if ($_SESSION['scriptcase']['proc_mobile']) {
                  $Link_Det  = nmButtonOutput($this->arr_buttons, "bcons_detalhes", "nm_submit_modal('" . $this->Ini->path_link . "grid_persona/index.php?nmgp_parms=" . $Md5_Det . "&nmgp_parm_acum=&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&SC_lig_apl_orig=grid_persona&nmgp_opcao=detalhe&KeepThis=true&TB_iframe=true&height=440&width=630&modal=true', '" . $Sc_parent . "')", "nm_submit_modal('" . $this->Ini->path_link . "grid_persona/index.php?nmgp_parms=" . $Md5_Det . "&nmgp_parm_acum=&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&SC_lig_apl_orig=grid_persona&nmgp_opcao=detalhe&KeepThis=true&TB_iframe=true&height=440&width=630&modal=true', '" . $Sc_parent . "')", "", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              }
              ...
              if (isset($this->Ini->sc_lig_md5["form_persona"]) && $this->Ini->sc_lig_md5["form_persona"] == "S")
              {
                  ...
                  $Md5_Edt    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_persona@SC_par@" . md5($Parms_Edt);
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['Lig_Md5'][md5($Parms_Edt)] = $Parms_Edt;
              }
              else
              {
...
$nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelVert . $this->css_sep . $this->css_td_nombre_label . "\"   align=\"\" valign=\"\" width=\"25%\" >\r\n");
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_td_nombre_grid_line . "\"  style=\"" . $this->Css_Cmp['css_td_nombre_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\" width=\"25%\"  HEIGHT=\"0px\">\r\n");
          ...
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] != 'pdf') {
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_qrcode_grid_line . "\"  style=\"" . $this->Css_Cmp['css_qrcode_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\" width=\"25%\"  HEIGHT=\"0px\">\r\n");
          ...
          { 
              ...
              elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['doc_word'] || $this->Img_embbed || $this->Ini->sc_export_ajax_img) 
              { 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_p_foto_grid_line . "\"  style=\"" . $this->Css_Cmp['css_p_foto_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\" width=\"25%\"  HEIGHT=\"0px\">\r\n");
          ...
          { 
              ...
              elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['embutida_pdf'] != "pdf") 
              { 
...
$nm_saida->saida("&nbsp;\r\n");
   ...
   else
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ordem_cmp'] == $NM_cmp_class)
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ordem_desc'] == " desc")
          {
...
$nm_saida->saida("    </TD>\r\n");
$nm_saida->saida("   </tr><tr>\r\n");
$nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelVert . $this->css_sep . $this->css_p_fechadenacimiento_label . "\"   align=\"\" valign=\"\" width=\"25%\" >\r\n");
...
$nm_saida->saida("    </TD>\r\n");
$nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelVert . $this->css_sep . $this->css_anios_label . "\"   align=\"\" valign=\"\" width=\"25%\" >\r\n");
...
$nm_saida->saida("    </TD>\r\n");
$nm_saida->saida("   </tr><tr>\r\n");
$nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelVert . $this->css_sep . $this->css_meses_label . "\"   align=\"\" valign=\"\" width=\"25%\" >\r\n");
...
$nm_saida->saida("    </TD>\r\n");
$nm_saida->saida("   </tr><tr>\r\n");
$nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelVert . $this->css_sep . $this->css_p_id_ref_externa_label . "\"   align=\"\" valign=\"\" width=\"25%\" >\r\n");
   if (isset($this->NM_cmp_hidden['p_id_ref_externa']) && $this->NM_cmp_hidden['p_id_ref_externa'] == "off")
   {
       $SC_Label = "&nbsp;"; 
   }
   else
   ...
   { 
$nm_saida->saida("     <span style=\"" . $this->Css_Cmp['css_p_id_ref_externa_label'] . "\">" . nl2br($SC_Label) . "</span>\r\n");
   } 
$nm_saida->saida("    </TD>\r\n");
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_p_id_ref_externa_grid_line . "\"  style=\"" . $this->Css_Cmp['css_p_id_ref_externa_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\" width=\"25%\"  HEIGHT=\"0px\">\r\n");
          $conteudo = sc_strip_script($this->p_id_ref_externa); 
          $conteudo_original = sc_strip_script($this->p_id_ref_externa); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
...
$nm_saida->saida("     <span id=\"id_sc_field_p_id_ref_externa_" . $this->SC_seq_page . "\"><span >" . $conteudo . "</span></span>\r\n");
$nm_saida->saida("    </TD>\r\n");
...
$nm_saida->saida("    </TD>\r\n");
$nm_saida->saida("   </tr><tr>\r\n");
$nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelVert . $this->css_sep . $this->css_carnet_label . "\"   align=\"\" valign=\"\" width=\"25%\" >\r\n");
   if (isset($this->NM_cmp_hidden['carnet']) && $this->NM_cmp_hidden['carnet'] == "off")
   {
       $SC_Label = "&nbsp;"; 
   }
   else
   ...
   { 
$nm_saida->saida("     <span style=\"" . $this->Css_Cmp['css_carnet_label'] . "\">" . nl2br($SC_Label) . "</span>\r\n");
   } 
$nm_saida->saida("    </TD>\r\n");
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_carnet_grid_line . "\"  style=\"" . $this->Css_Cmp['css_carnet_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\" width=\"25%\"  HEIGHT=\"0px\">\r\n");
          $conteudo = $this->carnet; 
          $conteudo_original = $this->carnet; 
          if (!is_file($this->Ini->root  . $this->Ini->path_imag_cab . "/scriptcase__NM__ico__NM__id_card2_24.png"))
          { 
              $conteudo = "&nbsp;" ;  
          } 
          else 
          { 
              if ($this->Ini->Export_img_zip)
              {
                  $this->Ini->Img_export_zip[] = $this->Ini->root . "/" . $this->Ini->path_imag_cab . "/scriptcase__NM__ico__NM__id_card2_24.png";
                  $conteudo = "<img border=\"\" src=\"scriptcase__NM__ico__NM__id_card2_24.png\"/>"; 
              }
              elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['doc_word'] || $this->Img_embbed || $this->Ini->sc_export_ajax_img) 
              { 
                  $loc_img_word = $this->Ini->root . $this->Ini->path_imag_cab . "/scriptcase__NM__ico__NM__id_card2_24.png";
                  $tmp_carnet = fopen($loc_img_word, "rb"); 
                  $reg_carnet = fread($tmp_carnet, filesize($loc_img_word)); 
                  fclose($tmp_carnet);  
                  $conteudo = "<img border=\"0\" src=\"data:image/jpeg;base64," . base64_encode($reg_carnet) . "\"/>" ; 
              } 
              else 
              { 
                  $conteudo = "<img border=\"0\" src=\"" . $this->NM_raiz_img  . $this->Ini->path_imag_cab . "/scriptcase__NM__ico__NM__id_card2_24.png\"/>" ; 
              } 
          } 
          $str_tem_display = $conteudo;
          $classColFld = "";
...
$nm_saida->saida("     \r\n");
 if (!$this->Ini->Proc_print && !$this->Ini->SC_Link_View && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] != "pdf" && $_SESSION['scriptcase']['contr_link_emb'] != "pdf" && $conteudo != "&nbsp;"){ $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['Ind_lig_mult']++;
       $linkTarget = isset($this->Ini->sc_lig_target['C_@scinf_carnet_@scinf_pdfreport_persona']) ? $this->Ini->sc_lig_target['C_@scinf_carnet_@scinf_pdfreport_persona'] : (isset($this->Ini->sc_lig_target['C_@scinf_carnet']) ? $this->Ini->sc_lig_target['C_@scinf_carnet'] : null);
       if (isset($this->Ini->sc_lig_md5["pdfreport_persona"]) && $this->Ini->sc_lig_md5["pdfreport_persona"] == "S") {
           $Parms_Lig = "nmgp_lig_edit_lapis?#?S?@?glopersona?#?" . str_replace("'", "@aspass@", $this->p_idpersona) . "?@?";
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dashboard_info']['under_dashboard'] && isset($linkTarget))
           {
               if ('' != $Parms_Lig)
               {
                   $Parms_Lig .= '*scout';
               }
               $Parms_Lig .= 'under_dashboard*scin1*scoutdashboard_app*scin' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dashboard_info']['dashboard_app'] . '*scoutown_widget*scin' . $linkTarget . '*scoutparent_widget*scin' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dashboard_info']['own_widget'] . '*scoutcompact_mode*scin' . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dashboard_info']['compact_mode'] ? '1' : '0') . '*scoutremove_margin*scin' . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dashboard_info']['remove_margin'] ? '1' : '0') . '*scoutremove_border*scin' . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dashboard_info']['remove_border'] ? '1' : '0');
           }
           $Md5_Lig    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_persona@SC_par@" . md5($Parms_Lig);
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
       } else {
           $Md5_Lig = "nmgp_lig_edit_lapis?#?S?@?glopersona?#?" . str_replace("'", "@aspass@", $this->p_idpersona) . "?@?";
       }
$nm_saida->saida("<a id=\"id_sc_field_carnet_" . $this->SC_seq_page . "\" href=\"javascript:nm_gp_submit5('" . $this->Ini->link_pdfreport_persona_cons . "', '$this->nm_location', '$Md5_Lig', '" . (isset($linkTarget) ? $linkTarget : '_blank') . "', 'inicio', '0', '0', '', 'pdfreport_persona', '" . $this->SC_ancora . "')\" onMouseover=\"nm_mostra_hint(this, event, 'Ver/Imprimir Carnet')\" onMouseOut=\"nm_apaga_hint()\" class=\"" . $this->Ini->cor_link_dados . $this->css_sep . $this->css_carnet_grid_line . "\">" . $conteudo . "</a>\r\n");
} else {
$nm_saida->saida(" <span id=\"id_sc_field_carnet_" . $this->SC_seq_page . "\">$conteudo </span>\r\n");
       } 
$nm_saida->saida("    </TD>\r\n");
$nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelVert . $this->css_sep . $this->css_p_idpersona_label . "\"   align=\"\" valign=\"\" width=\"25%\" >\r\n");
...
$nm_saida->saida("    </td></tr></table></td>\r\n");
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['exibe_total'] == "S")
       { 
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['SC_Ind_Groupby'] . "_top";
           $this->$Gb_geral() ;
       } 
   }  
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['embutida_grid'])
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] != "pdf" && empty($this->nm_grid_sem_reg) && 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao_print'] != "print") 
   { 
       $nm_saida->saida("</TABLE></TD>\r\n");
       $nm_saida->saida("<TD style=\"padding: 0px; border-width: 0px;\" valign=\"top\" width=1>\r\n");
 ...
 function nm_quebra_pagina($nm_parms)
 {
    ...
    if (($this->Ini->nm_limite_lin > 0 && $this->Ini->nm_cont_lin > $this->Ini->nm_limite_lin) || $nm_parms == "pagina" || $nm_parms == "resumo" || $nm_parms == "total")
    {
        ...
        if ($this->Print_All)
        {
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['print_navigator']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['print_navigator'] == "Netscape")
            {
        ...
        if ($nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['embutida'])
        {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['proc_pdf']) { 
           }
           else
 ...
 function quebra_geral_sc_free_total_bot() 
 {
   ...
   function nmgp_barra_top_normal()
   {
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
      {
          ...
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['fast_search'][2] : "";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ajax_nav'])
          {
      ...
      if ($this->nmgp_botoes['group_1'] == "on" && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("           $Cod_Btn\r\n");
      if ($this->nmgp_botoes['pdf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['SC_Gb_Free_cmp']))
      {
          $Tem_pdf_res = "n";
      }
              $this->nm_btn_exist['pdf'][] = "pdf_top";
          $nm_saida->saida("            <div id=\"div_pdf_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "pdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_persona/grid_persona_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=8&lpapel=279&apapel=216&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&sc_ver_93=s&nm_tem_gb=" . $Tem_gb_pdf . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_pdf_res=grid,resume&nm_all_modules=grid,resume,chart&nm_label_group=N&nm_all_cab=S&nm_all_label=S&nm_orient_grid=4&password=n&summary_export_columns=N&pdf_zip=N&origem=cons&language=es&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_persona&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_word_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['SC_Ind_Groupby'] != "sc_free_total")
          ...
          $nm_saida->saida("            <div id=\"div_word_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_persona/grid_persona_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_cor=CO&nm_res_cons=" . $Tem_word_res . "&nm_ini_word_res=grid,resume&nm_all_modules=grid,resume,chart&password=n&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_xls_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['SC_Ind_Groupby'] != "sc_free_total")
          ...
          $nm_saida->saida("            <div id=\"div_xls_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "xls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_persona/grid_persona_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_persona&nm_tp_xls=xlsx&nm_tot_xls=S&nm_res_cons=" . $Tem_xls_res . "&nm_ini_xls_res=grid,resume&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=N&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['csv'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_csv_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['SC_Ind_Groupby'] != "sc_free_total")
      ...
      if ($this->nmgp_botoes['print'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Tem_pdf_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['SC_Ind_Groupby'] != "sc_free_total")
          {
          ...
          $nm_saida->saida("            <div id=\"div_print_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "print_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_persona/grid_persona_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_opc=RC&nm_cor=CO&password=n&language=es&nm_page=" . NM_encode_input($this->Ini->sc_page) . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_prt_res=grid,resume&nm_all_modules=grid,resume,chart&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['dynsearch'] == "on" && !$this->grid_emb_form)
      {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['SC_Ind_Groupby'] != "sc_free_total")
        {
          ...
          if (is_file("grid_persona_help.txt") && !$this->grid_emb_form)
          {
             $Arq_WebHelp = file("grid_persona_help.txt"); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dashboard_info']['under_dashboard']))
      {
      ...
      {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['sc_modal'])
        {
   ...
   function nmgp_barra_bot_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao_print'] != "print") 
      {
          ...
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['qt_lin_grid'];
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['qtline'] == "on" && $this->Ini->Apl_paginacao != "FULL")
          {
              ...
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['qt_lin_grid'] == 1) ? " selected" : "";
              $nm_saida->saida("           <option value=\"1\" " . $obj_sel . ">1</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['qt_lin_grid'] == 10) ? " selected" : "";
              $nm_saida->saida("           <option value=\"10\" " . $obj_sel . ">10</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['qt_lin_grid'] == 20) ? " selected" : "";
              $nm_saida->saida("           <option value=\"20\" " . $obj_sel . ">20</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['qt_lin_grid'] == 50) ? " selected" : "";
              $nm_saida->saida("           <option value=\"50\" " . $obj_sel . ">50</option>\r\n");
              $nm_saida->saida("          </select>\r\n");
              $nm_saida->saida("          <input type=\"text\" class=\"" . $this->css_css_toolbar_obj . "\" id=\"quant_colunas_f0_bot\" name=\"nmgp_quant_colunas\" value=\"" . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['qt_col_grid']) . "\" onchange=\"sc_ind = document.getElementById('quant_linhas_f0_bot').selectedIndex; nm_gp_submit_ajax('muda_qt_linhas', document.getElementById('quant_linhas_f0_bot').options[sc_ind].value + ';' + document.getElementById('quant_colunas_f0_bot').value);\" style=\"width:25px;vertical-align: middle;\"/> \r\n");
              $NM_btn = true;
          }
          $nm_saida->saida("         </td> \r\n");
          $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"center\" width=\"33%\"> \r\n");
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opc_liga']['nav']))
          {
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['navpage'] == "on" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opc_liga']['nav']) && $this->Ini->Apl_paginacao != "FULL" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['qt_lin_grid'] != "all")
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['qt_lin_grid'] * $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['qt_col_grid'];
              $Max_link   = 5;
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opc_liga']['nav']))
          {
   ...
   function nmgp_barra_top_mobile()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['SC_Gb_Free_cmp']))
      {
          $Tem_pdf_res = "n";
              ...
              $this->nm_btn_exist['pdf'][] = "pdf_top";
          $nm_saida->saida("            <div id=\"div_pdf_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "pdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_persona/grid_persona_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=8&lpapel=279&apapel=216&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&sc_ver_93=s&nm_tem_gb=" . $Tem_gb_pdf . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_pdf_res=grid,resume&nm_all_modules=grid,resume,chart&nm_label_group=N&nm_all_cab=S&nm_all_label=S&nm_orient_grid=4&password=n&summary_export_columns=N&pdf_zip=N&origem=cons&language=es&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_persona&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_word_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $this->nm_btn_exist['word'][] = "word_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_persona/grid_persona_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_cor=CO&nm_res_cons=" . $Tem_word_res . "&nm_ini_word_res=grid,resume&nm_all_modules=grid,resume,chart&password=n&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
   ...
   function html_dynamic_search()
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['cond_dyn_search']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['cond_dyn_search']))
       {
           $tmp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['cond_dyn_search'];
           $pos = strrpos($tmp, "##*@@");
           if ($pos !== false)
           {
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ajax_nav'])
       {
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['save_grid']) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dyn_search_clear']))
           {
               return;
           }
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dyn_search_label'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dyn_search_label']['td_nombre'] = (isset($this->New_label['td_nombre'])) ? $this->New_label['td_nombre'] : "Tipo de Identificación";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dyn_search_label']['p_noidentificacion'] = (isset($this->New_label['p_noidentificacion'])) ? $this->New_label['p_noidentificacion'] : "No Identificación";
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dyn_search']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dyn_search']))
       {
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dyn_search'] as $IX => $def)
           {
               $cmp = $def['cmp'];
               if ($cmp == "td_nombre")
               {
       ...
       $nm_saida->saida("                <div class='scBtnGrpText' style='cursor: pointer;' onclick=\"ajax_add_dyn_search('td_nombre', 'grid')\">" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dyn_search_label']['td_nombre'] . "\r\n");
       $nm_saida->saida("                </div>\r\n");
       $nm_saida->saida("            </td>\r\n");
       $nm_saida->saida("        </tr>\r\n");
       $nm_saida->saida("        <tr>\r\n");
       $nm_saida->saida("            <td class='scBtnGrpBackground'>\r\n");
       $nm_saida->saida("                <div class='scBtnGrpText' style='cursor: pointer;' onclick=\"ajax_add_dyn_search('p_noidentificacion', 'grid')\">" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dyn_search_label']['p_noidentificacion'] . "\r\n");
       $nm_saida->saida("                </div>\r\n");
       $nm_saida->saida("            </td>\r\n");
       $nm_saida->saida("        </tr>\r\n");
       $nm_saida->saida("      </table> \r\n");
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           $this->Ini->Arr_result['setValue'][] = array('field' => 'id_dyn_search_cmd_str', 'value' => NM_charset_to_utf8(trim($this->Dyn_search_str)));
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dyn_search_clear']))
           { 
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dyn_search_clear']);
               return;
           } 
       } 
       $nm_saida->saida("   </tr>\r\n");
   ...
   function dynamic_search_td_nombre($ind, $ajax, $opc="", $val=array())
   {
       ...
       $lin_obj .= "      <td style='border-style: none' nowrap>" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dyn_search_label']['td_nombre'] . "</td>";
   ...
   function dynamic_search_p_noidentificacion($ind, $ajax, $opc="", $val=array())
   {
       ...
       $lin_obj .= "      <td style='border-style: none' nowrap>" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['dyn_search_label']['p_noidentificacion'] . "</td>";
       $lin_obj .= "      <td style='border-style: none' >";
       if (empty($opc))
       {
           $opc = "qp";
      ...
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
          ...
          { 
            ...
            $cmp1 = grid_persona_pack_protect_string($cmp1);
            $nmgp_def_dados[] = array($cmp1 => $cmp1); 
             $rs->MoveNext(); 
          } 
          $rs->Close(); 
   ...
   function html_grid_search()
   {
       ...
       $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['grid_pesq'])?'none':'';
       if(!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ajax_nav'])
       {
          $nm_saida->saida("   <tr id=\"NM_Grid_Search\" ajax='' style='display:" . $str_display . "'>\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['grid_pesq']))
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['grid_pesq'] as $cmp => $def)
           {
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['save_grid']))
           {
               return;
           }
           else
       ...
       $nm_saida->saida("            <input type=\"hidden\" name=\"parm\" value=\"\"/> \r\n");
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['save_grid']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['grid_pesq']))
           { 
   ...
   function grid_search_add_tag()
   {
       ...
       if (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['grid_pesq']) < 2)
       {
           $lin_obj .= "<table id='id_grid_search_all_cmp' cellpadding=0 cellspacing=0>";
           foreach ($All_cmp_search as $cada_cmp)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['grid_pesq'][$cada_cmp]))
               {
                   $lin_obj .= "  <tr>";
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "MealSint2/grid_persona";
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   $nm_saida->saida("   </TR>\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] != "pdf" &&
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao_print'] != "print" && !$this->Print_All) 
   { 
      $nm_saida->saida("     <tr><td colspan=3  class=\"" . $this->css_scGridTabelaTd . "\" style=\"vertical-align: top\"> \r\n");
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_B_grid_persona\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_B_grid_persona\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
      $nm_saida->saida("     </td></tr> \r\n");
   } 
   $nm_saida->saida("   </TABLE>\r\n");
   $nm_saida->saida("   </div>\r\n");
   ...
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   ...
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
       $nm_saida->saida("   document.getElementById('first_bot').disabled = true;\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['ajax_nav'])
       {
   ...
   $nm_saida->saida("   if (typeof(scSetFixedHeaders) === typeof(function(){})) scSetFixedHeaders();\r\n");
   $nm_saida->saida("  });\r\n");
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
               $nm_saida->saida("   document.getElementById('forward_bot').disabled = true;\r\n");
               $nm_saida->saida("   document.getElementById('forward_bot').className = \"scButton_" . $this->arr_buttons['bcons_avanca']['style'] . " disabled\";\r\n");
   ...
   if ($this->grid_emb_form || $this->grid_emb_form_full)
   {
       ...
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_persona', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      }\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"grid_persona\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"grid_persona_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   $nm_saida->saida("           document.Fdoc_word.action = \"grid_persona_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("      {\r\n");
   $nm_saida->saida("          NM_ancor_ult_lig = ancor;\r\n");
   $nm_saida->saida("          par_modal = '?&nmgp_outra_jan=true&nmgp_url_saida=modal&SC_lig_apl_orig=grid_persona';\r\n");
   $nm_saida->saida("          if (opc != null && opc != '') \r\n");
   $nm_saida->saida("          {\r\n");
   ...
   $nm_saida->saida("          return;\r\n");
   $nm_saida->saida("      }\r\n");
   $nm_saida->saida("      if (pos == \"A\") {obj = document.getElementById('nmsc_iframe_liga_A_grid_persona');} \r\n");
   $nm_saida->saida("      if (pos == \"B\") {obj = document.getElementById('nmsc_iframe_liga_B_grid_persona');} \r\n");
   $nm_saida->saida("      if (pos == \"E\") {obj = document.getElementById('nmsc_iframe_liga_E_grid_persona');} \r\n");
   $nm_saida->saida("      if (pos == \"D\") {obj = document.getElementById('nmsc_iframe_liga_D_grid_persona');} \r\n");
   ...
   $nm_saida->saida("           document.F3.SC_module_export.value = z;\r\n");
   $nm_saida->saida("       }\r\n");
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['grid_persona_iframe_params'] = array(
   ...
   $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_persona@SC_par@" . md5($prep_parm_pdf);
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   $nm_saida->saida("               document.Fprint.action = \"grid_persona_export_ctrl.php\";\r\n");
   $nm_saida->saida("           }\r\n");
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   ...
   $nm_saida->saida("           document.Fexport.action = \"grid_persona_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['campo_psq_ret']) )
   {
      $nm_saida->saida("      if (document.Fpesq.nm_ret_psq.value != \"\")\r\n");
      $nm_saida->saida("      {\r\n");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['sc_modal'])
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['grid_persona']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form  = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Form1 = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("           var Obj_Doc   = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form  = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Form1 = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("          var Obj_Doc   = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form  = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Form1 = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['campo_psq_ret']) . ";\r\n");
          $nm_saida->saida("          var Obj_Doc   = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"grid_persona_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_persona']['reg_start']))
   {
       $nm_saida->saida("      $(document).ready(function(){\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailStatus('grid_persona')\",50);\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_persona', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      })\r\n");
   }
