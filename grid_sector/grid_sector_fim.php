...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["MealSint2_____grid_sector"]))
   {
      unset($_SESSION['session_sec_aplicacao']["MealSint2_____grid_sector"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_sector']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_sector']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_sector']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_sector']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_sector']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_sector']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_sector']['embutida_filho'] as $ind => $sc_init)
          {
