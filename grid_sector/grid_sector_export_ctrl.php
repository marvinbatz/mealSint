<?php
@session_start() ;
$_SESSION['scriptcase']['grid_sector']['sc_process_barr'] = true;
require_once('../grid_sector/index.php');
unset($_SESSION['scriptcase']['grid_sector']['sc_process_barr']);
$ExportCtrl = new grid_sector_export_control;
$ExportCtrl->Export_barr();

class grid_sector_export_control
{
