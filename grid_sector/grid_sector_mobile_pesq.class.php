...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_codsector_cond" name="codsector_cond" onChange="nm_campos_between(document.getElementById('id_vis_codsector'), this, 'codsector')">
      ...
      <br><span id="id_hide_codsector"  <?php echo $str_hide_codsector?>><?php
      if ($codsector != "")
      {
      $codsector_look = substr($this->Db->qstr($codsector), 1, -1); 
      $nmgp_def_dados = array(); 
