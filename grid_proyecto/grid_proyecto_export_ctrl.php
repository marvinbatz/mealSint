<?php
@session_start() ;
$_SESSION['scriptcase']['grid_proyecto']['sc_process_barr'] = true;
require_once('../grid_proyecto/index.php');
unset($_SESSION['scriptcase']['grid_proyecto']['sc_process_barr']);
$ExportCtrl = new grid_proyecto_export_control;
$ExportCtrl->Export_barr();

class grid_proyecto_export_control
{
