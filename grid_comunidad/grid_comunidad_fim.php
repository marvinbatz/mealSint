...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["MealSint2_____grid_comunidad"]))
   {
      unset($_SESSION['session_sec_aplicacao']["MealSint2_____grid_comunidad"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_comunidad']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_comunidad']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_comunidad']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_comunidad']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_comunidad']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_comunidad']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_comunidad']['embutida_filho'] as $ind => $sc_init)
          {
