<?php
@session_start() ;
$_SESSION['scriptcase']['grid_comunidad']['sc_process_barr'] = true;
require_once('../grid_comunidad/index.php');
unset($_SESSION['scriptcase']['grid_comunidad']['sc_process_barr']);
$ExportCtrl = new grid_comunidad_export_control;
$ExportCtrl->Export_barr();

class grid_comunidad_export_control
{
