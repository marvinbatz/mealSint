<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tec_videotutoriales']['sc_process_barr'] = true;
require_once('../grid_tec_videotutoriales/index.php');
unset($_SESSION['scriptcase']['grid_tec_videotutoriales']['sc_process_barr']);
$ExportCtrl = new grid_tec_videotutoriales_export_control;
$ExportCtrl->Export_barr();

class grid_tec_videotutoriales_export_control
{
