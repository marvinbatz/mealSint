<?php
@session_start() ;
$_SESSION['scriptcase']['grid_jdp_planificacion_aprobado']['sc_process_barr'] = true;
require_once('../grid_jdp_planificacion_aprobado/index.php');
unset($_SESSION['scriptcase']['grid_jdp_planificacion_aprobado']['sc_process_barr']);
$ExportCtrl = new grid_jdp_planificacion_aprobado_export_control;
$ExportCtrl->Export_barr();

class grid_jdp_planificacion_aprobado_export_control
{
