<?php
@session_start() ;
$_SESSION['scriptcase']['grid_hogar']['sc_process_barr'] = true;
require_once('../grid_hogar/index.php');
unset($_SESSION['scriptcase']['grid_hogar']['sc_process_barr']);
$ExportCtrl = new grid_hogar_export_control;
$ExportCtrl->Export_barr();

class grid_hogar_export_control
{
