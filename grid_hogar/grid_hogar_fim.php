...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["MealSint2_____grid_hogar"]))
   {
      unset($_SESSION['session_sec_aplicacao']["MealSint2_____grid_hogar"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_hogar'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_hogar']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_hogar']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_hogar']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_hogar']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_hogar']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_hogar']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_hogar']['embutida_filho'] as $ind => $sc_init)
          {
