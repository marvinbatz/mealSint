  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_objetivo_resultado" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_objetivo_resultado_form();
	}
...
?>
  ...
  // ---------- Validate nombre
  function do_ajax_form_objetivo_resultado_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_objetivo_resultado_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_objetivo_resultado_validate_nombre_cb);
  } // do_ajax_form_objetivo_resultado_validate_nombre

  function do_ajax_form_objetivo_resultado_validate_nombre_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_objetivo_resultado_validate_nombre_cb

  // ---------- Validate planmeal
  function do_ajax_form_objetivo_resultado_validate_planmeal()
  {
    var nomeCampo_planmeal = "planmeal";
    var var_planmeal = scAjaxGetFieldText(nomeCampo_planmeal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_objetivo_resultado_validate_planmeal(var_planmeal, var_script_case_init, do_ajax_form_objetivo_resultado_validate_planmeal_cb);
  } // do_ajax_form_objetivo_resultado_validate_planmeal

  function do_ajax_form_objetivo_resultado_validate_planmeal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_objetivo_resultado_validate_planmeal_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_objetivo_resultado_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_objetivo_resultado_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_objetivo_resultado_submit_form(var_nombre, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_objetivo_resultado_submit_form_cb);
  } // do_ajax_form_objetivo_resultado_submit_form

  function do_ajax_form_objetivo_resultado_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_objetivo_resultado_submit_form_cb_after_alert);
  } // do_ajax_form_objetivo_resultado_submit_form_cb
  function do_ajax_form_objetivo_resultado_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_objetivo_resultado_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_planmeal"] = "off";

  function do_ajax_form_objetivo_resultado_navigate_form()
  {
    perform_ajax_form_objetivo_resultado_navigate_form();
  }

  function perform_ajax_form_objetivo_resultado_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_planmeal"] = "on";
    x_ajax_form_objetivo_resultado_navigate_form(var_idobjetivo_resultado, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_objetivo_resultado_navigate_form_cb);
  } // do_ajax_form_objetivo_resultado_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_objetivo_resultado']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_objetivo_resultado_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_planmeal"] && "nmsc_iframe_liga_form_planmeal" != scMasterDetailIframe["nmsc_iframe_liga_form_planmeal"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_planmeal"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_planmeal').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_planmeal').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_planmeal').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_objetivo_resultado_navigate_form_cb_after_alert);
  } // do_ajax_form_objetivo_resultado_navigate_form_cb
  function do_ajax_form_objetivo_resultado_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_objetivo_resultado_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_objetivo_resultado_navigate_form_cb_after_alert
  function sc_hide_form_objetivo_resultado_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_planmeal"])
    {
      return true;
    }
    return false;
