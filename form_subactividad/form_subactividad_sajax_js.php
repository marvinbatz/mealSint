  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_subactividad" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_subactividad_form();
	}
...
?>
  ...
  // ---------- Validate codigo_
  function do_ajax_form_subactividad_validate_codigo_(iNumLinha)
  {
    var nomeCampo_codigo_ = "codigo_" + iNumLinha;
    var var_codigo_ = scAjaxGetFieldText(nomeCampo_codigo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_subactividad_validate_codigo_(var_codigo_, iNumLinha, var_script_case_init, do_ajax_form_subactividad_validate_codigo__cb);
  } // do_ajax_form_subactividad_validate_codigo_

  function do_ajax_form_subactividad_validate_codigo__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "codigo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "codigo_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "codigo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "codigo_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_subactividad_validate_codigo__cb

  // ---------- Validate nombre_
  function do_ajax_form_subactividad_validate_nombre_(iNumLinha)
  {
    var nomeCampo_nombre_ = "nombre_" + iNumLinha;
    var var_nombre_ = scAjaxGetFieldText(nomeCampo_nombre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_subactividad_validate_nombre_(var_nombre_, iNumLinha, var_script_case_init, do_ajax_form_subactividad_validate_nombre__cb);
  } // do_ajax_form_subactividad_validate_nombre_

  function do_ajax_form_subactividad_validate_nombre__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_subactividad_validate_nombre__cb

  // ---------- Validate descripcion_
  function do_ajax_form_subactividad_validate_descripcion_(iNumLinha)
  {
    var nomeCampo_descripcion_ = "descripcion_" + iNumLinha;
    var var_descripcion_ = scAjaxGetFieldText(nomeCampo_descripcion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_subactividad_validate_descripcion_(var_descripcion_, iNumLinha, var_script_case_init, do_ajax_form_subactividad_validate_descripcion__cb);
  } // do_ajax_form_subactividad_validate_descripcion_

  function do_ajax_form_subactividad_validate_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "descripcion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "descripcion_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "descripcion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "descripcion_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_subactividad_validate_descripcion__cb

  // ---------- Validate idsubactividad_
  function do_ajax_form_subactividad_validate_idsubactividad_(iNumLinha)
  {
    var nomeCampo_idsubactividad_ = "idsubactividad_" + iNumLinha;
    var var_idsubactividad_ = scAjaxGetFieldHidden(nomeCampo_idsubactividad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_subactividad_validate_idsubactividad_(var_idsubactividad_, iNumLinha, var_script_case_init, do_ajax_form_subactividad_validate_idsubactividad__cb);
  } // do_ajax_form_subactividad_validate_idsubactividad_

  function do_ajax_form_subactividad_validate_idsubactividad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idsubactividad_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idsubactividad_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idsubactividad_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idsubactividad_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_subactividad_validate_idsubactividad__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_subactividad_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_subactividad_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_subactividad_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_subactividad_add_new_line_cb);
  } // do_ajax_form_subactividad_add_new_line

  function do_ajax_form_subactividad_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_subactividad_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_subactividad_backup_line(iNumLinha)
  {
    var var_idsubactividad_ = scAjaxGetFieldHidden("idsubactividad_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_subactividad_backup_line(var_idsubactividad_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_subactividad_backup_line_cb);
  } // do_ajax_form_subactividad_backup_line

  function do_ajax_form_subactividad_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_subactividad_backup_line_cb

  function do_ajax_form_subactividad_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_subactividad_cancel_insert

  function do_ajax_form_subactividad_cancel_update(iSeqVert)
  {
    do_ajax_form_subactividad_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_subactividad_cancel_update

  function do_ajax_form_subactividad_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_subactividad_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_subactividad_table_refresh()
  {
    var var_idsubactividad_ = document.F2.idsubactividad_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_subactividad_table_refresh(var_idsubactividad_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_subactividad_table_refresh_cb);
  } //  do_ajax_form_subactividad_table_refresh

  function do_ajax_form_subactividad_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idsubactividad_.value = scAjaxGetKeyValue("idsubactividad_");
    ...
    scAjaxAlert(do_ajax_form_subactividad_table_refresh_cb_after_alert);
  } // do_ajax_form_subactividad_table_refresh_cb
  function do_ajax_form_subactividad_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_subactividad_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_subactividad_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_subactividad_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_codigo_ = scAjaxGetFieldText("codigo_" + iNumLinha);
    var var_nombre_ = scAjaxGetFieldText("nombre_" + iNumLinha);
    var var_descripcion_ = scAjaxGetFieldText("descripcion_" + iNumLinha);
    var var_idsubactividad_ = scAjaxGetFieldHidden("idsubactividad_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_subactividad_submit_form(var_codigo_, var_nombre_, var_descripcion_, var_idsubactividad_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_subactividad_submit_form_cb);
  } // do_ajax_form_subactividad_submit_form

  function do_ajax_form_subactividad_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("codigo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("nombre_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("descripcion_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("idsubactividad_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_subactividad_submit_form_cb_after_alert);
  } // do_ajax_form_subactividad_submit_form_cb
  function do_ajax_form_subactividad_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_subactividad_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_subactividad_navigate_form()
  {
    perform_ajax_form_subactividad_navigate_form();
  }

  function perform_ajax_form_subactividad_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_subactividad_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("codigo_" + iNavForm);
      scAjaxHideErrorDisplay("nombre_" + iNavForm);
      scAjaxHideErrorDisplay("descripcion_" + iNavForm);
      scAjaxHideErrorDisplay("idsubactividad_" + iNavForm);
    }
    var var_idsubactividad_ = document.F2.idsubactividad_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_subactividad_navigate_form(var_idsubactividad_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_subactividad_navigate_form_cb);
  } // do_ajax_form_subactividad_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_subactividad']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_subactividad_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idsubactividad_.value = scAjaxGetKeyValue("idsubactividad_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_subactividad_navigate_form_cb_after_alert);
  } // do_ajax_form_subactividad_navigate_form_cb
  function do_ajax_form_subactividad_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_subactividad_navigate_form_cb_after_alert
  function sc_hide_form_subactividad_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "codigo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "nombre_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "descripcion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idsubactividad_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["codigo_" + iNumLinha] = {"label": "Codigo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["descripcion_" + iNumLinha] = {"label": "Descripcion<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["idsubactividad_" + iNumLinha] = {"label": "Id Sub Actividad<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["codigo_"][iNumLinha] = "codigo_" + iNumLinha;
    ajax_field_mult["nombre_"][iNumLinha] = "nombre_" + iNumLinha;
    ajax_field_mult["descripcion_"][iNumLinha] = "descripcion_" + iNumLinha;
    ajax_field_mult["idsubactividad_"][iNumLinha] = "idsubactividad_" + iNumLinha;
    ajax_field_id["codigo_" + iNumLinha] = new Array("hidden_field_label_codigo_", "hidden_field_data_codigo_" + iNumLinha);
    ajax_field_id["nombre_" + iNumLinha] = new Array("hidden_field_label_nombre_", "hidden_field_data_nombre_" + iNumLinha);
    ajax_field_id["descripcion_" + iNumLinha] = new Array("hidden_field_label_descripcion_", "hidden_field_data_descripcion_" + iNumLinha);
    ajax_error_count["codigo_" + iNumLinha] = "off";
    ajax_error_count["nombre_" + iNumLinha] = "off";
    ajax_error_count["descripcion_" + iNumLinha] = "off";
    ajax_error_count["idsubactividad_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["codigo_" + iNumLinha] = "off";
    ajax_read_only["nombre_" + iNumLinha] = "off";
    ajax_read_only["descripcion_" + iNumLinha] = "off";
    ajax_read_only["idsubactividad_" + iNumLinha] = "on";
<?php
}
else
{
?>
    ajax_read_only["codigo_" + iNumLinha] = "on";
    ajax_read_only["nombre_" + iNumLinha] = "on";
    ajax_read_only["descripcion_" + iNumLinha] = "on";
    ajax_read_only["idsubactividad_" + iNumLinha] = "on";
<?php
}
?>
  ...
  {
    ajax_error_list["codigo_" + iNumLinha] = null;
    ajax_error_list["nombre_" + iNumLinha] = null;
    ajax_error_list["descripcion_" + iNumLinha] = null;
    ajax_error_list["idsubactividad_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "codigo_": new Array(),
    "nombre_": new Array(),
    "descripcion_": new Array(),
    "idsubactividad_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["codigo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["codigo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["codigo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["codigo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["codigo_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["descripcion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["descripcion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["descripcion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["descripcion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["descripcion_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["idsubactividad_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idsubactividad_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idsubactividad_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idsubactividad_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idsubactividad_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['codigo_'])) ? $this->nmgp_cmp_readonly['codigo_'] : 'off';
?>
    scAjaxFieldRead("codigo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['descripcion_'])) ? $this->nmgp_cmp_readonly['descripcion_'] : 'off';
?>
    scAjaxFieldRead("descripcion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idsubactividad_'])) ? $this->nmgp_cmp_readonly['idsubactividad_'] : 'on';
?>
    scAjaxFieldRead("idsubactividad_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("codigo_" + iSeq, "on");
    scAjaxFieldRead("nombre_" + iSeq, "on");
    scAjaxFieldRead("descripcion_" + iSeq, "on");
    scAjaxFieldRead("idsubactividad_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["codigo_" + iRow] || "on" == ajax_error_count["nombre_" + iRow] || "on" == ajax_error_count["descripcion_" + iRow] || "on" == ajax_error_count["idsubactividad_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_codigo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_nombre_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_descripcion_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idsubactividad_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["codigo_" + iRow] && "off" == ajax_error_count["nombre_" + iRow] && "off" == ajax_error_count["descripcion_" + iRow] && "off" == ajax_error_count["idsubactividad_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["codigo_" + iRow] = "off";
        ajax_error_count["nombre_" + iRow] = "off";
        ajax_error_count["descripcion_" + iRow] = "off";
        ajax_error_count["idsubactividad_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_codigo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_nombre_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_descripcion_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_idsubactividad_" + iRow).removeClass("scFormErrorLine");
    }
  }
