<?php
@session_start() ;
$_SESSION['scriptcase']['grid_actividad_enlace']['sc_process_barr'] = true;
require_once('../grid_actividad_enlace/index.php');
unset($_SESSION['scriptcase']['grid_actividad_enlace']['sc_process_barr']);
$ExportCtrl = new grid_actividad_enlace_export_control;
$ExportCtrl->Export_barr();

class grid_actividad_enlace_export_control
{
