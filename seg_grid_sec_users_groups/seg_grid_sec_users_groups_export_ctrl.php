<?php
@session_start() ;
$_SESSION['scriptcase']['seg_grid_sec_users_groups']['sc_process_barr'] = true;
require_once('../seg_grid_sec_users_groups/index.php');
unset($_SESSION['scriptcase']['seg_grid_sec_users_groups']['sc_process_barr']);
$ExportCtrl = new seg_grid_sec_users_groups_export_control;
$ExportCtrl->Export_barr();

class seg_grid_sec_users_groups_export_control
{
