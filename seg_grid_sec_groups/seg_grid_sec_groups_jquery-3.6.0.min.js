...
function ajax_navigate(opc, parm)
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_seg_grid_sec_groups').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_seg_grid_sec_groups').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_seg_grid_sec_groups').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_seg_grid_sec_groups').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_seg_grid_sec_groups').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_seg_grid_sec_groups').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_seg_grid_sec_groups').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_seg_grid_sec_groups').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_seg_grid_sec_groups').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_seg_grid_sec_groups').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_seg_grid_sec_groups').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_seg_grid_sec_groups').style.width  = '0px';
        if (oResp["setValue"]) {
