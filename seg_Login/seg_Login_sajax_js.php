...
?>
  ...
  // ---------- Validate links
  function do_ajax_seg_Login_validate_links()
  {
    var nomeCampo_links = "links";
    var var_links = scAjaxGetFieldText(nomeCampo_links);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seg_Login_validate_links(var_links, var_script_case_init, do_ajax_seg_Login_validate_links_cb);
  } // do_ajax_seg_Login_validate_links

  function do_ajax_seg_Login_validate_links_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "links";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seg_Login_validate_links_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  function do_ajax_seg_Login_submit_form()
  {
    ...
    x_ajax_seg_Login_submit_form(var_login, var_pswd, var_links, var_links_sc_target_name, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, var_bok, do_ajax_seg_Login_submit_form_cb);
...
?>
  ...
  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['dashboard_info']['parent_widget'] ?>";
...
{
?>
    do_ajax_seg_Login_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
