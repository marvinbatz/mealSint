...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_links' + iSeqRow).bind('blur', function() { sc_seg_Login_links_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_seg_Login_links_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_seg_Login_links_onfocus(this, iSeqRow) });
} // scJQEventsAdd
...
function sc_seg_Login_links_onblur(oThis, iSeqRow) {
...
function sc_seg_Login_links_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
