...
//----- 
   function ini_controle()
   {
      ...
      { 
          ...
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['initialize'])
          {
              $_SESSION['scriptcase']['seg_Login']['contr_erro'] = 'on';
  if (isset($_SESSION['scriptcase']['sc_apl_conf']['seg_form_add_users']))
{
unset($_SESSION['scriptcase']['sc_apl_conf']['seg_form_add_users']);
}
;
if (isset($_SESSION['scriptcase']['sc_apl_conf']['seg_retrieve_pswd']))
{
unset($_SESSION['scriptcase']['sc_apl_conf']['seg_retrieve_pswd']);
}
;
$_SESSION['scriptcase']['seg_Login']['contr_erro'] = 'off';
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['seg_Login']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['seg_Login']['label'] = "Login";
...
$_SESSION['scriptcase']['seg_Login']['contr_erro'] = 'off'; 
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['Gera_log_access'] = false;
      }
...
//
      ...
      if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "" || $campos_erro != "" || !isset($this->bok) || $this->bok != "OK" || $this->nmgp_opcao == "recarga")
      {
          if ($Campos_Crit == "" && empty($Campos_Falta) && $this->Campos_Mens_erro == "" && !isset($this->bok) && $this->nmgp_opcao != "recarga")
          {
              ...
              { 
                  $login = $_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['campos'][0]; 
                  $pswd = $_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['campos'][1]; 
                  $links = $_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['campos'][2]; 
              } 
          }
          $this->nm_gera_html();
          $this->NM_close_db(); 
      ...
      elseif (isset($this->bok) && $this->bok == "OK")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['campos'][0] = $this->login; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['campos'][1] = $this->pswd; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['campos'][2] = $this->links; 
          if (!empty($this->links))
          {
              ...
              else
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['redir_target_name'] = $this->links_sc_target_name;
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       $delim  = "'";
       $delim1 = "'";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['SC_sep_date1'];
       }
       $dt  = $delim . date('Y-m-d H:i:s') . $delim1;
       $usr = isset($_SESSION['usr_login']) ? $_SESSION['usr_login'] : "";
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'seg_Login', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'seg_Login', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'links' == $filtro)) || (is_array($filtro) && in_array('links', $filtro)))
...
;
	...
	if(count($this->rs ) == 0)
	{
		...
		$this->NM_gera_log_insert("User", 'login Fail',  $this->Ini->Nm_lang['lang_login_fail']  . $resource. "_".$user_id);
...
if (!isset($this->sc_temp_usr_login)) {$this->sc_temp_usr_login = (isset($_SESSION['usr_login'])) ? $_SESSION['usr_login'] : "";}
	...
	$sql = "INSERT INTO
			...
			VALUES 
				(". $this->Db->qstr($usr_id). ", ".
					$this->Db->qstr($name) . ", ".
					$this->Db->qstr(hash("sha256",date("YmdHis"))) . ", ".
...
;
	...
	if($this->sc_logged($this->login )):
        ...
        if (is_file($_SESSION['scriptcase']['dir_temp'] . "/sc_apl_default_MealSint2.txt")) {
    unlink($_SESSION['scriptcase']['dir_temp'] . "/sc_apl_default_MealSint2.txt");
}
if (is_file("../_lib/friendly_url/seg_Login_ini.txt")) {
    $SC_arq_def = fopen($_SESSION['scriptcase']['dir_temp'] . "/sc_apl_default_MealSint2.txt", "w");
    fwrite ($SC_arq_def, 'seg_Login, M');
    fclose ($SC_arq_def);
    setcookie('sc_apl_default_MealSint2','seg_Login, M','0','/');
}
;
		 if (isset($this->sc_temp_usr_login)) { $_SESSION['usr_login'] = $this->sc_temp_usr_login;}
 if (!isset($this->Campos_Mens_erro) || empty($this->Campos_Mens_erro))
...
<?php
    ...
    $_SESSION['scriptcase']['seg_Login']['contr_erro'] = 'on';
  $_SESSION['scriptcase']['sc_apl_conf']['seg_form_add_users']['start'] = 'new';
$_SESSION['scriptcase']['seg_Login']['contr_erro'] = 'off'; 
    }
    if (!empty($this->Campos_Mens_erro)) 
    {
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_seg_Login = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['total'] = $qt_geral_reg_seg_Login;
      $_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          seg_Login_pack_ajax_response();
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['empty_filter'] = true;
          $this->NM_ajax_info['empty_filter'] = 'ok';
          seg_Login_pack_ajax_response();
          exit;
      }
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['seg_Login']['ordem_ord'] == " desc") {
