...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["MealSint2_____grid_hogar_consulta"]))
   {
      unset($_SESSION['session_sec_aplicacao']["MealSint2_____grid_hogar_consulta"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_hogar_consulta']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_hogar_consulta']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_hogar_consulta']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_hogar_consulta']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_hogar_consulta']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_hogar_consulta</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_hogar_consulta']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_hogar_consulta']['embutida_filho'] as $ind => $sc_init)
          {
