<?php
@session_start() ;
$_SESSION['scriptcase']['grid_hogar_consulta']['sc_process_barr'] = true;
require_once('../grid_hogar_consulta/index.php');
unset($_SESSION['scriptcase']['grid_hogar_consulta']['sc_process_barr']);
$ExportCtrl = new grid_hogar_consulta_export_control;
$ExportCtrl->Export_barr();

class grid_hogar_consulta_export_control
{
