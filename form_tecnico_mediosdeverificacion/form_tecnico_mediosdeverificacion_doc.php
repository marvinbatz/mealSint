<?php
   ...
   include_once 'form_tecnico_mediosdeverificacion_doc_name.php';
   ...
   if ($nm_cod_doc == "documento_db")
   {
       ...
       $trab_doc = $root . $_SESSION['scriptcase']['form_tecnico_mediosdeverificacion']['glo_nm_path_imag_temp'] . "/" . $index_file;
       if (!$accessError && @is_file($root.trim($index_file)))
       {
           $trab_doc =$root.$index_file;
           $bChanged    = true;
       }
   }else{
       $index_file = trim($nm_nome_doc);
       if (isset($_SESSION['sc_session'][$script_case_init][$nm_cod_apl]['download_filenames'][$index_file]))
       {
           $nm_nome_doc = $_SESSION['sc_session'][$script_case_init][$nm_cod_apl]['download_filenames'][$index_file];
       }
       ...
       if ($bChanged && isset($_SESSION['sc_session'][$script_case_init][$nm_cod_apl]['download_filenames'][$index_file]))
       {
           $nm_nome_doc = $_SESSION['sc_session'][$script_case_init][$nm_cod_apl]['download_filenames'][$index_file];
       }
   }
