...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "fechaDeIngreso";$Nm_datas[] = "fechaDeIngreso";$Nm_numeric[] = "idbeneficionoaplica";$Nm_numeric[] = "valor";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_valor_cond" name="valor_cond" onChange="nm_campos_between(document.getElementById('id_vis_valor'), this, 'valor')">
      ...
      <br><span id="id_hide_valor"  <?php echo $str_hide_valor?>><INPUT  type="text" id="SC_valor" name="valor" value="<?php echo NM_encode_input($valor) ?>" size=1 alt="{datatype: 'integer', maxLength: 1, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_detalles_cond" name="detalles_cond" onChange="nm_campos_between(document.getElementById('id_vis_detalles'), this, 'detalles')">
      ...
      <br><span id="id_hide_detalles"  <?php echo $str_hide_detalles?>><INPUT  type="text" id="SC_detalles" name="detalles" value="<?php echo NM_encode_input($detalles) ?>"  size=50 alt="{datatype: 'text', maxLength: 250, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
