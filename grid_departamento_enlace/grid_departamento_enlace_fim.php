...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["MealSint2_____grid_departamento_enlace"]))
   {
      unset($_SESSION['session_sec_aplicacao']["MealSint2_____grid_departamento_enlace"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_departamento_enlace']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_departamento_enlace']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_departamento_enlace']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_departamento_enlace']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_departamento_enlace']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_departamento_enlace</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_departamento_enlace']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_departamento_enlace']['embutida_filho'] as $ind => $sc_init)
          {
