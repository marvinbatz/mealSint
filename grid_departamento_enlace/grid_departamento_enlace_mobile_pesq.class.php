...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "d_iddepartamento";$Nm_numeric[] = "d_lat";$Nm_numeric[] = "d_lon";$Nm_numeric[] = "d_iddepartamento";$Nm_numeric[] = "d_lat";$Nm_numeric[] = "d_lon";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_d_coddepartamento_cond" name="d_coddepartamento_cond" onChange="nm_campos_between(document.getElementById('id_vis_d_coddepartamento'), this, 'd_coddepartamento')">
      ...
      <br><span id="id_hide_d_coddepartamento"  <?php echo $str_hide_d_coddepartamento?>><?php
