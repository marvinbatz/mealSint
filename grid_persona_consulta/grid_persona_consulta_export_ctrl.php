<?php
@session_start() ;
$_SESSION['scriptcase']['grid_persona_consulta']['sc_process_barr'] = true;
require_once('../grid_persona_consulta/index.php');
unset($_SESSION['scriptcase']['grid_persona_consulta']['sc_process_barr']);
$ExportCtrl = new grid_persona_consulta_export_control;
$ExportCtrl->Export_barr();

class grid_persona_consulta_export_control
{
