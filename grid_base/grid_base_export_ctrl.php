<?php
@session_start() ;
$_SESSION['scriptcase']['grid_base']['sc_process_barr'] = true;
require_once('../grid_base/index.php');
unset($_SESSION['scriptcase']['grid_base']['sc_process_barr']);
$ExportCtrl = new grid_base_export_control;
$ExportCtrl->Export_barr();

class grid_base_export_control
{
