<?php
@session_start() ;
$_SESSION['scriptcase']['grid_programa']['sc_process_barr'] = true;
require_once('../grid_programa/index.php');
unset($_SESSION['scriptcase']['grid_programa']['sc_process_barr']);
$ExportCtrl = new grid_programa_export_control;
$ExportCtrl->Export_barr();

class grid_programa_export_control
{
