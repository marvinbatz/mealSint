  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_comunidad" == sTestField)
        {
...
?>
  ...
  // ---------- Validate nombre_
  function do_ajax_form_comunidad_validate_nombre_(iNumLinha)
  {
    var nomeCampo_nombre_ = "nombre_" + iNumLinha;
    var var_nombre_ = scAjaxGetFieldText(nomeCampo_nombre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_comunidad_validate_nombre_(var_nombre_, iNumLinha, var_script_case_init, do_ajax_form_comunidad_validate_nombre__cb);
  } // do_ajax_form_comunidad_validate_nombre_

  function do_ajax_form_comunidad_validate_nombre__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "nombre_" + iLineNumber;
    }
    else
    {
      sFieldValid = "nombre_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "nombre_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "nombre_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_comunidad_validate_nombre__cb

  // ---------- Validate codcomunidad_
  function do_ajax_form_comunidad_validate_codcomunidad_(iNumLinha)
  {
    var nomeCampo_codcomunidad_ = "codcomunidad_" + iNumLinha;
    var var_codcomunidad_ = scAjaxGetFieldText(nomeCampo_codcomunidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_comunidad_validate_codcomunidad_(var_codcomunidad_, iNumLinha, var_script_case_init, do_ajax_form_comunidad_validate_codcomunidad__cb);
  } // do_ajax_form_comunidad_validate_codcomunidad_

  function do_ajax_form_comunidad_validate_codcomunidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "codcomunidad_" + iLineNumber;
    }
    else
    {
      sFieldValid = "codcomunidad_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "codcomunidad_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "codcomunidad_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_comunidad_validate_codcomunidad__cb

  // ---------- Validate lat_
  function do_ajax_form_comunidad_validate_lat_(iNumLinha)
  {
    var nomeCampo_lat_ = "lat_" + iNumLinha;
    var var_lat_ = scAjaxGetFieldText(nomeCampo_lat_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_comunidad_validate_lat_(var_lat_, iNumLinha, var_script_case_init, do_ajax_form_comunidad_validate_lat__cb);
  } // do_ajax_form_comunidad_validate_lat_

  function do_ajax_form_comunidad_validate_lat__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "lat_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "lat_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_comunidad_validate_lat__cb

  // ---------- Validate long_
  function do_ajax_form_comunidad_validate_long_(iNumLinha)
  {
    var nomeCampo_long_ = "long_" + iNumLinha;
    var var_long_ = scAjaxGetFieldText(nomeCampo_long_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_comunidad_validate_long_(var_long_, iNumLinha, var_script_case_init, do_ajax_form_comunidad_validate_long__cb);
  } // do_ajax_form_comunidad_validate_long_

  function do_ajax_form_comunidad_validate_long__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "long_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "long_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_comunidad_validate_long__cb

  // ---------- Validate idcomunidad_
  function do_ajax_form_comunidad_validate_idcomunidad_(iNumLinha)
  {
    var nomeCampo_idcomunidad_ = "idcomunidad_" + iNumLinha;
    var var_idcomunidad_ = scAjaxGetFieldHidden(nomeCampo_idcomunidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_comunidad_validate_idcomunidad_(var_idcomunidad_, iNumLinha, var_script_case_init, do_ajax_form_comunidad_validate_idcomunidad__cb);
  } // do_ajax_form_comunidad_validate_idcomunidad_

  function do_ajax_form_comunidad_validate_idcomunidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idcomunidad_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idcomunidad_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idcomunidad_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idcomunidad_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_comunidad_validate_idcomunidad__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_comunidad_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_comunidad_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_comunidad_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_comunidad_add_new_line_cb);
  } // do_ajax_form_comunidad_add_new_line

  function do_ajax_form_comunidad_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_comunidad_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_comunidad_backup_line(iNumLinha)
  {
    var var_idcomunidad_ = scAjaxGetFieldHidden("idcomunidad_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_comunidad_backup_line(var_idcomunidad_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_comunidad_backup_line_cb);
  } // do_ajax_form_comunidad_backup_line

  function do_ajax_form_comunidad_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_comunidad_backup_line_cb

  function do_ajax_form_comunidad_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_comunidad_cancel_insert

  function do_ajax_form_comunidad_cancel_update(iSeqVert)
  {
    do_ajax_form_comunidad_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_comunidad_cancel_update

  function do_ajax_form_comunidad_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_comunidad_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_comunidad_table_refresh()
  {
    var var_idcomunidad_ = document.F2.idcomunidad_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_comunidad_table_refresh(var_idcomunidad_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_comunidad_table_refresh_cb);
  } //  do_ajax_form_comunidad_table_refresh

  function do_ajax_form_comunidad_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idcomunidad_.value = scAjaxGetKeyValue("idcomunidad_");
    ...
    scAjaxAlert(do_ajax_form_comunidad_table_refresh_cb_after_alert);
  } // do_ajax_form_comunidad_table_refresh_cb
  function do_ajax_form_comunidad_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_comunidad_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_comunidad_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_comunidad_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_nombre_ = scAjaxGetFieldText("nombre_" + iNumLinha);
    var var_codcomunidad_ = scAjaxGetFieldText("codcomunidad_" + iNumLinha);
    var var_lat_ = scAjaxGetFieldText("lat_" + iNumLinha);
    var var_long_ = scAjaxGetFieldText("long_" + iNumLinha);
    var var_idcomunidad_ = scAjaxGetFieldHidden("idcomunidad_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_comunidad_submit_form(var_nombre_, var_codcomunidad_, var_lat_, var_long_, var_idcomunidad_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_comunidad_submit_form_cb);
  } // do_ajax_form_comunidad_submit_form

  function do_ajax_form_comunidad_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("nombre_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("codcomunidad_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("lat_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("long_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("idcomunidad_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_comunidad_submit_form_cb_after_alert);
  } // do_ajax_form_comunidad_submit_form_cb
  function do_ajax_form_comunidad_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_comunidad_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_comunidad_navigate_form()
  {
    perform_ajax_form_comunidad_navigate_form();
  }

  function perform_ajax_form_comunidad_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_comunidad_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("nombre_" + iNavForm);
      scAjaxHideErrorDisplay("codcomunidad_" + iNavForm);
      scAjaxHideErrorDisplay("lat_" + iNavForm);
      scAjaxHideErrorDisplay("long_" + iNavForm);
      scAjaxHideErrorDisplay("idcomunidad_" + iNavForm);
    }
    var var_idcomunidad_ = document.F2.idcomunidad_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_comunidad_navigate_form(var_idcomunidad_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_comunidad_navigate_form_cb);
  } // do_ajax_form_comunidad_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_comunidad']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_comunidad_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idcomunidad_.value = scAjaxGetKeyValue("idcomunidad_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_comunidad_navigate_form_cb_after_alert);
  } // do_ajax_form_comunidad_navigate_form_cb
  function do_ajax_form_comunidad_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_comunidad_navigate_form_cb_after_alert
  function sc_hide_form_comunidad_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "nombre_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "codcomunidad_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "lat_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "long_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idcomunidad_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["nombre_" + iNumLinha] = {"label": "Nombre<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["codcomunidad_" + iNumLinha] = {"label": "Cod Comunidad<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["lat_" + iNumLinha] = {"label": "Latitud<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["long_" + iNumLinha] = {"label": "Longitud<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["idcomunidad_" + iNumLinha] = {"label": "Id Comunidad<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["nombre_"][iNumLinha] = "nombre_" + iNumLinha;
    ajax_field_mult["codcomunidad_"][iNumLinha] = "codcomunidad_" + iNumLinha;
    ajax_field_mult["lat_"][iNumLinha] = "lat_" + iNumLinha;
    ajax_field_mult["long_"][iNumLinha] = "long_" + iNumLinha;
    ajax_field_mult["idcomunidad_"][iNumLinha] = "idcomunidad_" + iNumLinha;
    ajax_field_id["nombre_" + iNumLinha] = new Array("hidden_field_label_nombre_", "hidden_field_data_nombre_" + iNumLinha);
    ajax_field_id["codcomunidad_" + iNumLinha] = new Array("hidden_field_label_codcomunidad_", "hidden_field_data_codcomunidad_" + iNumLinha);
    ajax_field_id["lat_" + iNumLinha] = new Array("hidden_field_label_lat_", "hidden_field_data_lat_" + iNumLinha);
    ajax_field_id["long_" + iNumLinha] = new Array("hidden_field_label_long_", "hidden_field_data_long_" + iNumLinha);
    ajax_error_count["nombre_" + iNumLinha] = "off";
    ajax_error_count["codcomunidad_" + iNumLinha] = "off";
    ajax_error_count["lat_" + iNumLinha] = "off";
    ajax_error_count["long_" + iNumLinha] = "off";
    ajax_error_count["idcomunidad_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["nombre_" + iNumLinha] = "off";
    ajax_read_only["codcomunidad_" + iNumLinha] = "off";
    ajax_read_only["lat_" + iNumLinha] = "off";
    ajax_read_only["long_" + iNumLinha] = "off";
    ajax_read_only["idcomunidad_" + iNumLinha] = "on";
<?php
}
else
{
?>
    ajax_read_only["nombre_" + iNumLinha] = "on";
    ajax_read_only["codcomunidad_" + iNumLinha] = "on";
    ajax_read_only["lat_" + iNumLinha] = "on";
    ajax_read_only["long_" + iNumLinha] = "on";
    ajax_read_only["idcomunidad_" + iNumLinha] = "on";
<?php
}
?>
  ...
  {
    ajax_error_list["nombre_" + iNumLinha] = null;
    ajax_error_list["codcomunidad_" + iNumLinha] = null;
    ajax_error_list["lat_" + iNumLinha] = null;
    ajax_error_list["long_" + iNumLinha] = null;
    ajax_error_list["idcomunidad_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "nombre_": new Array(),
    "codcomunidad_": new Array(),
    "lat_": new Array(),
    "long_": new Array(),
    "idcomunidad_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["nombre_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["nombre_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["nombre_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["nombre_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["nombre_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["codcomunidad_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["codcomunidad_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["codcomunidad_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["codcomunidad_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["codcomunidad_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["lat_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["lat_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["lat_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["lat_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["lat_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["long_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["long_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["long_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["long_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["long_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["idcomunidad_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idcomunidad_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idcomunidad_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idcomunidad_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idcomunidad_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['nombre_'])) ? $this->nmgp_cmp_readonly['nombre_'] : 'off';
?>
    scAjaxFieldRead("nombre_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['codcomunidad_'])) ? $this->nmgp_cmp_readonly['codcomunidad_'] : 'off';
?>
    scAjaxFieldRead("codcomunidad_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['lat_'])) ? $this->nmgp_cmp_readonly['lat_'] : 'off';
?>
    scAjaxFieldRead("lat_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['long_'])) ? $this->nmgp_cmp_readonly['long_'] : 'off';
?>
    scAjaxFieldRead("long_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idcomunidad_'])) ? $this->nmgp_cmp_readonly['idcomunidad_'] : 'on';
?>
    scAjaxFieldRead("idcomunidad_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("nombre_" + iSeq, "on");
    scAjaxFieldRead("codcomunidad_" + iSeq, "on");
    scAjaxFieldRead("lat_" + iSeq, "on");
    scAjaxFieldRead("long_" + iSeq, "on");
    scAjaxFieldRead("idcomunidad_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["nombre_" + iRow] || "on" == ajax_error_count["codcomunidad_" + iRow] || "on" == ajax_error_count["lat_" + iRow] || "on" == ajax_error_count["long_" + iRow] || "on" == ajax_error_count["idcomunidad_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_nombre_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_codcomunidad_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_lat_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_long_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idcomunidad_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["nombre_" + iRow] && "off" == ajax_error_count["codcomunidad_" + iRow] && "off" == ajax_error_count["lat_" + iRow] && "off" == ajax_error_count["long_" + iRow] && "off" == ajax_error_count["idcomunidad_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["nombre_" + iRow] = "off";
        ajax_error_count["codcomunidad_" + iRow] = "off";
        ajax_error_count["lat_" + iRow] = "off";
        ajax_error_count["long_" + iRow] = "off";
        ajax_error_count["idcomunidad_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_nombre_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_codcomunidad_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_lat_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_long_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_idcomunidad_" + iRow).removeClass("scFormErrorLine");
    }
  }
