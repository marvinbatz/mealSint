<?php
@session_start() ;
$_SESSION['scriptcase']['grid_aportedonante']['sc_process_barr'] = true;
require_once('../grid_aportedonante/index.php');
unset($_SESSION['scriptcase']['grid_aportedonante']['sc_process_barr']);
$ExportCtrl = new grid_aportedonante_export_control;
$ExportCtrl->Export_barr();

class grid_aportedonante_export_control
{
