<?php
@session_start() ;
$_SESSION['scriptcase']['grid_jdp_beneficiohogar']['sc_process_barr'] = true;
require_once('../grid_jdp_beneficiohogar/index.php');
unset($_SESSION['scriptcase']['grid_jdp_beneficiohogar']['sc_process_barr']);
$ExportCtrl = new grid_jdp_beneficiohogar_export_control;
$ExportCtrl->Export_barr();

class grid_jdp_beneficiohogar_export_control
{
