  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_seg_form_sec_groups_apps" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_seg_form_sec_groups_apps_form();
	}
...
?>
  ...
  // ---------- Validate app_name_
  function do_ajax_seg_form_sec_groups_apps_validate_app_name_(iNumLinha)
  {
  } // do_ajax_seg_form_sec_groups_apps_validate_app_name_

  function do_ajax_seg_form_sec_groups_apps_validate_app_name__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "app_name_" + iLineNumber;
    }
    else
    {
      sFieldValid = "app_name_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "app_name_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "app_name_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seg_form_sec_groups_apps_validate_app_name__cb

  // ---------- Validate priv_access_
  function do_ajax_seg_form_sec_groups_apps_validate_priv_access_(iNumLinha)
  {
    var nomeCampo_priv_access_ = "priv_access_" + iNumLinha;
    var var_priv_access_ = scAjaxGetFieldCheckbox(nomeCampo_priv_access_, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seg_form_sec_groups_apps_validate_priv_access_(var_priv_access_, iNumLinha, var_script_case_init, do_ajax_seg_form_sec_groups_apps_validate_priv_access__cb);
  } // do_ajax_seg_form_sec_groups_apps_validate_priv_access_

  function do_ajax_seg_form_sec_groups_apps_validate_priv_access__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "priv_access_" + iLineNumber;
    }
    else
    {
      sFieldValid = "priv_access_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "priv_access_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "priv_access_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seg_form_sec_groups_apps_validate_priv_access__cb

  // ---------- Validate priv_insert_
  function do_ajax_seg_form_sec_groups_apps_validate_priv_insert_(iNumLinha)
  {
    var nomeCampo_priv_insert_ = "priv_insert_" + iNumLinha;
    var var_priv_insert_ = scAjaxGetFieldCheckbox(nomeCampo_priv_insert_, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seg_form_sec_groups_apps_validate_priv_insert_(var_priv_insert_, iNumLinha, var_script_case_init, do_ajax_seg_form_sec_groups_apps_validate_priv_insert__cb);
  } // do_ajax_seg_form_sec_groups_apps_validate_priv_insert_

  function do_ajax_seg_form_sec_groups_apps_validate_priv_insert__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "priv_insert_" + iLineNumber;
    }
    else
    {
      sFieldValid = "priv_insert_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "priv_insert_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "priv_insert_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seg_form_sec_groups_apps_validate_priv_insert__cb

  // ---------- Validate priv_delete_
  function do_ajax_seg_form_sec_groups_apps_validate_priv_delete_(iNumLinha)
  {
    var nomeCampo_priv_delete_ = "priv_delete_" + iNumLinha;
    var var_priv_delete_ = scAjaxGetFieldCheckbox(nomeCampo_priv_delete_, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seg_form_sec_groups_apps_validate_priv_delete_(var_priv_delete_, iNumLinha, var_script_case_init, do_ajax_seg_form_sec_groups_apps_validate_priv_delete__cb);
  } // do_ajax_seg_form_sec_groups_apps_validate_priv_delete_

  function do_ajax_seg_form_sec_groups_apps_validate_priv_delete__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "priv_delete_" + iLineNumber;
    }
    else
    {
      sFieldValid = "priv_delete_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "priv_delete_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "priv_delete_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seg_form_sec_groups_apps_validate_priv_delete__cb

  // ---------- Validate priv_update_
  function do_ajax_seg_form_sec_groups_apps_validate_priv_update_(iNumLinha)
  {
    var nomeCampo_priv_update_ = "priv_update_" + iNumLinha;
    var var_priv_update_ = scAjaxGetFieldCheckbox(nomeCampo_priv_update_, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seg_form_sec_groups_apps_validate_priv_update_(var_priv_update_, iNumLinha, var_script_case_init, do_ajax_seg_form_sec_groups_apps_validate_priv_update__cb);
  } // do_ajax_seg_form_sec_groups_apps_validate_priv_update_

  function do_ajax_seg_form_sec_groups_apps_validate_priv_update__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "priv_update_" + iLineNumber;
    }
    else
    {
      sFieldValid = "priv_update_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "priv_update_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "priv_update_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seg_form_sec_groups_apps_validate_priv_update__cb

  // ---------- Validate priv_export_
  function do_ajax_seg_form_sec_groups_apps_validate_priv_export_(iNumLinha)
  {
    var nomeCampo_priv_export_ = "priv_export_" + iNumLinha;
    var var_priv_export_ = scAjaxGetFieldCheckbox(nomeCampo_priv_export_, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seg_form_sec_groups_apps_validate_priv_export_(var_priv_export_, iNumLinha, var_script_case_init, do_ajax_seg_form_sec_groups_apps_validate_priv_export__cb);
  } // do_ajax_seg_form_sec_groups_apps_validate_priv_export_

  function do_ajax_seg_form_sec_groups_apps_validate_priv_export__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "priv_export_" + iLineNumber;
    }
    else
    {
      sFieldValid = "priv_export_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "priv_export_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "priv_export_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seg_form_sec_groups_apps_validate_priv_export__cb

  // ---------- Validate priv_print_
  function do_ajax_seg_form_sec_groups_apps_validate_priv_print_(iNumLinha)
  {
    var nomeCampo_priv_print_ = "priv_print_" + iNumLinha;
    var var_priv_print_ = scAjaxGetFieldCheckbox(nomeCampo_priv_print_, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seg_form_sec_groups_apps_validate_priv_print_(var_priv_print_, iNumLinha, var_script_case_init, do_ajax_seg_form_sec_groups_apps_validate_priv_print__cb);
  } // do_ajax_seg_form_sec_groups_apps_validate_priv_print_

  function do_ajax_seg_form_sec_groups_apps_validate_priv_print__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "priv_print_" + iLineNumber;
    }
    else
    {
      sFieldValid = "priv_print_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "priv_print_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "priv_print_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seg_form_sec_groups_apps_validate_priv_print__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_seg_form_sec_groups_apps_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_seg_form_sec_groups_apps_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_seg_form_sec_groups_apps_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_seg_form_sec_groups_apps_add_new_line_cb);
  } // do_ajax_seg_form_sec_groups_apps_add_new_line

  function do_ajax_seg_form_sec_groups_apps_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_seg_form_sec_groups_apps_add_new_line_cb

  // ---------- backup_line
  function do_ajax_seg_form_sec_groups_apps_backup_line(iNumLinha)
  {
    var var_group_id_ = scAjaxGetFieldText("group_id_" + iNumLinha);
    var var_app_name_ = scAjaxGetFieldHidden("app_name_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seg_form_sec_groups_apps_backup_line(var_group_id_, var_app_name_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_seg_form_sec_groups_apps_backup_line_cb);
  } // do_ajax_seg_form_sec_groups_apps_backup_line

  function do_ajax_seg_form_sec_groups_apps_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_seg_form_sec_groups_apps_backup_line_cb

  function do_ajax_seg_form_sec_groups_apps_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_seg_form_sec_groups_apps_cancel_insert

  function do_ajax_seg_form_sec_groups_apps_cancel_update(iSeqVert)
  {
    do_ajax_seg_form_sec_groups_apps_backup_line(iSeqVert);
...
?>
  } // do_ajax_seg_form_sec_groups_apps_cancel_update

  function do_ajax_seg_form_sec_groups_apps_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_seg_form_sec_groups_apps_restore_buttons

  // ---------- table_refresh
  function do_ajax_seg_form_sec_groups_apps_table_refresh()
  {
    var var_group_id_ = document.F2.group_id_.value;
    var var_app_name_ = document.F2.app_name_.value;
    ...
    scAjaxProcOn();
    x_ajax_seg_form_sec_groups_apps_table_refresh(var_group_id_, var_app_name_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_seg_form_sec_groups_apps_table_refresh_cb);
  } //  do_ajax_seg_form_sec_groups_apps_table_refresh

  function do_ajax_seg_form_sec_groups_apps_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.group_id_.value = scAjaxGetKeyValue("group_id_");
    document.F2.app_name_.value = scAjaxGetKeyValue("app_name_");
    ...
    scAjaxAlert(do_ajax_seg_form_sec_groups_apps_table_refresh_cb_after_alert);
  } // do_ajax_seg_form_sec_groups_apps_table_refresh_cb
  function do_ajax_seg_form_sec_groups_apps_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_seg_form_sec_groups_apps_table_refresh_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_seg_form_sec_groups_apps_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_seg_form_sec_groups_apps_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_app_name_ = scAjaxGetFieldHidden("app_name_" + iNumLinha);
    var var_priv_access_ = scAjaxGetFieldCheckbox("priv_access_" + iNumLinha, ";");
    var var_priv_insert_ = scAjaxGetFieldCheckbox("priv_insert_" + iNumLinha, ";");
    var var_priv_delete_ = scAjaxGetFieldCheckbox("priv_delete_" + iNumLinha, ";");
    var var_priv_update_ = scAjaxGetFieldCheckbox("priv_update_" + iNumLinha, ";");
    var var_priv_export_ = scAjaxGetFieldCheckbox("priv_export_" + iNumLinha, ";");
    var var_priv_print_ = scAjaxGetFieldCheckbox("priv_print_" + iNumLinha, ";");
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_seg_form_sec_groups_apps_submit_form(var_app_name_, var_priv_access_, var_priv_insert_, var_priv_delete_, var_priv_update_, var_priv_export_, var_priv_print_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_seg_form_sec_groups_apps_submit_form_cb);
  } // do_ajax_seg_form_sec_groups_apps_submit_form

  function do_ajax_seg_form_sec_groups_apps_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("app_name_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("priv_access_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("priv_insert_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("priv_delete_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("priv_update_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("priv_export_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("priv_print_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_seg_form_sec_groups_apps_submit_form_cb_after_alert);
  } // do_ajax_seg_form_sec_groups_apps_submit_form_cb
  function do_ajax_seg_form_sec_groups_apps_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_seg_form_sec_groups_apps_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_seg_form_sec_groups_apps_navigate_form()
  {
    perform_ajax_seg_form_sec_groups_apps_navigate_form();
  }

  function perform_ajax_seg_form_sec_groups_apps_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    {
      scAjaxHideErrorDisplay("app_name_" + iNavForm);
      scAjaxHideErrorDisplay("priv_access_" + iNavForm);
      scAjaxHideErrorDisplay("priv_insert_" + iNavForm);
      scAjaxHideErrorDisplay("priv_delete_" + iNavForm);
      scAjaxHideErrorDisplay("priv_update_" + iNavForm);
      scAjaxHideErrorDisplay("priv_export_" + iNavForm);
      scAjaxHideErrorDisplay("priv_print_" + iNavForm);
    }
    var var_group_id_ = document.F2.group_id_.value;
    var var_app_name_ = document.F2.app_name_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_seg_form_sec_groups_apps_navigate_form(var_group_id_, var_app_name_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_seg_form_sec_groups_apps_navigate_form_cb);
  } // do_ajax_seg_form_sec_groups_apps_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_sec_groups_apps']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_seg_form_sec_groups_apps_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxClearErrors()
    scResetFormChanges()
    $(".sc-ui-checkbox-all-all").prop("checked", false);
    $(".sc-ui-checkbox-record-all").prop("checked", false);
    $("#sc-ui-checkbox-priv_access_-control").prop("checked", false);
    $("#sc-ui-checkbox-priv_insert_-control").prop("checked", false);
    $("#sc-ui-checkbox-priv_delete_-control").prop("checked", false);
    $("#sc-ui-checkbox-priv_update_-control").prop("checked", false);
    $("#sc-ui-checkbox-priv_export_-control").prop("checked", false);
    $("#sc-ui-checkbox-priv_print_-control").prop("checked", false);
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.group_id_.value = scAjaxGetKeyValue("group_id_" + var_last_index);
    document.F2.app_name_.value = scAjaxGetKeyValue("app_name_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_seg_form_sec_groups_apps_navigate_form_cb_after_alert);
  } // do_ajax_seg_form_sec_groups_apps_navigate_form_cb
  function do_ajax_seg_form_sec_groups_apps_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_seg_form_sec_groups_apps_navigate_form_cb_after_alert
  function sc_hide_seg_form_sec_groups_apps_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "app_name_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "priv_access_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "priv_insert_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "priv_delete_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "priv_update_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "priv_export_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "priv_print_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["app_name_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_app_name'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["priv_access_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_priv_access'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["priv_insert_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_priv_insert'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["priv_delete_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_priv_delete'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["priv_update_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_priv_update'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["priv_export_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_priv_export'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["priv_print_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_priv_print'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["app_name_"][iNumLinha] = "app_name_" + iNumLinha;
    ajax_field_mult["priv_access_"][iNumLinha] = "priv_access_" + iNumLinha;
    ajax_field_mult["priv_insert_"][iNumLinha] = "priv_insert_" + iNumLinha;
    ajax_field_mult["priv_delete_"][iNumLinha] = "priv_delete_" + iNumLinha;
    ajax_field_mult["priv_update_"][iNumLinha] = "priv_update_" + iNumLinha;
    ajax_field_mult["priv_export_"][iNumLinha] = "priv_export_" + iNumLinha;
    ajax_field_mult["priv_print_"][iNumLinha] = "priv_print_" + iNumLinha;
    ajax_field_id["app_name_" + iNumLinha] = new Array("hidden_field_label_app_name_", "hidden_field_data_app_name_" + iNumLinha);
    ajax_field_id["priv_access_" + iNumLinha] = new Array("hidden_field_label_priv_access_", "hidden_field_data_priv_access_" + iNumLinha);
    ajax_field_id["priv_insert_" + iNumLinha] = new Array("hidden_field_label_priv_insert_", "hidden_field_data_priv_insert_" + iNumLinha);
    ajax_field_id["priv_delete_" + iNumLinha] = new Array("hidden_field_label_priv_delete_", "hidden_field_data_priv_delete_" + iNumLinha);
    ajax_field_id["priv_update_" + iNumLinha] = new Array("hidden_field_label_priv_update_", "hidden_field_data_priv_update_" + iNumLinha);
    ajax_field_id["priv_export_" + iNumLinha] = new Array("hidden_field_label_priv_export_", "hidden_field_data_priv_export_" + iNumLinha);
    ajax_field_id["priv_print_" + iNumLinha] = new Array("hidden_field_label_priv_print_", "hidden_field_data_priv_print_" + iNumLinha);
    ajax_error_count["app_name_" + iNumLinha] = "off";
    ajax_error_count["priv_access_" + iNumLinha] = "off";
    ajax_error_count["priv_insert_" + iNumLinha] = "off";
    ajax_error_count["priv_delete_" + iNumLinha] = "off";
    ajax_error_count["priv_update_" + iNumLinha] = "off";
    ajax_error_count["priv_export_" + iNumLinha] = "off";
    ajax_error_count["priv_print_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["app_name_" + iNumLinha] = "off";
    ajax_read_only["priv_access_" + iNumLinha] = "off";
    ajax_read_only["priv_insert_" + iNumLinha] = "off";
    ajax_read_only["priv_delete_" + iNumLinha] = "off";
    ajax_read_only["priv_update_" + iNumLinha] = "off";
    ajax_read_only["priv_export_" + iNumLinha] = "off";
    ajax_read_only["priv_print_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["app_name_" + iNumLinha] = "on";
    ajax_read_only["priv_access_" + iNumLinha] = "on";
    ajax_read_only["priv_insert_" + iNumLinha] = "on";
    ajax_read_only["priv_delete_" + iNumLinha] = "on";
    ajax_read_only["priv_update_" + iNumLinha] = "on";
    ajax_read_only["priv_export_" + iNumLinha] = "on";
    ajax_read_only["priv_print_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["app_name_" + iNumLinha] = null;
    ajax_error_list["priv_access_" + iNumLinha] = null;
    ajax_error_list["priv_insert_" + iNumLinha] = null;
    ajax_error_list["priv_delete_" + iNumLinha] = null;
    ajax_error_list["priv_update_" + iNumLinha] = null;
    ajax_error_list["priv_export_" + iNumLinha] = null;
    ajax_error_list["priv_print_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "app_name_": new Array(),
    "priv_access_": new Array(),
    "priv_insert_": new Array(),
    "priv_delete_": new Array(),
    "priv_update_": new Array(),
    "priv_export_": new Array(),
    "priv_print_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["app_name_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["app_name_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["app_name_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["app_name_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["app_name_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["priv_access_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["priv_access_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["priv_access_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["priv_access_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["priv_access_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["priv_insert_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["priv_insert_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["priv_insert_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["priv_insert_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["priv_insert_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["priv_delete_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["priv_delete_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["priv_delete_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["priv_delete_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["priv_delete_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["priv_update_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["priv_update_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["priv_update_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["priv_update_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["priv_update_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["priv_export_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["priv_export_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["priv_export_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["priv_export_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["priv_export_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["priv_print_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["priv_print_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["priv_print_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["priv_print_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["priv_print_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['app_name_'])) ? $this->nmgp_cmp_readonly['app_name_'] : 'off';
?>
    scAjaxFieldRead("app_name_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['priv_access_'])) ? $this->nmgp_cmp_readonly['priv_access_'] : 'off';
?>
    scAjaxFieldRead("priv_access_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['priv_insert_'])) ? $this->nmgp_cmp_readonly['priv_insert_'] : 'off';
?>
    scAjaxFieldRead("priv_insert_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['priv_delete_'])) ? $this->nmgp_cmp_readonly['priv_delete_'] : 'off';
?>
    scAjaxFieldRead("priv_delete_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['priv_update_'])) ? $this->nmgp_cmp_readonly['priv_update_'] : 'off';
?>
    scAjaxFieldRead("priv_update_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['priv_export_'])) ? $this->nmgp_cmp_readonly['priv_export_'] : 'off';
?>
    scAjaxFieldRead("priv_export_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['priv_print_'])) ? $this->nmgp_cmp_readonly['priv_print_'] : 'off';
?>
    scAjaxFieldRead("priv_print_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("app_name_" + iSeq, "on");
    scAjaxFieldRead("priv_access_" + iSeq, "on");
    scAjaxFieldRead("priv_insert_" + iSeq, "on");
    scAjaxFieldRead("priv_delete_" + iSeq, "on");
    scAjaxFieldRead("priv_update_" + iSeq, "on");
    scAjaxFieldRead("priv_export_" + iSeq, "on");
    scAjaxFieldRead("priv_print_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["app_name_" + iRow] || "on" == ajax_error_count["priv_access_" + iRow] || "on" == ajax_error_count["priv_insert_" + iRow] || "on" == ajax_error_count["priv_delete_" + iRow] || "on" == ajax_error_count["priv_update_" + iRow] || "on" == ajax_error_count["priv_export_" + iRow] || "on" == ajax_error_count["priv_print_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_app_name_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_priv_access_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_priv_insert_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_priv_delete_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_priv_update_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_priv_export_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_priv_print_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["app_name_" + iRow] && "off" == ajax_error_count["priv_access_" + iRow] && "off" == ajax_error_count["priv_insert_" + iRow] && "off" == ajax_error_count["priv_delete_" + iRow] && "off" == ajax_error_count["priv_update_" + iRow] && "off" == ajax_error_count["priv_export_" + iRow] && "off" == ajax_error_count["priv_print_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["app_name_" + iRow] = "off";
        ajax_error_count["priv_access_" + iRow] = "off";
        ajax_error_count["priv_insert_" + iRow] = "off";
        ajax_error_count["priv_delete_" + iRow] = "off";
        ajax_error_count["priv_update_" + iRow] = "off";
        ajax_error_count["priv_export_" + iRow] = "off";
        ajax_error_count["priv_print_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_app_name_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_priv_access_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_priv_insert_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_priv_delete_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_priv_update_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_priv_export_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_priv_print_" + iRow).removeClass("scFormErrorLine");
    }
  }
