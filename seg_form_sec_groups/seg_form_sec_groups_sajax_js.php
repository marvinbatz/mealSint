  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_seg_form_sec_groups" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_seg_form_sec_groups_form();
	}
...
?>
  ...
  function do_ajax_seg_form_sec_groups_validate_description()
  {
    var nomeCampo_description = "description";
    var var_description = scAjaxGetFieldText(nomeCampo_description);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seg_form_sec_groups_validate_description(var_description, var_script_case_init, do_ajax_seg_form_sec_groups_validate_description_cb);
  } // do_ajax_seg_form_sec_groups_validate_description

  function do_ajax_seg_form_sec_groups_validate_description_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seg_form_sec_groups_validate_description_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_seg_form_sec_groups_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_seg_form_sec_groups_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_seg_form_sec_groups_submit_form(var_description, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_seg_form_sec_groups_submit_form_cb);
  } // do_ajax_seg_form_sec_groups_submit_form

  function do_ajax_seg_form_sec_groups_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_seg_form_sec_groups_submit_form_cb_after_alert);
  } // do_ajax_seg_form_sec_groups_submit_form_cb
  function do_ajax_seg_form_sec_groups_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_seg_form_sec_groups_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_seg_form_sec_groups_navigate_form()
  {
    perform_ajax_seg_form_sec_groups_navigate_form();
  }

  function perform_ajax_seg_form_sec_groups_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_seg_form_sec_groups_navigate_form(var_group_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_seg_form_sec_groups_navigate_form_cb);
  } // do_ajax_seg_form_sec_groups_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_sec_groups']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_seg_form_sec_groups_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_seg_form_sec_groups_navigate_form_cb_after_alert);
  } // do_ajax_seg_form_sec_groups_navigate_form_cb
  function do_ajax_seg_form_sec_groups_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_seg_form_sec_groups_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_seg_form_sec_groups_navigate_form_cb_after_alert
  function sc_hide_seg_form_sec_groups_form()
  {
