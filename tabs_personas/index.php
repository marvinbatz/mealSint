<?php
//
    include_once('tabs_personas_session.php');
    @ini_set('session.cookie_httponly', 1);
    @ini_set('session.use_only_cookies', 1);
    @ini_set('session.cookie_secure', 0);
    session_start();
    $_SESSION['scriptcase']['tabs_personas']['glo_nm_path_prod']      = "";
    $_SESSION['scriptcase']['tabs_personas']['glo_nm_path_imag_temp'] = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['tabs_personas']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['tabs_personas']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['tabs_personas']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['tabs_personas']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
...
//
     ...
     $_SESSION['scriptcase']['sc_aba_iframe']['tabs_personas'][] = "form_persona";
     $_SESSION['scriptcase']['sc_aba_iframe']['tabs_personas'][] = "grid_persona";
     $_SESSION['scriptcase']['sc_aba_iframe']['tabs_personas'][] = "grid_persona_lista";
//
      $NM_dir_atual = getcwd();
     ...
     $path_imag_temp  = $_SESSION['scriptcase']['tabs_personas']['glo_nm_path_imag_temp'];
     ...
     $path_imagens    = $_SESSION['scriptcase']['tabs_personas']['glo_nm_path_prod'] . "/imagens/";
     $path_libs       = $root . $_SESSION['scriptcase']['tabs_personas']['glo_nm_path_prod'] . "/lib/php/";
     $path_third      = $root . $_SESSION['scriptcase']['tabs_personas']['glo_nm_path_prod'] . "/third/";
     $_SESSION['scriptcase']['dir_temp'] = $root . $_SESSION['scriptcase']['tabs_personas']['glo_nm_path_imag_temp'];
...
<?php
     ...
     if (isset($_SESSION['scriptcase']['tabs_personas']['session_timeout']['lang'])) {
         $this->str_lang = $_SESSION['scriptcase']['tabs_personas']['session_timeout']['lang'];
     }
     elseif (!isset($_SESSION['scriptcase']['tabs_personas']['actual_lang']) || $_SESSION['scriptcase']['tabs_personas']['actual_lang'] != $this->str_lang) {
         $_SESSION['scriptcase']['tabs_personas']['actual_lang'] = $this->str_lang;
     ...
     if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['tabs_personas']['session_timeout']['redir']))
     {
     ...
     if (isset($_SESSION['scriptcase']['tabs_personas']['session_timeout']['redir'])) {
         ...
         if ($_SESSION['scriptcase']['tabs_personas']['session_timeout']['redir_tp'] == "R") {
             $SS_cod_html .= "  </HEAD>\r\n";
             $SS_cod_html .= "   <body>\r\n";
         }
         else {
             ...
             $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['tabs_personas']['session_timeout']['redir'] . "');\">\r\n";
             $SS_cod_html .= "     </form>\r\n";
         ...
         if ($_SESSION['scriptcase']['tabs_personas']['session_timeout']['redir_tp'] == "R") {
             $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['tabs_personas']['session_timeout']['redir'] . "');\r\n";
         }
         ...
         $SS_cod_html .= " </body>\r\n";
         $SS_cod_html .= "</HTML>\r\n";
         unset($_SESSION['scriptcase']['tabs_personas']['session_timeout']);
     ...
     $_SESSION['scriptcase']['contr_link_emb'] = $dir_raiz . "tabs_personas.php" ; 
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->sc_page]['tabs_personas']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->sc_page]['tabs_personas']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['tabs_personas']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['tabs_personas'];
          }
          ...
          if ($this->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['tabs_personas']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['tabs_personas']['link'] = $path_link . "" . SC_dir_app_name('tabs_personas') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['tabs_personas']['label'] = "tabs_personas";
     ...
     if (!empty($nmsc_falta_var)) 
     {
         ...
         echo "    action='tabs_personas_fim.php'"; 
         echo "    target='_self'>"; 
         echo "    <input type='hidden' name='saida_aba' value='" . NM_encode_input($_SESSION['sc_session'][$this->sc_page]['tabs_personas']['aba_saida']) . "'/>";
...
//  
     if (isset($_SESSION['scriptcase']['sc_apl_conf']['tabs_personas']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['tabs_personas']['exit'] != '')
     {
         $_SESSION['sc_session'][$this->sc_page]['tabs_personas']['aba_saida'] = $_SESSION['scriptcase']['sc_apl_conf']['tabs_personas']['exit'];
     }
...
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
     ...
     $nm_saida->saida("  <HEAD>\r\n");
     $nm_saida->saida("   <TITLE>tabs_personas</TITLE>\r\n");
     ...
     $nm_saida->saida("   <script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['tabs_personas']['glo_nm_path_prod'] . '/third/sweetalert/sweetalert2.all.min.js' . "\"></script>\r\n");
     $nm_saida->saida("   <script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['tabs_personas']['glo_nm_path_prod'] . '/third/sweetalert/polyfill.min.js' . "\"></script>\r\n");
...
$nm_saida->saida("   <link rel=\"shortcut icon\" href=\"../_lib/img/scriptcase__NM__ico__NM__favicon.ico\">\r\n");
     ...
     $nm_saida->saida("           <A HREF=\"javascript:nm_gp_aba1()\" TARGET=\"_self\">Nueva</A>\r\n");
     $nm_saida->saida("         </li>\r\n");
     $cor_celula  = "scTabInactive";
     if ($nmgp_num_aba == "2") 
     {
     ...
     $nm_saida->saida("           <A HREF=\"javascript:nm_gp_aba3()\" TARGET=\"_self\">Lista</A>\r\n");
     $nm_saida->saida("         </li>\r\n");
//
     $cor_celula  = "scTabInactive";
//
         $cor_celula  = "scTabInactive";
     if (is_file("tabs_personas_help.txt"))
     {
        $Arq_WebHelp = file("tabs_personas_help.txt"); 
     ...
     $nm_saida->saida("    <TR>\r\n");
     $nm_saida->saida("      <TD style=\"padding: 0px\">\r\n");
     $nm_saida->saida("         <iframe id=\"nmsc_iframe_form_persona_1\" frameborder=\"0\" align=\"center\" valign=\"top\" name=\"nm_iframe_aba_form_persona_1\" height=\"600px\" width=\"100%\" scrolling=\"auto\"></iframe>\r\n");
     $nm_saida->saida("      </TD>\r\n");
     $nm_saida->saida("    </TR>\r\n");
     $nm_saida->saida("    <TR>\r\n");
     $nm_saida->saida("      <TD style=\"padding: 0px\">\r\n");
     $nm_saida->saida("         <iframe id=\"nmsc_iframe_grid_persona_2\" frameborder=\"0\" align=\"center\" valign=\"top\" name=\"nm_iframe_aba_grid_persona_2\" height=\"600px\" width=\"100%\" scrolling=\"auto\"></iframe>\r\n");
     $nm_saida->saida("      </TD>\r\n");
     $nm_saida->saida("    </TR>\r\n");
     $nm_saida->saida("    <TR>\r\n");
     $nm_saida->saida("      <TD style=\"padding: 0px\">\r\n");
     $nm_saida->saida("         <iframe id=\"nmsc_iframe_grid_persona_lista_3\" frameborder=\"0\" align=\"center\" valign=\"top\" name=\"nm_iframe_aba_grid_persona_lista_3\" height=\"600px\" width=\"100%\" scrolling=\"auto\"></iframe>\r\n");
     $nm_saida->saida("      </TD>\r\n");
     $nm_saida->saida("    </TR>\r\n");
     $nm_saida->saida("   </TABLE>\r\n");
     $nm_saida->saida("     </TD>\r\n");
     $nm_saida->saida("    </TR>\r\n");
     if (!$_SESSION['sc_session'][$this->sc_page]['tabs_personas']['iframe_menu'])
     {
         $nm_saida->saida("    <TR>\r\n");
         $Saida = $_SESSION['sc_session'][$this->sc_page]['tabs_personas']['aba_saida'];
     ...
     $nm_saida->saida("      document.F2.action = \"tabs_personas_fim.php\";\r\n");
     ...
     $nm_saida->saida("   var nm_form_persona_1 = 'no';\r\n");
     $nm_saida->saida("   var nm_grid_persona_2 = 'no';\r\n");
     $nm_saida->saida("   var nm_grid_persona_lista_3 = 'no';\r\n");
     ...
     $nm_saida->saida("      document.getElementById('nmsc_iframe_grid_persona_2').style.display = 'none'; \r\n");
     $nm_saida->saida("      document.getElementById('nmsc_iframe_grid_persona_lista_3').style.display = 'none'; \r\n");
     $nm_saida->saida("      tst_clear_iframe = document.getElementById(\"nmsc_iframe_form_persona_1\"); \r\n");
     ...
     $nm_saida->saida("      document.Faba.target   = \"nm_iframe_aba_form_persona_1\"; \r\n");
     $nm_saida->saida("      document.Faba.action   = \"" . $path_link  . SC_dir_app_name('form_persona') . "/\";\r\n");
     $nm_saida->saida("      document.Faba.submit() ;\r\n");
     $nm_saida->saida("      document.getElementById('nmsc_iframe_form_persona_1').style.display = 'block'; \r\n");
     $nm_saida->saida("   } \r\n");
     ...
     $nm_saida->saida("      document.getElementById('cel'+sc_cel_ativa).className = 'scTabActive';\r\n");
     $nm_saida->saida("      document.getElementById('nmsc_iframe_form_persona_1').style.display = 'none'; \r\n");
     $nm_saida->saida("      document.getElementById('nmsc_iframe_grid_persona_lista_3').style.display = 'none'; \r\n");
     $nm_saida->saida("      tst_clear_iframe = document.getElementById(\"nmsc_iframe_grid_persona_2\"); \r\n");
     $nm_saida->saida("      if (tst_clear_iframe.contentWindow && tst_clear_iframe.contentWindow.document && tst_clear_iframe.contentWindow.document.body)\r\n");
     $nm_saida->saida("      {\r\n");
     $nm_saida->saida("          tst_clear_iframe.contentWindow.document.body.innerHTML = \"\";\r\n");
     $nm_saida->saida("      }\r\n");
     $nm_saida->saida("      document.Faba.nmgp_parms.value = \"under_dashboard*scin1*scout\"; \r\n");
     $nm_saida->saida("      document.Faba.target   = \"nm_iframe_aba_grid_persona_2\"; \r\n");
     $nm_saida->saida("      document.Faba.action   = \"" . $path_link  . SC_dir_app_name('grid_persona') . "/\";\r\n");
     $nm_saida->saida("      document.Faba.submit() ;\r\n");
     $nm_saida->saida("      document.getElementById('nmsc_iframe_grid_persona_2').style.display = 'block'; \r\n");
     $nm_saida->saida("   } \r\n");
     ...
     $nm_saida->saida("      document.getElementById('nmsc_iframe_form_persona_1').style.display = 'none'; \r\n");
     $nm_saida->saida("      document.getElementById('nmsc_iframe_grid_persona_2').style.display = 'none'; \r\n");
     $nm_saida->saida("      tst_clear_iframe = document.getElementById(\"nmsc_iframe_grid_persona_lista_3\"); \r\n");
     $nm_saida->saida("      if (tst_clear_iframe.contentWindow && tst_clear_iframe.contentWindow.document && tst_clear_iframe.contentWindow.document.body)\r\n");
     $nm_saida->saida("      {\r\n");
     $nm_saida->saida("          tst_clear_iframe.contentWindow.document.body.innerHTML = \"\";\r\n");
     $nm_saida->saida("      }\r\n");
     $nm_saida->saida("      document.Faba.nmgp_parms.value = \"under_dashboard*scin1*scout\"; \r\n");
     $nm_saida->saida("      document.Faba.target   = \"nm_iframe_aba_grid_persona_lista_3\"; \r\n");
     $nm_saida->saida("      document.Faba.action   = \"" . $path_link  . SC_dir_app_name('grid_persona_lista') . "/\";\r\n");
     $nm_saida->saida("      document.Faba.submit() ;\r\n");
     $nm_saida->saida("      document.getElementById('nmsc_iframe_grid_persona_lista_3').style.display = 'block'; \r\n");
     $nm_saida->saida("   } \r\n");
     if ($nmgp_num_aba == "1" || empty($nmgp_num_aba)) 
     { 
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['tabs_personas']['glo_nm_path_imag_temp'] . "/sc_apl_default_MealSint2.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['tabs_personas']['glo_nm_path_imag_temp'] . "/sc_apl_default_MealSint2.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "tabs_personas") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['tabs_personas']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['tabs_personas']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['tabs_personas']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_MealSint2'])) {
            $_SESSION['scriptcase']['tabs_personas']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_MealSint2'];
        }
    }
}
...
if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'tabs_personas')
{
    $_SESSION['sc_session'][$script_case_init]['tabs_personas']['sc_outra_jan'] = true;
...
$salva_iframe = false;
if (isset($_SESSION['sc_session'][$script_case_init]['tabs_personas']['iframe_menu']))
{
    $salva_iframe = $_SESSION['sc_session'][$script_case_init]['tabs_personas']['iframe_menu'];
    unset($_SESSION['sc_session'][$script_case_init]['tabs_personas']['iframe_menu']);
}
if (isset($nm_run_menu) && $nm_run_menu == 1)
{
    ...
    $_SESSION['scriptcase']['sc_apl_menu_atual'] = "tabs_personas";
    $achou = false;
    if (isset($_SESSION['sc_session'][$script_case_init]))
    {
        foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
        {
            if ($nome_apl == 'tabs_personas' || $achou)
            {
                if ($achou)
                {
    ...
    $_SESSION['sc_session'][$script_case_init]['tabs_personas']['iframe_menu'] = true;
}
else
{
    $_SESSION['sc_session'][$script_case_init]['tabs_personas']['iframe_menu'] = $salva_iframe;
}

   if (!isset($_SESSION['sc_session'][$script_case_init]['tabs_personas']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['tabs_personas']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['tabs_personas']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('tabs_personas' == $sReferer || 'tabs_personas_' == substr($sReferer, 0, 14))
       {
           $_SESSION['sc_session'][$script_case_init]['tabs_personas']['initialize'] = false;
       }
       else
...
{
    $_SESSION['sc_session'][$script_case_init]['tabs_personas']['num_aba'] = $nmgp_num_aba;
}
if (isset($nmgp_url_saida) && !empty($nmgp_url_saida)) 
{ 
    $_SESSION['sc_session'][$script_case_init]['tabs_personas']['aba_saida'] = $nmgp_url_saida ; 
...
if (isset($_SESSION['scriptcase']['tabs_personas']['session_timeout']['lang'])) {
    $STR_lang = $_SESSION['scriptcase']['tabs_personas']['session_timeout']['lang'];
}
...
if (!isset($_SESSION['scriptcase']['tabs_personas']['session_timeout']['redir']) && (!isset($_SESSION['scriptcase']['sc_apl_seg']['tabs_personas']) || $_SESSION['scriptcase']['sc_apl_seg']['tabs_personas'] != "on"))
{ 
    $NM_Mens_Erro = $Nm_lang['lang_errm_unth_user'];
    $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['tabs_personas']['iframe_menu']) ? false : true;
    if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
    {
        foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
        {
            if (in_array("tabs_personas", $apls_aba))
            {
                $nm_botao_ok = false;
                 break;
            }
...
?>
      ...
      <form name="Fseg" method="post" 
                          action="tabs_personas_fim.php" 
                          target="_self"> 
       <input type="hidden" name="saida_aba" value="<?php echo $_SESSION['sc_session'][$script_case_init]['tabs_personas']['aba_saida']; ?>"> 
...
$_POST = array();
$_GET  = array();
$nmgp_num_aba = (isset($_SESSION['sc_session'][$script_case_init]['tabs_personas']['num_aba'])) ? $_SESSION['sc_session'][$script_case_init]['tabs_personas']['num_aba'] : 1;
$tabs_personas_contr = new tabs_personas();
$tabs_personas_contr->controle();
?>
